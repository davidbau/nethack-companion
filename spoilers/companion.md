...
On a first descent, read [What to Pack](#what-to-pack), [The Golden
Rules](#the-golden-rules-of-early-survival), and [Saving Yourself from
Imminent Death](#delayed-deaths). Leave the tables and the endgame
chapters alone until the dungeon gives you a reason to open them.

During a game, use the contents and index as a field manual. Look up
the monster in front of you, the message you just saw, or the object
you are about to use. The item chapters put the common, useful cases
first; the tables are there when you need an exact price or number.

**Conventions.** `@`, `#pray`, and other fixed-width text are things
you will see or type in the game. **Bold text** marks a rule worth
remembering. *Dlvl* is dungeon depth and *XL* is experience level.
Prices are in zorkmids (*zm*). A note marked **new in 5.0** matters
especially if you learned the game on 3.6; returning players can start
with [What Changed Since Last Time](#what-changed-since-last-time).

#### Dungeon Emergency Checklist

When a turn has gone bad, stop typing and read the messages again.

1. Check HP, hunger, encumbrance, and every status word.
2. Look for the up stair, a door you can close, or another one-turn
   escape. Inventory search comes after the obvious exit.
3. If you cannot walk away, engrave `Elbereth` in dust before the
   monster reaches you. Use a permanent engraving when you have time.
4. Prayer can cure a life-threatening problem when your alignment and
   Luck are sound and enough time has passed. In Gehennom, expect less.
5. For stoning, eat a lizard corpse. For sliming, use fire. For
   illness, use blessed healing or non-cursed extra healing. For
   strangulation, remove the amulet or pray.
6. If nothing in the pack saves you, write down the death. NetHack is
   very good at making the same mistake memorable.
...
10. [Saving Yourself from Imminent Death](#delayed-deaths) — Warning messages and the cure to reach for
11. [Engravings and Elbereth](#engravings) — Writing on the floor and making a ward
12. [The Art of Combat](#the-art-of-combat) — Hit probability, damage, and tactics
13. [Things That Will Kill You](#things-that-will-kill-you) — Top-ten killers, common deaths, mimics, dragons
14. [Saving and Bones](#saving-and-bones) — How runs continue across sessions, and what dead heroes leave behind
15. [Ways to Die Instantly](#ways-to-die-instantly) — Instadeaths and how to recognize them
16. [Divine Relations](#divine-relations) — Prayer, sacrifice, and altars
17. [Making Friends](#making-friends) — Pets, taming, and peaceful coexistence

**Part Four: Gear and Provisions**

18. [A Practical Identification Strategy](#a-practical-identification-strategy) — Figuring out what you've found (with flowchart)
19. [Provisions and Dining](#provisions-and-dining) — Food, nutrition, and dining
20. [The Apothecary](#the-apothecary) — Potions and their many uses
21. [The Scroll Rack](#the-scroll-rack) — Scrolls, their effects, and confused reading
22. [Wands](#wands) — Magical implements
23. [Rings and Amulets](#rings-and-amulets) — Jewelry, for better or worse
24. [Tools of the Trade](#tools-of-the-trade) — From pickaxes to magic lamps
25. [The Armory](#the-armory) — Weapons, armor, and hitting things
26. [Curses and How to Break Them](#curses-and-how-to-break-them) — Spotting them, undoing them, surviving them

**Part Five: Mastery and Endgame**

27. [Spellcasting](#spellcasting) — Magic for the studious adventurer
28. [Luck and Fortune](#luck-and-fortune) — The hidden numbers that shape your fate
29. [Exercising Your Stats](#exercising-your-stats) — Habits that slowly drift Str, Dex, Con, and Wis
30. [Enhancing Skills](#enhancing-skills) — Mastering specific styles of combat and magic
31. [Wishes and Wishing](#wishes-and-wishing) — Getting what you want
32. [Artifacts](#artifacts) — Legendary equipment and how to obtain it
33. [Into Gehennom](#into-gehennom) — The Castle gateway and the realm below
34. [The Ascension](#the-ascension) — Assembling the kit and climbing back out
...
39. [Shops: Credit, Debt, and Trouble](#shopping-and-shopkeeper-pricing) — Commerce in the dungeon
...
| Role | Alignments | Races | Early edge | Main difficulty |
|---|---|---|---|---|
| Archeologist | Lawful, Neutral | Human, dwarf, gnome | Digging and identification tools | Fragile in melee |
| Barbarian | Neutral, Chaotic | Human, orc | High HP and poison resistance | Little useful magic |
| Cave Dweller | Lawful, Neutral | Human, dwarf, gnome | Tough, simple, good ranged start | Few built-in resistances |
| Healer | Neutral | Human, gnome | Healing, sleep wand, poison resistance | Weak weapon and armor |
| Knight | Lawful | Human | Armor, pony, lance, long sword | Mounting and conduct mistakes |
| Monk | Any | Human | Speed, resistances, martial arts | Armor and diet restrictions |
| Priest | Any | Human, elf | Sees BUC status at a glance | Middling opening offense |
| Ranger | Neutral, Chaotic | Human, elf, gnome, orc | Bow, arrows, displacement | Wants distance to fight well |
| Rogue | Chaotic | Human, orc | Daggers, stealth, lock pick | Light armor |
| Samurai | Lawful | Human | Fast, well armed, good bow | Conduct penalties |
| Tourist | Neutral | Human | Darts, camera, mapping | Very weak opening |
| Valkyrie | Lawful, Neutral | Human, dwarf | Excellent shield and cold resistance | Must find magical defenses later |
| Wizard | Neutral, Chaotic | Human, elf, gnome, orc | Magic resistance and a deep kit | Low HP and no food |

The [intrinsic tables](#intrinsic-and-extrinsic-tables) give the exact
level-by-level abilities for every role and race.
...
into a sealed vault to reach the gold inside, or dig straight down to
...
level's map in an instant. One rule
...
rules out a whole category of early deaths, and you
...
stretch of the game you can simply wade in and swing. Trouble comes
later, once you have
...
most reliably a suit of gray dragon scale mail. Because poison cannot
touch you, you can also taste-test risky potions and
...
protection from fire or cold or poison, you earn each one by eating
the right corpse. A fire ant grants fire resistance and a killer bee
can grant poison resistance. In a fight you can grow expert
...
hard. Low starting Intelligence and narrow spell skills make scrolls
more dependable than spellbooks. Choose the dwarf or human background for
the heaviest melee.

**Healer** *(Neutral).* The dungeon's doctor. You arrive equipped for medicine rather
...
wand is your best early defense. Most monsters in the first levels have no
defense against sleep, and a single charge drops even a dangerous one
where it stands. Save the charges for threats you cannot safely kill
another way. The stethoscope is useful from turn one: press it to a
...
mystery potion can never poison or sicken you, though paralysis or
sleep still can. You are no brawler, so lean on the wand and, later,
on your spells. In
...
a full suit of armor, helmet, shield, and gloves. On foot, the lance can be
...
more, but climbing into the saddle is riskier than it looks: a failed
mount throws you for 10--14 HP, most of a new Knight's life, and early on you
...
blindness, and pick your fights with honor.

**Monk** *(Any alignment).* You begin unarmed and can train your
...
with unusual speed, and you gain new powers faster than any
other role. To keep the combat bonuses, stay light and
unburdened. Any body armor costs 20 points of accuracy, a shield cancels your
...
the robe and keep to the vegetarian diet if you want to preserve your
conduct.

**Priest** *(Any alignment, matching your god).* Your faith gives you
an immediate read on every item's condition: blessed, cursed, or
uncursed. You never have to wonder whether the cloak on the floor is
safe to wear. You set out with a mace, a robe and shield, and four
...
When sacrifice yields your first artifact gift, it is guaranteed to
be **Demonbane**, a blessed silver mace made to smite demons. Each
worthy offering has a one-in-six chance to produce that first gift.
You are a capable fighter who grows into a formidable caster of
clerical magic, expert with a whole rack of blunt weapons and in the
healing, divination, and cleric schools. One caution: guard your
Luck. Do not kill peaceful monsters or break mirrors before you have
...
passages and traps as you walk without stopping to search. Two
pieces of woodcraft are worth remembering. Your finest arrows, the enchanted
...
to be thrown, not thrust: you hurl several in a single turn. Later you
can coat darts and any arrows, bolts, or shuriken you find with the
poison you start carrying. Daggers cannot be poisoned.
...
**Tourist** *(Neutral).* You arrive on holiday: a loud
...
trick: a flash blinds whatever is bearing down on you, and
...
scrolls for the levels that look most dangerous. Shopkeepers can smell
a tourist: until you are seasoned, they overcharge you and lowball
what they buy. Leave serious shopping for later in the run. Survive
that brutal opening and the
Tourist blossoms: your quest reward, the Platinum Yendorian Express
Card, grants magic resistance and helps recharge tools. With a good
Intelligence score, a late-game Tourist also casts well. The hardest role in the
...
stats that let you meet the early dungeon head-on.
The gods have set
your late game aside for you, too. Your first guaranteed sacrifice
gift, whatever your alignment, is **[Mjollnir](#mjollnir)**, a
thunderous war hammer. A Valkyrie with Strength 25 can throw it and
usually catch it on the return. You can grow skilled with a wider range of weapons than nearly
...
**Wizard** *(Neutral or Chaotic).* You set out already holding a treasure most adventurers spend
...
As you study each school of spellcasting you begin to recognize its
spellbooks on sight. A Wizard who reaches the middle game with a broad
library has an answer to most fights. Keep the quarterstaff in hand as you cast, since
...
intrinsics you get. No stat can go below 3; the table lists the
maximum each race can reach for each attribute.
...
talents. Every role is open to you, but gnomes and orcs are still
hostile; being human does not make the Mines friendly.
...
**Orc.** Poison resistance from level 1 is useful, and
it lets you eat kobold corpses safely (free nutrition in the early
dungeon). Orcs may also eat other orcs without a cannibalism penalty.
Lower stat caps overall, and many humans, elves, and dwarves are
race-hostile to orcs. Monsters that are normally peaceful, including
shopkeepers, priests, and watchmen, stay peaceful. Other orcs aren't
automatically peaceful either. Available for:
Barbarian, Ranger, Rogue, Wizard.

#### Alignment

It is tempting to read Lawful, Neutral, and Chaotic as good, balanced,
and evil. The game does not judge you that way. Alignment is a number
that measures how well you have kept your god's rules.

Killing a hostile monster usually raises that number. Killing a
peaceful monster costs every alignment 5 points, and murdering one
also costs Luck. Some roles add rules of their own: Knights lose
standing for striking helpless foes, and Samurai for attacking
peaceful ones. A damaged record can be repaired through ordinary
hostile kills and [sacrifice](#sacrifice).

Alignment also determines your god, your Quest, and which artifacts
you can handle safely. Lawful characters can draw Excalibur from a
fountain at XL 5 or later. Rogues are always Chaotic; dwarves are
always Lawful. For the full altar rules, see [Altars and
Alignment](#altars-and-alignment).
...
blessed/cursed), your pet (it is reluctant to step on cursed items), and
experimentation. A scroll of identify is valuable, but you might
not find one for a while. A touchstone (a gray stone that
identifies gems) is helpful. At shops you will learn
...
**Armor improvements.** At AC 6 or worse, with no altar or pet to test
what you find, put on ordinary body armor, helmets, shields, and
cloaks. A curse on one of those is usually less dangerous than walking
around unarmored. Test boots and gloves first: cursed levitation,
fumbling, or trapped hands can leave you unable to escape.
...
a replacement if you're a Tourist, Cave Dweller, or Healer who starts
with a feeble weapon, or if it matches your skills (check the
`#enhance` chapter), or it's **silver** (a hefty bonus against
werecreatures, vampires, demons, shades, and imps). Ordinary zombies
and mummies ignore it. Prefer one-handed if you want the option to
hold a shield.

**A throwing stack.** Keep daggers, darts, spears, or a bow and arrows
ready, not buried in a bag. A floating eye should never be fought in
melee. Rothes, homunculi, killer bees, and soldier ants are also much
safer if you begin hurting them before they reach you.
...
Careful about what you leave for monsters, though. They can pick up what you drop, and they can loot containers.
...
- prayer cooldown uses rnz(350), averaging about 450 turns but with a long tail (pray.c:1356)
...
The first few levels go easy on you, which is a relative term.
Monsters are weaker, but so are you: minimal gear, low HP, and
none of the resistances that make the mid-game survivable. More
adventurers die on levels one through five than anywhere else, not
because the monsters are fierce but because you have so little to
answer them with.

#### The Golden Rules of Early Survival

**Rule 1: Don't fight what you can't beat.** Decide after the first
exchange, not when you are down to your last few hit points. Take the
up stair if you can. Otherwise reach a door you can close, then a
corridor. If there is no way out, engrave `Elbereth` in the dust with
`E`, then `-`, before the monster reaches you.
...
**Rule 3: Your pet is your friend.** Your starting pet fights alongside
you and picks up items (a pet is
...
critically low, Weak with no food, turning to stone) you
can pray to your god (`#pray`) for help. In the early game, with decent
alignment and non-negative Luck, prayer will almost certainly save
you. Do not pray in the first 300 turns. After a prayer, count on
waiting about a thousand turns to be safe; the actual recovery
averages around 500 but can run much longer. Praying at the
wrong time (when your god is angry, when you're in [Gehennom](#gehennom), or
when you've prayed too recently) can make things much worse. Don't
waste it on minor problems (see [Divine Relations](#divine-relations)
for the full mechanics). If you have lost alignment, kill ordinary
hostile monsters; kobolds and orcs are useful targets even for a
Neutral character.

**Rule 5: Explore thoroughly but move purposefully.** Every turn
costs nutrition, so standing around for hundreds of turns starves
you, but rushing past rooms misses items you need. Explore each
level fairly completely (check rooms, open doors, and use `s`, or
`10s`, to look for hidden passages), then move on when you've found
what it offers. Once you know the down stair, do not spend hundreds of
turns tapping walls. If you are Hungry and the level has no food left,
go down.

**Rule 6: Build your defenses.** In the first half of the game,
your goal isn't treasure but the resistances that carry you
through the late game. The three most important are
**[magic resistance](#damage-resistances)**, **reflection**, and
**[poison resistance](#damage-resistances)**. Poison resistance is
an *intrinsic* from eating the right corpse: a killer bee, giant
spider, yellow mold, or a [black pudding](#a-note-on-puddings)
kicked from a sink. Magic resistance and reflection come from
gear: dragon scale mail (gray for MR, silver for reflection), a
cloak of MR or amulet of reflection, a silver shield (reflection),
or an artifact from your god, [the Quest](#the-quest), or a wish.
...
without one keypress per square, learn the **shift-direction**
shortcut: capital `H J K L Y U B N` runs past items and doors but
stops for a monster ahead or one that hits you. `G`+direction is the
cautious version; it also stops beside monsters, items, and doors.
Autorepeat offers neither protection.

#### Dungeon Hazards (and How to Survive Them)

Here's a short list of common early deaths and how to prevent them:

**Starvation.** Eat when you're Hungry (the status message), not when
you're Weak or Fainting. If you are Hungry with no food, descend; a
cleared floor will not grow a new ration. Weak already counts as a
prayer emergency. At Fainting, eat or pray at once.
...
past ~175 turns an uncursed corpse is certainly tainted. If you do
get food poisoning, use blessed healing, non-cursed extra or full
healing, a unicorn horn, or a eucalyptus leaf. Pray only if the
requirements in [Divine Relations](#prayer) are satisfied.

**Falling down stairs while overburdened.** If you're carrying too
much, taking the stairs can make you tumble for 1–3 HP. A cockatrice
corpse in your pack is harmless; a wielded one can stone you in the
fall.
...
you in open rooms. Killer bees, soldier ants, and gnomes arrive the
same way. Retreat to a doorway or corridor at the first sign of more
than two attackers. If they have not reached you yet, hold your ground
and let them spend the approach turns; stepping toward a pack gives
those turns away.

**Pushing too quickly into [the Mines](#the-gnomish-mines).** The deeper Mines below
Minetown are crowded with armored dwarves and gnome lords. If
you're not ready for armored melee packs, head back to the main
branch and return later.
...
These look like ordinary containers, no special marking. Above the
Oracle, check every chest and large box. A locked one
yields to a credit card, a key, or a wand of opening, or `#force`
it. Pry with a dagger if you can: blades very rarely snap, while a
blunt weapon may smash the box and any healing potion inside.

---

## Part Two: Dungeon Sights

The map is full of punctuation, but only a few marks should stop you
in your tracks. Read [Points of Interest](#points-of-interest) when
you find dungeon furniture and [Branches and Landmarks](#branches-and-landmarks)
before taking an unfamiliar stair. The field guide is meant for
lookup: find the letter, then follow the link if the short warning is
not enough.
...
The Mazes are laid out fresh every game, but the branches, special
levels, and their rough depths stay the same. Once you know that
shape, you can usually tell what is coming next.

#### The Big Picture

The dungeon is a branching tree with a main trunk and several side
branches. Exact depths vary; the diagram gives the usual shape.

The **Dungeons of Doom** form the upper half, roughly levels 1
through 27. Side branches lead to the **[Gnomish Mines](#the-gnomish-mines)** (where
...
Learn to read them at a glance:

| Symbol   | Meaning                       |
| -------- | ----------------------------- |
| `.`      | Floor (room)                  |
| `#`      | Corridor, tree, or cloud       |
...
**Zoos.** A room packed with sleeping monsters and gold. Each sleeper
that can see you from within ten squares has a one-in-seven chance to
wake each turn. Stealth prevents that. Fight from the doorway so only
one or two can reach you at a time.
...
**Themed rooms.** The dungeon also has dozens of rooms that are odd in
shape (pillars, a room inside a room) or in their contents. Some to
look out for:
...
- **Massacre.** Floor strewn with human adventurer corpses. None grants
  an intrinsic. A human who eats one commits cannibalism, and a
  non-Chaotic sacrifice of one is a serious offense.
- **Mausoleum.** A small interior chamber with one waiting
  monster (mummy, vampire, lich, or zombie) or a human corpse.
  Open the door carefully.
- **Spider nest, buried zombies, trap room, teleportation hub.** Treat
  these as traps. Spider nests and buried zombies scale with depth, so
  back out and return with what the room calls for. Trap rooms may hold
  anything from arrow traps to anti-magic fields or land mines.
- **Pillared and divided rooms.** Some rooms contain pillars, an inner
  chamber, or a blocked center. Use those corners to protect an
  [Elbereth](#elbereth) square or keep a polearm target at reach.

Themed rooms are mixed in with ordinary rooms; a level may have
several.
...
| [`B`](#bats-and-birds-b)    | [Bats](#bats-and-birds-b)      | Speed is the danger. Bats and giant bats move at 22 against your base 12, so they bite almost twice per one of your swings. A giant bat's 1d6 bites wear a new character down quickly. Vampire bats add a Strength-draining bite. |
| [`d`](#dogs-and-canines-d)    | [Dogs and other canines](#dogs-and-canines-d) | Jackals bite for only 1d2, but on the first few levels a pack of them kills more characters than anything else. Foxes bite for 1d3 and are faster, but spawn alone. Tame dogs and cats help fight everything else. |
| [`e`](#eyes-and-spheres-e)    | [Eyes](#eyes-and-spheres-e)      | A floating eye paralyzes you when struck in melee; use a missile or walk around it. Gas spores explode for 4d6 when killed, so shoot from at least two squares away. Flaming, freezing, and shocking spheres also explode nearby. |
| [`f`](#felines-f)    | [Cats](#felines-f)      | Like dogs, often starting pets. Domestic cats can be tamed with tripe; wild felines need magic. |
| [`G`](#gnomes-g)    | [Gnomes](#gnomes-g)    | The Mines have a lot of them. Most are peaceful to gnomes and dwarves. Lords and kings are stronger but need no separate rule. |
| [`h`](#humanoids-h)    | [Humanoids](#humanoids-h) | Dwarves, bugbears, mind flayers. A dwarf with a mattock hits for 1d8 plus 1d12, enough to kill a first-level character in two swings. Start at range. |
...
| [`j`](#jellies-j)    | [Jellies](#jellies-j)   | They do not move. Walk around them; melee can trigger passive acid damage.               |
| [`k`](#kobolds-k)    | [Kobolds](#kobolds-k)   | Weak, but every kobold corpse is poisonous. Very rarely one carries poisoned darts.      |
...
| [`x`](#xans-and-fantastic-insects-x)    | [Grid bugs](#xans-and-fantastic-insects-x) | The weakest monster in the game; they can't even move diagonally. They leave no corpse. The `x` class also covers the much-later **xan**, whose sting cripples your legs (slow movement until it heals). |
| [`:`](#lizards)    | [Lizards](#lizards)   | Newts, geckos, and iguanas are individually weak. The class matters mostly for the corpses: **lizard corpses cure [petrification](#petrification-stoning)** (carry one for cockatrice insurance), and newt corpses may restore 1–3 mana. |
...
| [`F`](#fungi-and-molds-f)    | [Fungi](#fungi-and-molds-f)             | Molds do not move, so walk around them. Shriekers summon other monsters.                              |
...
| [`H`](#giant-humanoids-h)    | [Giants](#giant-humanoids-h)            | Strong melee, throw boulders, and carry gems. Their corpses can raise Strength.                      |
| [`J`](#jabberwocks-j)    | [Jabberwock](#jabberwocks-j)        | Four 2d10 attacks per turn, about 44 damage if all four land.                                        |
...
| [`L`](#liches-l)    | [Liches](#liches-l)            | Spellcasters. Arch-liches are among the most dangerous monsters in the game because they cast touch of death. |
...
| [`M`](#mummies-m)    | [Mummies](#mummies-m)           | Aggressive undead with physical claw attacks. They leave the already-rotten corpse of their base race; there is no aging effect. Mummy wrapping worn as a cloak blocks invisibility, useful when a shopkeeper refuses to serve you. |
...
| [`p`](#piercers-p)    | [Piercers](#piercers-p)          | Disguise as stalactites and drop for 2d6 damage (iron 3d6, glass 4d6). A hard helmet blocks the blow; good AC may let you dodge. |
...
| [`R`](#rust-monsters-and-disenchanters-r)    | [Rust monster](#rust-monsters-and-disenchanters-r) | Rust monsters corrode worn iron armor when they hit you, and your wielded iron weapon when you hit them. Use mithril, silver, or wood, or strip iron gear before the fight. Disenchanters appear only in Gehennom; see [Enchantment Drain](#enchantment-drain). |
...
| [`u`](#unicorns-and-horses-u)    | [Horses / unicorns](#unicorns-and-horses-u) | Wild horses spawn hostile but can be tamed and ridden. Unicorn color marks alignment: your own spawns peaceful. Throw hostile unicorns gems; see [Luck and Fortune](#luck-and-fortune). |
| [`U`](#umber-hulks-u)    | [Umber hulk](#umber-hulks-u)        | Its gaze confuses you whenever you can see it. A blindfold makes you immune.                          |
| [`v`](#vortices-v)    | [Vortices](#vortices-v)          | Fast [engulfing](#engulfment) clouds, except for the slow fog cloud. Dust blinds; ice freezes; energy shocks and drains Pw; steam and fire burn. Kill at range. |
...
| [`Y`](#apelike-creatures-y)    | [Yetis](#apelike-creatures-y)             | Big white brutes. A yeti corpse grants cold resistance about one time in three.              |
| [`z`](#zruties-z)    | [Zruty](#zruties-z)             | Slow, but attacks with two 3d4 claws and a 3d6 bite each turn.                                |
| [`Z`](#zombies-z)    | [Zombies](#zombies-z)           | Slow and numerous. A wand or spell of undead turning deals 1d8 and makes them flee. Race-based zombies drop an already-old corpse of their base race. |
...
| [`h`](#humanoids-h)    | [Mind flayers](#humanoids-h)     | [Drain intelligence on hit](#brainlessness). **At Int 3, the next tentacle that lands kills you.** A helmet blocks 7/8 tentacles. Kill from range. |
...
| [`X`](#xorns-x)    | [Xorn](#xorns-x)             | Passes through walls. Three claws and a bite per turn; hard to ambush and hard to escape from. |
...
As you descend, make time for the landmarks. Scattered throughout the levels are fixtures that
reward the curious, and occasionally punish them.
...
About one in seven randomly placed fountains is a **magic fountain**,
regardless of your Luck. It is indistinguishable from an ordinary one
until you drink. With non-negative Luck, a successful magic draught
says *Wow! This makes you feel great!*, restores every attribute to
its maximum, and raises every attribute by one. That consumes the
magic charge. (Pre-placed fountains like those
in Minetown or [the Oracle](#the-oracle), and fountains created from
another feature, are never magic. Also: dipping gets no benefits from magic charge but could
consume it.)
...
| Nothing           | "The cool draught refreshes you." or "This tepid water is tasteless." |
...
**Dipping in a fountain** is how a Lawful character gets Excalibur.
If you're at least XL
5, dipping a long sword may transform it into [Excalibur](#excalibur-artifact), one of the
...
At XL 5, a Lawful Knight carrying a long sword should dip in every
fountain until Excalibur appears. Each dip carries roughly a one-in-three chance of drying
...
aligned to one of the three gods. Drop your gear on it to learn at a
...
It costs nothing and never runs out, so haul unknown gear to the first
altar you find before putting it on. (Drop the whole pile at once; you'll see one flash
per item.)

**Sacrificing monster corpses on an altar** (`#offer`, while
standing on it) earns your god's favor. A stale corpse simply does
nothing; a fresh, difficult monster is worth more.
...
the alignment loss is severe and the residual aggravate-monster
intrinsic sticks around for the rest of the run. See
[Divine Relations](#divine-relations) for the full theology.

**Converting an altar** is risky enough that the details matter. With
a non-negative alignment record, a cross-aligned sacrifice either
flips the altar or costs 1 Luck; either result may summon a minion.
With a negative record, the altar converts *you* instead. Read [Altars
and Alignment](#altars-and-alignment) before trying it.
...
- A wish (most reliable at non-negative Luck)
- Genocide of one monster species
...
- Confusion
- A curse on as many as six items; at positive Luck, long blindness and lost Luck instead
- Magic mapping of the level
- [See invisible](#senses-and-perception)
- All your gold, vanished
- Teleportation; with bad Luck, every monster on the level wakes instead
...
strong enough to survive the worst row of that table. A wish can still
come at Luck -1, but non-negative Luck guarantees the favorable branch
when that outcome is rolled. Even when nothing happens, the throne
...
different gamble. One kick in three, once per throne, dislodges
300–500 gold and up to six gems. Of the failed kicks, one in four
drops you through a trap door.
...
**Kicking a sink** usually produces a harmless *Klunk!* Four kicks in
five do nothing. A successful kick might shake loose a ring or summon a [black pudding](#a-note-on-puddings)
...
the table below. Searching and slow digestion return at once. Of the
other rings, one in twenty comes back and one in five of the rest is
buried beneath the sink, where a pick-axe can recover it; the rest are
gone. It's most useful when you have a duplicate ring to spare, or
...
| *"The sink vanishes."*<br>sink moves to a new spot                     | teleportation         | no |
...
potion is poured down your throat, which is a gamble in itself. The bad ones
...
Sleeping and paralysis leave you helpless for 1–5 turns;
hallucination gives only a momentary vision. Wasted on
...
For an Archeologist, the word *historic* appears in the name of a
significant statue. Breaking one costs 1 alignment point.
...
Explore the upper Dungeons of Doom until you have found an altar or
another way to test curses. The Mines entrance appears on Dlvl 2–4,
but note it and keep going unless you are ready: about XL 5, AC 5 or
better, full HP, a throwing stack, and an escape item is a fair bar.
Near the Oracle, take the upward branch through Sokoban for its bag of
holding or amulet of reflection. Then visit Minetown, finish the Mines
when you can handle the packs, return to the main dungeon for the
Quest at XL 14, and continue through Medusa to the Castle.

**[Sokoban](#sokoban) or Mines first?** You usually encounter the Mines
first (Dlvl 2 to 4), but the *strategic* suggestion for most beginners
is Sokoban. It's a controlled puzzle crawl with mostly trivial
monsters, and the prize at the top (reflection or a bag of
holding) directly helps [the Mines](#the-gnomish-mines) run
afterward. The Mines are a fairer fight after Sokoban: you come back
with one of those prizes and a few more levels.
...
kings) appearing as you descend. If you're playing a gnome or dwarf,
most of them will be peaceful, which makes the Mines a
relatively comfortable detour. Everyone else fights through a steady stream of hostile gnomes and dwarves.

The Mines also have a notorious surprise guest: a mind flayer
can spawn on any random Mines level outside Minetown, including
Mine's End. *"You sense a faint wave of psychic energy"* on an
...
settlement with shops and a temple. Visit after you can manage the
Mines' packs, or return after Sokoban if the first trip turns ugly.
...
grant permanent AC reductions. A qualifying first donation grants
2–4 points of intrinsic protection, not just one. The price and
threshold are easy to misread, so use the full table in
...
peaceful unless you steal, attack a peaceful creature, break a door,
or dig in town. Anger one and the whole watch turns on you.
...
The prize at the top is usually a **bag of holding**, otherwise an
**amulet of reflection**. Either can settle a major equipment problem
before the Mines become difficult.

The entrance staircase appears somewhere around dungeon levels 6
through 10 (one level below [the Oracle](#the-oracle)), and it goes up. Sokoban
...
may not help: **squeeze past** the boulder (drop your stuff to
fit), **dig the boulder** with a wielded pick-axe or mattock, or
**fracture it** with force bolt or a wand of striking (a scroll of
earth and polymorph also count). Each of these costs a
point of Luck and breaks the Sokoban conduct. The walls themselves
are non-diggable on every Sokoban level, and pits cannot be bypassed.
Even flying or levitation will not carry you over an open pit; the
air currents pull you down anyway. You can climb back out after falling.
...
Every legitimate boulder-push exercises Strength. The puzzle gives
you plenty of practice without any need to walk around Stressed.
...
Delphi, flanked by centaur statues (empty) and four
...
to rest for a moment, though the fountains carry the usual risks.

Each type of consultation grants experience points the first time
you buy it. If your first consultation ever is a major, you get
50–100 XP (it scales with your level). A minor first gives only
5 XP, and the major afterward gives less. Repeat consultations
give nothing.
...
the [Orb of Fate](#orb-of-fate). A Samurai's path ends in a duel with Ashikaga
Takauji over the [Tsurugi of Muramasa](#tsurugi-of-muramasa). The Wizard descends into
...
Most quest artifacts are worth carrying for the rest of the game.
Each gives some mix of magic resistance, telepathy, warning,
reflection, stealth, or luck. Check whether its protection works when
carried or only when wielded or worn.
...
The whole Quest hinges on your leader's approval. Below XL 14, or with
too little alignment, you are expelled automatically and may return
after fixing the problem. If you have changed alignment, the leader
banishes you for good. Do not experiment with a helm of opposite
alignment before the Quest.
...
Fort Ludios is the stronghold of Croesus. It is optional and easy to
miss: the portal appears between Dlvl 11 and Medusa, always inside a
sealed vault, so dig in or break the door. The alarm wakes sixteen
soldiers and a lieutenant. Four dragons guard the storerooms; a stone
giant and four giant eels patrol the moat. Croesus waits on the throne
and hits hard enough that you should shoot or zap him across the moat.

The level is non-diggable and blocks ordinary teleportation. Leave by
the portal or by level teleport. The treasury holds 36,000 to 54,000
zm across sixty squares, with a land mine or spiked pit under roughly
a third of them. The corner towers hold diamonds, emeralds, rubies,
and amethysts; soldiers carry rations and serviceable weapons. None
of it is required to win. The gold is the reason to come, and it buys
...
mirrored shield. Break it with force bolt, striking, or a pick-axe to
recover a (cursed) **shield of reflection**
...
- **A mirror.** Apply it at an awake Medusa anywhere along a clear
  straight line. Every layout generates her asleep, so wake her from
  safety first.
- **One-shot kill.** A wand of death or finger of death can kill her
  before she gets a turn. Medusa resists stoning, so a cockatrice
  corpse does not work.
...
- **Wand of cold.** Zap the water to freeze a path of ice. Every other
  step may make you slip and lose two turns, and fire can melt the path
  again, but it gets you across.
...
One trapdoor can separate you from your pet, your stash, and the stair
you meant to use. Traps are invisible until you step on one, detect it
with `s`, or reveal it by another means. Once discovered, they show up
as `^`. Each search of an adjacent square has an independent
chance of revealing a trap, but the chance is well under 100%, so
search repeatedly in suspicious areas. Pets avoid only traps you have
already found; watching them reveals nothing new.
...
entirely. Except in [Sokoban](#sokoban), where the puzzle levels disable the
...
| Trap              | Effect                                      | Blocked or softened by |
| ----------------- | ------------------------------------------- | ---------------------- |
| Land mine         | Explosion and item damage                   | Levitation or flight   |
| Bear trap         | Holds you in place                          | Iron footwear prevents leg damage |
| Sleeping gas trap | Leaves you helpless for several turns      | Sleep resistance       |
| Fire trap         | Burns you and exposed inventory             | Fire resistance; bag the scrolls and potions |
| Magic trap        | Random magic, often blindness plus monsters | No general defense     |
| Anti-magic field  | Drains energy; may also damage you          | Positive iron footwear can absorb the drain |
| Polymorph trap    | Changes you into a random creature          | Magic resistance, Unchanging, or iron footwear |
| Rolling boulder   | Sends a boulder down a fixed track          | Stay out of the track  |

Fire traps threaten your pack, not just your health. The fire
itself hurts, but the danger is what happens to your inventory: scrolls
...
With [polymorph control](#special-and-utility), a polymorph trap lets
you choose a new form. Without it, the trap chooses for you, possibly
turning you into a newt that cannot use any of your equipment.
...
to hit you like it's a buffet. [Sleep resistance](#damage-resistances)
from elven blood, orange dragon armor, or the right corpse prevents it.
...
your invisibility, one uncurses worn and wielded items, and one tames the
...
Magic resistance blocks a teleport trap. If you want to use one, stand
on it after it has been discovered and press `Ctrl+T`; the command
does nothing from another square.
...
half-spell damage, plus d4 for wielding [Magicbane](#magicbane), plus
...
- **Flying and levitation** make you immune to most floor traps
  (you still trigger webs and magic, teleport, level-teleport,
  polymorph, and anti-magic traps)
...
empty room, a scatter of arrows or darts on the floor, or a themed
room whose gimmick is hidden hazards.
...
secret. Searching once and moving on is announcing your
...
If the down stair is already known, take it. Wall-tapping is for a
level whose exit or special room is still missing, not a ritual to
perform on every floor.
...
or force bolt pass through harmlessly. What gets through is acid:
a yellow dragon's breath, or a potion of acid shattered against
the bars. The potion is the handy one. Wield it and force-fight
(`F`) into the bars, and the splash dissolves them away. And if
you happen to be chained to a heavy iron ball, you can wield the
ball and batter the bars apart by hand, though it takes about
twenty-five swings.

Usually, dig around them. Bars sit in a niche
...
What's usually behind: a scroll of teleportation.
...
The Mazes hide warnings inside bits of atmosphere. Learn the four
emergency messages first; use the later tables when a stranger one
appears.
...
| *"You are turning into a green slime."* | Green-slime contagion. Burn it off (read a fire scroll, cast fireball on yourself, or self-zap a wand of fire), or `#pray`. |
...
| *"You hear crashing rock."*            | A tunneler (dwarf, rock mole, or umber hulk) just dug through stone.                    |
| *"You hear rumbling nearby."* (or *in the distance*) | A rolling boulder trap just fired offscreen. *"You hear a rumbling stop abruptly."* means a rolling boulder hit a teleport trap. |
...
| *"You feel a mild buzz."*              | A newt corpse restored 1–3 mana.                                                       |
...
#### Identification and Status Changes
...
| *"You feel that monsters have difficulty pinpointing your location."* | A cloak of displacement just turned on. *"…no longer have difficulty…"* means it just turned off. |
| *"You hear the rumble of distant thunder…"* | You killed your own pet (or tame creature): −15 alignment and −1 Luck. Prayer fails until your alignment is positive again. |
...
| *"You hear someone summoning something, and…"* (and *"…summoning <something>"*) | A priestly spell summoned insects or snakes offscreen. Mage summoning says *"Monsters appear from nowhere!"* |
...
| *"You feel less paranoid."* | Secret-door detection cleared an old `I` marker from the map; it says nothing about where the monster went. |
...
| *"Wow! This makes you feel great!"*    | Blessed potion of restore ability, restoring all attributes, with no remaining troubles; or a magic-fountain hit. |
---

## Part Three: Survival

When the game pauses on a dangerous turn, begin with [Saving Yourself
from Imminent Death](#delayed-deaths). For ordinary fights, the short
rule is simpler: enter at full HP, decide whether you are winning after
the first exchange, and know which stair or door you will use if not.
[Elbereth](#elbereth) belongs in the same mental kit as prayer and a
healing potion; use it before the monster is adjacent.
...
Not every fatal threat kills instantly. The message tells you how
long you have and what to reach for.

| Threat | Warning | Time | Reliable answers |
|---|---|---:|---|
| Stoning | *You are slowing down* | 5 turns; helpless after 3 | Lizard or acidic corpse, acid, prayer |
| Sliming | *You are turning into a green slime* | About 10 turns | Fire, cure sickness, suitable polymorph, prayer outside Gehennom |
| Food poisoning | *You feel deathly sick* | 10–19 turns | Non-cursed extra/full healing, blessed healing, eucalyptus, unicorn horn, prayer |
| Lava, no fire resistance | You fall into the lava | None | Prevent with levitation or flight |
| Lava, fire resistant | You sink into the lava | About a dozen turns | Levitate, teleport, step out, prayer |
| Eel or kraken wrap | The monster swings itself around you | The next landed wrap can drown | Magical breathing, kill or teleport the monster |
| Strangulation | *It constricts your throat!* | 6 turns | Remove or uncurse the amulet, pray |

**Sliming.** Being hit by a green slime or eating its glob starts a
roughly ten-turn transformation. **Cures:** burn
...
underway. Cancelling the green slime prevents new
...
fails, so don't plan on it.

**Illness (food poisoning).** Eating a rotten or badly aged corpse
gives you food poisoning, which kills in
10–19 turns ("You feel deathly sick."). **Cures:** non-cursed extra
or full healing, blessed healing, a unicorn horn, prayer, or a
eucalyptus leaf. Poison resistance does not protect against food
poisoning. That is *sickness resistance*, a separate intrinsic.
...
**Sinking in lava.** Without fire resistance, lava kills on contact
and burns your pack first. With fire resistance, you sink instead and
have about a dozen turns to leave. Levitate, teleport, step out, or
pray. Fire resistance stops the burn, not the sinking.

**Drowning (being held).** When grabbed by an eel or kraken in water,
the next wrap that lands can drown you. The drown
...
**Strangulation.** An amulet of strangulation kills in six turns.
Remove it immediately if it is not cursed. Otherwise uncurse it with
remove curse or holy water, or pray.
...
-->
### Engravings and Elbereth {#engravings}
...
| Other edged weapon        | Several turns | Semi-permanent | Interruptible. Dulls to −3; a +0 blade stops at "Elberet," while +1 or better can finish the word. |
...
- **Fragile (dust).** A monster stepping on the square smudges
  ...
  stays clear.
- **Semi-permanent (scratched into the floor).** Each monster step has
  a one-in-26 chance to chip a character. It lasts much longer than
  dust, but not forever.
...
In an emergency, write Elbereth in the dust with your finger. It costs
no item but does consume your action, so write before contact. Most monsters will
...
interruption risk, and no ordinary wear. Blindness, confusion, stun,
or hallucination can still scramble the spelling. A
...
weapon. A wand of fire, lightning, cold,
or digging still works from above. You'll see "you gesture toward
the floor below you" first, but the burn lands anyway.

**Never engrave on an altar or a grave.** On an altar, writing
anything — Elbereth included — engraves *nothing* and angers your
god: you lose Wisdom and alignment on your own altar, or Luck on
any other. So the reflex to scrawl Elbereth when a monster corners
you at an altar backfires; step off first. Engraving an
undisturbed grave with a weapon or wand disturbs it and summons a
ghoul (a bare finger only smudges it). And a fountain square
can't be engraved at all.

A **scroll of scare monster** dropped on the floor is Elbereth's
stronger cousin. Stand on it and most monsters keep their
distance, and it beats the ward on three counts: it still works
in Gehennom and on the Astral Plane where Elbereth is dead,
it repels minotaurs and blind monsters that walk through
Elbereth, and you can fight from it freely, since it is not
an engraving and so never defiles or costs you the hypocrite
alignment hit. It doesn't erode, and its square stays off-limits
even when you step away. Its weakness is pickup: taking it
...
Add 1, your XL, Strength and Dexterity bonuses, about a third of your
Luck, weapon enchantment and skill, then the target's AC. Your attack
hits when the d20 rolls *under* that total. A negative target AC lowers
the number, so enchantment and weapon skill matter more as you descend.
...
- Strength bonus (up to +6 before a two-handed multiplier)
...
At 18/100 Strength, that +6 becomes +9 on a two-handed sword. Its
d12+9 averages about five more damage per swing than a long sword's
d8+6, before enchantment and skill.
...
Negative AC is rolled afresh on each attack, and monster level still
adds to the chance to hit. At AC -20 an ogre connects about one swing
in four, while a level-15 monster lands roughly two in three. Many late-game threats use special
...
extrinsic Protection bought from any priest.
See [the Armory](#armor-and-ac) for picks by slot.

**Test the dangerous slots first.** Drop boots and gloves on an altar,
or see whether your pet is reluctant to cross them. At AC 6 or worse,
with no test available, wear ordinary suits, helms, shields, and
cloaks; being stuck in one is usually safer than staying unarmored. See
...
**Divide before you engage.** A useful number in a
...
**Speed grants extra moves probabilistically.** **Fast**
...
wins. Speed boots are the easiest source: put them on once and stop
spending potions or spell energy on speed.
...
a baseline Unencumbered one. At Stressed, a speed-6 zombie keeps pace;
at Strained it acts twice per move. Get to Unencumbered, ideally with a
bag of holding.
...
impressive and gives a second swing per turn. Each
...
Barbarian at Basic. Rangers, Healers, Monks, and Wizards cannot use
the style.
...
to be a one-handed melee weapon. If it is cursed when you try to
start, it slips to the floor.
...
Samurai get +1 with a yumi and ya; Skilled adds +1 and Expert +2;
the Longbow of Diana adds +1 while wielded. At Expert with a
matching role, the game rolls from one projectile up to the maximum.
An Expert Ranger averages about two and a half shots a turn.
...
thirty unbroken +2 arrows can keep shooting through the long fights.

#### Fighting Smart

The dungeon rewards cowardice, cunning, and property damage. Make the
fight unfair before it starts.

##### Position before contact

**Use corridors.** Monsters can only approach one at a time in a
corridor. Do not fight a crowd in an open room when a chokepoint is in
reach.
...
**Step around a corner.** An approaching monster spends an action
rounding it. A monster that has just stepped next to you does not swing
in that same action, so you attack first.
...
**Keep an exit at your back.** Keep at least one square open toward your fallback:
a staircase, a known corridor, an Elbereth square. Stairs are
the best of these. Most monsters stay behind, though soldiers,
watchmen, vampires, trolls, wraiths, and imps may follow when adjacent.
On the return trip, expect the rest of the pack to be waiting at the
stair.

**Doors and diagonals.** You cannot move diagonally through a
doorway, so approach and leave orthogonally. **Closing a door**
(`c` + direction) stops any monster that lacks the wits or hands
to open it, most animals included. Close one behind you and a
pursuing beast is stuck on the far side while you rest and heal.
It also blocks your pet, handy when you want to slip away for a
turn.

**Jump when you have a source.** With the jumping spell,
jumping boots, or a Knight's innate jump, `#jump`
crosses several squares in one turn. Use it to escape a faster
monster, reach a corridor or an Elbereth square without walking
through attacks of opportunity, clear most known traps (not fire
traps or level portals, and not in Sokoban), burn off Satiated
status before eating an intrinsic-granting corpse, or cross
Medusa's island gap.
...
**Stay in your pet's path.** A pet next to the monster draws some of
its attacks and adds its own. Step so the pet can reach the fight
rather than blocking its approach.

**A sleeping room is not safe.** Each monster that sees you has a
one-in-seven chance to wake every turn; dogs and human monsters wake
at once. Stealth prevents the random wake-up. A hit wakes the target,
whose growl may wake other sleeping monsters within roughly four squares
...
##### Ranged and Frightened Monsters

**Ranged attackers retreat.** Archers and spellcasters back away when
you close to melee range. A centaur archer may retreat and keep shooting.
...
past the dance. Spellcasters use the same room to keep casting while
you struggle to close.
...
nowhere to flee will turn and fight rather than stand
helplessly while you recover. If you have carved
[Elbereth](#elbereth) in a corridor and then backed a monster
into a dead end, expect it to turn and fight. Keep an exit behind the
monster.
...
requires alignment record at least 20 *and* XL 14. These one-point
penalties can be repaired by killing hostile monsters, but may delay
your [Quest](#the-quest).
...
2026-07-30 accuracy pass vs NetHack-5.0 source:
- Sleep resistance is from elf corpses only; an elven mummy drops an already-old elf corpse, so eating it risks food poisoning (mon.c:620-646; eat.c:908). Giants convey Str/elemental res.
...
Only about **0.4% of dungeon expeditions end in ascension.**
...
**On pacing.** Rest after fights and take a stair at full HP, or at
least above 90%. Maximum HP predicts survival better than trying to
keep XL even with Dlvl. Explore what you can use, but once the down
stair is known, do not spend food on empty rooms or fruitless searches.
Descend with a ranged attack and a way back out, such as a scroll or
wand of teleportation. Most stair deaths begin with someone arriving
on a fresh level already hurt and with no escape ready.

#### Common Combat Deaths

Beyond the top ten, certain enemy categories kill more
beginners than their depth or appearance would suggest. They come in
packs, move faster than you, or have one attack you cannot afford to take.
...
level, but come back with about XL 5, AC 5 or better, full HP, a
throwing stack, and one escape item. Sleep resistance helps, but is
...
comes from being an elf at XL 4, orange dragon armor, and several
corpses. Neither the Wizard's cloak of magic resistance nor the
Ranger's cloak of displacement supplies it.
...
Strength). Fight from a doorway so they cannot circle you, or kill
them at range.
...
The iron golem is the heaviest threat here: level 18, 4d10 weapon
...
summons a water demon roughly 1 quaff in 30. The wish roll happens as
the demon appears: a grateful one grants it immediately and vanishes;
otherwise the level-8 demon attacks. Wish odds also drop with
...
reach you. Minotaurs ignore Elbereth.

**Major demons gate in more major demons.** Once per attack round, a
major demon has a one-in-16 chance to summon another outside Gehennom
and a one-in-ten chance inside it.

#### Deadly Mistakes

Routine mistakes kill more adventurers than exotic instadeaths. The
list below is a field guide, not a server ranking.
...
The Confused or Fumbling or Glib cases have worse odds, and
a fresh pet at XL 2 throws you 9 times in 20; a barely tame one does
so about 17 times in 20.
...
**Boiling and shattering potions.** A potion dropped on Gehennom's hot
floor breaks about half the time, harmlessly. Fire reaching the
potions in your pack is what can boil them and kill you. Bagging your potion and scroll stash is
wise: a fire trap or a red dragon's flames incinerate loose
scrolls and potions, and a white dragon's frost shatters loose
potions.

**Wands in the wrong hands.** Monsters use attack wands, and a ray can
ricochet off a wall back into your face. Reflection and magic
resistance matter long before Gehennom. Engrave-test an unknown wand
before aiming it at anything alive.
...
Kicking a door merely gives a harmless *Whammm!* when it fails, but a
wall hurts. Trapped chests are a separate danger. Kick only when you
...
Most early deaths are ordinary fights allowed to run one exchange too
long.
...
**Only theft.** Both claws use the same attack: each takes either an
item from your pack or something you are wearing. She costs you gear,
not hit points.
...
climb to hunt her down and kill her, and the mysterious force
does not pause while you search.

#### A Note on Mimics

Mimics are far tougher than their depth suggests: their claws hit hard
...
the upper levels is a small one with a 3d4 claw.
...
#### A Note on Werecreatures

A bite from a **werejackal, wererat, or werewolf** can infect you
with **lycanthropy**, and the infection, not the bite, is the
danger. You then transform into the beast at random, roughly every
60 to 80 turns and more often at night. Each shift forces you out
of your armor; a werewolf destroys your body armor and shirt but drops
the cloak intact, then leaves you in a weak beast body. You revert on your
own, but a mid-fight transform leaves you stripped at the worst
possible moment.

When the werecreature *summons help*, write Elbereth at once. The
summoned animals respect it, but the werecreature's human `@` form
walks through, so keep an exit as well.
...
dagger, elven dagger, club, quarterstaff). These don't
trigger the split. Mithril also bypasses the check. Fire kills without
splitting; brown and black puddings resist cold. Most attack spells
work too.
...
be farmed for offerings. The globs remain edible for about 500 turns
and are packed with resistances. A
...
gray ooze are *vegetarian*-safe; black pudding is not. Globs of the
same color merge into one meal with one resistance roll, so eat them
one at a time off the floor before they combine. The full intrinsic table is in
...
**Silver** dragon scale mail grants reflection, turning away most ray
attacks.
...
trip. Yellow dragons are no rarer than the other colors.
...
digestion, which slows hunger on long descents.
...
resistance, covering both poison and illness attacks.

**Blue** dragon scale mail grants shock resistance *and* intrinsic
**speed**, same tier as speed boots. (Wearing both at once doesn't
make you faster; either alone reaches Very Fast.) That combination
makes blue an excellent general-purpose choice.

**Gold** dragons breathe fire. Their scale mail has no elemental
resistance but is permanently lit (radius 4 blessed, 3 uncursed, 2
cursed), so it can replace torches and oil. It also confers
hallucination resistance.

All scale mails are dragonhide, body-slot, and +9 AC worn. Dragonhide
resists rust, corrosion, and fire, but not disenchantment. The choice of
...
back up at full HP, fresh and angry. About three troll corpses in four
get back up within fifty turns.

**Stopping the revival.** Eat the corpse, tin it, feed it to a pet, or
kick it into lava. Teleport only moves it elsewhere on the same level,
and striking does not destroy it.
...
variant to fear, a three-attack hitter at level 13.

#### A Note on Wraiths

The `W` class has a touch attack that **drains an experience
level**, one of the few permanent character setbacks in the
game. You lose maximum HP, energy, and the most recent skill slot, but
not attribute points. A potion of restore ability returns lost levels.
The wraith can
land the touch again if you let it, so plan the kill from across the
room.

**The corpse gives you a level.** The touch is melee-range only,
so engage at distance or from inside a corridor where you control
the spacing. A wraith corpse rots at the ordinary rate; eat it
while it is fresh and the room is safe.

**Farming wraiths.** Mid-to-late-game players hunt
wraiths in the upper Quest and throughout Gehennom for experience levels.
...
Both lights die in the explosion; the blindness or hallucination is
what endangers you. **Defenses:** kill them at range with wands, thrown daggers, or
...
your save and **deletes the save file in the process**. There is no
reloading after a death. Copying the save file outside the game to
retry one is called **save scumming**, and is cheating.
...
Minetown and Quest filler levels (but *not* Sokoban,
Mines' End, the Castle, any level of Vlad's Tower, or the
...
down). The overview records *"Final resting place for..."*. The entry
message *"This place looks familiar..."* appears only when the bones
came from one of your own former characters.
...
- The dead hero leaves behind a *named* remnant — usually a
  ...
  **green slime** for a sliming death, or a **statue** if the
  ...
  where it fell.
- Every non-artifact item directly in the hero's inventory has an
  **80% chance of being cursed**. Contents of containers are untouched. Pet
...
above the level's normal difficulty. Whatever killed the previous
adventurer is usually still there, and often far too strong for the
depth. Treat
...
Some things in the Mazes kill in one move no matter how many hit
points you have. Players call them instadeaths. Nearly every one gives
a warning a turn or two ahead if you know what to look for.
...
**Defense:** Reflection bounces rays; magic resistance blocks death
and magic-missile rays. The first time most monsters zap a beam wand
...
at you and have a turn to react before the next zap connects. Monsters
native to the Castle, Ludios, the Quest, Gehennom, Vlad's Tower, and
the Planes get no warning miss.
...
prompt you. Past a hard nutrition threshold only a one-in-20 escape,
or being Breathless, keeps the meal from killing you
instantly.
...
remove curse. [Magic resistance](#damage-resistances) doesn't help.
Polymorphing into a Breathless form
*does* save you.
...
spiders) have a poison-damage branch that can deliver 10 to 30
...
so on. Skill loss has to be earned back at training posts, so do not
stand and trade blows with a mind flayer.
...
flayer's *mind blast* locks on every time when telepathy reveals you,
but can still fire one time in ten without it. Taking off an amulet of
ESP lowers the risk; it does not remove it. To recover drained Intelligence you need a
...
Other engulfers don't hide. Purple worms digest; vortices and fog
clouds engulf and batter you without digestion. Dragons do not swallow
you.
...
Petrification is the reason players carry a lizard corpse. Touching
or eating a cockatrice without protection, kicking its corpse
barefoot, or meeting Medusa's gaze kills at once; a lizard cannot help.
Stepping on the corpse is safe unless Fumbling trips you onto it.

A cockatrice's hiss or a thrown egg instead starts a five-turn
countdown. It announces itself with *"You are slowing down,"*
...
resistance from acid blob corpses (each one grants 3–18 turns).
For something
...
classic offense, known to veterans as the "rubber chicken," handles
many demon lords. Medusa and the Riders resist stoning. The
...
breath first: the **shield** is destroyed first if you have one, then
your **body armor and cloak** together; only if neither is worn do you die outright
...
[Stormbringer](#stormbringer) in an enemy's hand does the same. Drained levels do
...
sources are wielding [Excalibur](#excalibur-artifact) (Lawful), Stormbringer (Chaotic),
or the [Staff of Aesculapius](#staff-of-aesculapius) (Healer's quest artifact). New in 5.0:
...
Wraith corpses are weightless and can't be tinned (no nutrition),
so eat them fresh the moment the fight ends.
...
**Disenchanters** (`R`, blue) appear only in [Gehennom](#gehennom).
Their claw drains worn gear; hitting one in melee drains your weapon.
...
your own role species. Check your status before reading one.
...
A happy god answers prayers, forgives
transgressions, and occasionally sends gift artifacts. An angry god
smites you.

#### Prayer

Praying (`#pray`) calls on your god for help. When conditions are right, prayer pulls you back from stoning,
starvation, or near-death. When conditions are wrong, it can kill you.
...
**What prayer fixes (in priority order).** Your god fixes the most
urgent trouble first:
...
- The **prayer timeout** must have expired. After a successful
  ...
  around 450 turns but can run much longer. In a
...
**The short rule:** pray for a listed trouble only when your alignment
and Luck are non-negative, your god has not expressed anger, and you
are off another god's altar and outside Gehennom. If you have never
prayed, wait until after turn 300. Afterward, allow about a thousand
turns between prayers when you can; the average recovery is nearer 500,
...
**Prayer timeout tracking.** The game does not show the number. Five
hundred turns is an average, not a promise; use a thousand as the safe
rule when the run gives you that much room.
...
no goodwill, so use it freely, paying only a few turns of
paralysis while you chant. But like prayer it **fails in
[Gehennom](#gehennom)**, so it's dead weight in the Valley of the
Dead. The turn undead spell is different: it fires in one direction,
scares one target, and works there.

#### Sacrifice

Sacrifice trades a fresh corpse for favor. On a co-aligned altar,
`#offer` first calms an angry god, then repairs alignment and prayer
timeout; once those are sound it can raise Luck or produce an artifact.
Holy water and crowning come from prayer on the altar, not the
sacrifice itself.
...
If only your first gift exists, the next chance begins around one in
eight; more gifts and more existing artifacts make it worse. Don't be surprised
if you get one artifact and then nothing more for thousands of
turns.

The first gift is not merely biased for several roles. A Valkyrie,
Wizard, Barbarian, Samurai, or Priest can receive only the role's
signature artifact first, and it adopts the hero's alignment. The
corpse also caps what can appear: Sting, Ogresmasher, and Trollsbane
need only a value-1 offering; Vorpal Blade and Fire Brand need 5;
Frost Brand needs 9; Grayswandir needs 10. Save a troll-class corpse
when fishing for the strongest gifts.
...
- **Clairvoyance.** 500–999 turns per suggested amount of automatic short-range
...
If you walk in carrying far more gold than the baseline, the priest
scales the ask to your purse. The useful thresholds are the two
numbers in the prompt: pay at least the first for clairvoyance and the
larger for protection.
...
- **Donate early, donate often.** Protection stacks, so 500 zm at
  ...
  the Minetown temple every time you climb back up from [the Mines](#the-gnomish-mines)
...
- **Do not start the conversation unless you are willing to pay.** A
  zero offer counts as a refusal: it costs alignment and marks you as
  a cheapskate just like a token offer.
...
(success), costs you Luck (failure), or, if your alignment record is
negative, converts *you* to the altar's alignment instead. Better
...
Above XL 8, either result can also summon a hostile minion of the
displaced god. Have an exit in reach before you make the offering.

Keep two things off every altar:
...
- An alignment gift, with exceptions. A Lawful crowning transforms
  the long sword you are wielding into [Excalibur](#excalibur-artifact), so
  having a +7 long sword in hand at the moment of crowning gives
  you a +7 Excalibur; with no long sword there is no sword. Wizards
  and Monks receive their spellbook instead of the weapon.
...
Crowning makes every later prayer add roughly 1,000 turns on top of
the ordinary timeout. If you're sacrificing to fish for an
...
depending on your role. It follows you between levels (if adjacent when you take
...
Pets have an invisible tameness score that decreases when you leave
them behind on another level for too many turns, drag them by a leash,
or hit them yourself. Hunger affects their behavior, not tameness. (Combat damage
...
You'll find tripe rations scattered through the dungeon. Always pick them up, even though
they're revolting food for humans. Your pet will adore you for it
(unless it's a horse, which prefers fruit). When you're carrying
food your pet likes, it will follow you more closely.

**Is it hungry?** There's no meter, but `#chat` to the pet and the
sound tells you, graded by how recently it fed:

| Pet       | Just fed | Content   | Hungry     |
|-----------|----------|-----------|------------|
| **Dog**   | yips     | barks     | whines     |
| **Cat**   | purrs    | mews      | meows      |
| **Horse** | —        | whickers  | whinnies   |

The hungry sound is your cue to feed. It doubles as the unhappy
sound, so read it in a calm moment: a cat that **yowls** or a
horse that **neighs** has nearly gone feral.
...
or the charm monster spell, you can recruit a purple worm to
  swallow your enemies whole, a dragon to breathe
...
- **Curse detection.** The drop-and-watch trick is free but
...
monsters, drowning in water. Use a stethoscope to check your
companion's health, and don't lead it into fights it can't win.
...
forgets you were friends.
A **magic whistle** warps every pet on your level to a square
next to you, even on no-teleport floors. Sokoban has no special
protection against loyalty decay; do not leave a pet there while you
clear another branch.

If you see *"You have a sad feeling for a moment"*, that's
different: a pet of yours just died
offscreen on another level, usually one you left behind.
...
or cursed (BUC for short). The gods have opinions about your equipment, and those
opinions have consequences:

- A **blessed** scroll of identify reveals one to four items, or the
  whole pack one time in five. Positive Luck raises the minimum to
  two. An *uncursed* scroll usually identifies one item, but one time
  in five it gets the blessed result. A *cursed* scroll identifies
  only itself the first time you read one of that type, then one item
  per subsequent cursed read.
...
Repeatedly walking around it is strong evidence that it is cursed;
walking over it once is not proof that it is safe. Food, fear, combat,
and pathfinding can spoil the test. A further trap: a helm of opposite
alignment or dunce cap may test uncursed and then curse itself when
worn. Fumbling gloves and levitation boots do not autocurse, but they
are generated cursed often enough that you should still test them.
...
blessed one. You make holy water by placing potions of water on a
co-aligned altar and making a successful prayer there. It is precious
in the early game, so save it for items you've already identified.

**Scroll of identify.** Save this for objects that the cheaper tests
cannot settle. A blessed scroll identifies one to four inventory
items—or everything, one time in five. Positive Luck guarantees at
least two. An uncursed scroll usually identifies one item but gets
the blessed result one time in five. Pick up every unidentified item
before reading a blessed scroll so the all-inventory result reaches
everything you own.
...
Every unidentified object has a fixed base price. With Charisma 11–15
and no surcharge, the shopkeeper's buy quote is that base price; the
ordinary offer for an item you sell is half of it. That makes a shop
an identification station as well as a market.
...
To quote an item without picking it up, stand on it and press **`:`**,
or **`#chat`** with the shopkeeper while you are standing there. Do
not throw your own object in from the doorway: you get no quote, and
the shopkeeper pockets it.

Three conditions impose the same Tourist markup: wearing a *dunce
cap*, playing a *Tourist below XL 15*, or showing a *T-shirt or
Hawaiian shirt* with no body armor or cloak over it. Each raises buy
prices by a third and cuts ordinary sell offers from one-half to
one-third of base; the conditions do not stack. Charisma changes buy
quotes only. Cover the shirt before doing business.

Items in the same category that share a base price
are in the same **price group**. A price often narrows an object to
two or three candidates. Low Charisma raises buy quotes (to twice
base at Cha 5 or less); high Charisma lowers them (to half base at
Cha 19 or more). The tables below do the conversion.

Two wrinkles affect unidentified merchandise. About one object in
four carries a permanent one-third buy surcharge, so identical-looking
stacks may receive different quotes. About one shopkeeper in four
offers only three-quarters of the normal sell price for unidentified
goods; that habit applies to the shopkeeper, not the object. If a
quote misses the expected tier, check the neighboring tier as well.

**Angry.** Attacking a shopkeeper, zapping a wand at one, leaving
with unpaid goods, or refusing to pay for shop damage makes the
shopkeeper angry. Even after you settle matters, a pacified
shopkeeper keeps a one-third buy surcharge. Sell prices are
unaffected.

**After a fight.** If you actually attacked a shopkeeper rather
than just running up a debt, they want blood, not gold. You can
still buy them off. Press `p` to offer 1000 gold pieces, which
you must have in hand. If you are the shop's registered customer
the offer fails about one time in three, wasting the gold and
leaving them furious. Otherwise they calm down, minus the usual
surcharge.

**Invisible.** A shopkeeper will not do business with a customer
they cannot see. Walk in invisible and you get "Invisible
customers are not welcome!" and no quotes, no sales. If you are
stuck invisible, wear a mummy wrapping as your cloak: it blocks
...
Each row gives the price you'd transact for the listed base prices.
...
**Sell rows** at the bottom give what an unangry shopkeeper
...
The $100 group is crowded, so its quote seldom settles an identity.
A $20 scroll is identify. The $60 group contains blank paper and
enchant weapon; $80 means enchant armor or remove curse. Those narrow
groups are good places to spend a use-test once BUC is known.

```{=latex}
\needspace{6\baselineskip}
```

A *single* scroll sealed in a one-square niche with no door—sometimes
behind iron bars—is a scroll of teleportation. It is there so that a
creature teleported into the niche can leave.
...
| ----- | ----- | --------------------------------------------------------------------------------------------------------------------------- |
|   100 | 1     | confuse monster, detect monsters, force bolt, healing, jumping, knock, light, protection                               |
...
Only four rings cost $300, and three of them are excellent: conflict,
[polymorph control](#special-and-utility), and [teleport
control](#movement-and-spatial-behavior). The fourth is polymorph,
which usually generates cursed.
...
1. **BUC-test the wand first.** A cursed wand has a 1-in-100 chance
   to explode when used for engraving. Drop it on any altar, or use
...
3. **Engrave again with the wand.** Use `E` and select the wand.
   ...
   engrave-test result for each wand; most reveal themselves here.
   A wand of lightning also blinds you for up to 50 turns, so do not
   test one while monsters are near. A few wands share results; see
   [Resolving Ambiguous Engrave Results](#resolving-ambiguous-engrave-results).

**A suspected wand of wishing is safe to engrave-test.** If a $500
candidate asks *"For what do you wish?"*, the test has spent a charge
and granted the wish. Make it count.
...
under the sink; otherwise it is gone. Use a spare ring, not your only
candidate. See [Sinks](#sinks) for the message table.
...
ammunition (arrows, crossbow bolts, darts, or shuriken)
...
**Oil is the only potion you can apply.** `#apply` an
unidentified potion and, if the game offers to light it, it's a
potion of oil; nothing else responds.

A dip also makes a quick safety check before drinking blind.
Acid corrodes a dipped arrow and sickness coats it with poison,
so **if you dip a spare arrow and nothing happens, the potion is
neither acid nor sickness** (nor oil, polymorph, or holy water). That
won't clear paralysis or sleeping, which give no reaction but
will still leave you helpless.

**Testing a $200 potion.** The $200 group (enlightenment, full
healing, levitation, polymorph, speed) has good payouts but two traps.
Uncursed levitation lasts 10–149 turns; blessed levitation lasts
250–299, though you can press `>` to descend early. Polymorph may put
you in a form that destroys or sheds body armor. Strip to a shirt and
test only when nothing is hunting you.

**Scrolls.** Reading is risky. Some scrolls (destroy armor, amnesia,
punishment) are outright harmful. Safest is to price-ID
first, then read from safe price groups. If you must test
...
**Amulets.** BUC-test an amulet before wearing it. Strangulation kills
in six turns; remove the amulet immediately, or pray if a curse holds
it on. Restful sleep can leave you helpless. An amulet of ESP reveals
itself if you go blind while wearing it; reflection becomes apparent
when a ray bounces from you.

**Armor.** Magical armor reveals itself when worn: speed boots
make you faster, a cloak of invisibility makes you invisible. But
trying on unknown armor in a shop is dangerous: if it is cursed you
cannot take it off, and the shopkeeper still expects payment. A helm
of opposite alignment or dunce cap can even curse itself on wear.
**Verify BUC before wearing unknown armor in a shop.** Outside a shop,
survival takes priority: at AC 6 or worse, wear found body armor,
helms, shields, and cloaks if you cannot test them. Keep testing boots
and gloves first; their bad magical variants can be immediately
dangerous.
...
Prices do not shuffle. They separate the safe boots and cloaks from
the cursed ones.
...
| ----- | -------- | ---------------------------------------------------------------- |
|    10 | Helms    | plain helmet                                                      |
|    50 | Helms    | caution, opposite alignment, or telepathy                         |
...
A $30 pair of boots is the warning sign: both candidates are usually
generated cursed. A $50 pair is desirable. A $60 cloak is either
invisibility or magic resistance. Price cannot separate $8 elven
boots from kicking boots, or the three kinds of $50 gauntlets; after
a BUC test, wear them and watch the messages.
...
Gray stones range from a luckstone worth carrying all game to a
loadstone you cannot put down. There are four types:

| Price | Stone                | Effect                                     |
| ----- | -------------------- | ------------------------------------------ |
|     1 | flint **or** loadstone | flint is sling ammunition; loadstone weighs 500 units, usually cursed, and won't drop once carried. Use the kick test (loadstones don't scoot). |
...
**The price test.** At base price, $60 means a luckstone, $45 a
touchstone, and $1 flint or a loadstone. The random unidentified-item
surcharge can make a $45 touchstone quote at $60, so only a $45 quote
...
Before picking up a gray stone, kick it and check BUC. A few seconds
of testing can spare you a 500-unit loadstone welded to your pack.
...
All of these techniques combine into a workflow:

**At an altar** (priority one). Ferry unknown equipment to the altar
and drop each item. Sort the pack by BUC; whether to wear, stash, or
discard an object still depends on what it does.

**At a shop** (priority two). Stand on unidentified items and press
`:` for quotes. Group them by price and compare them with the tables.

**Engrave-test your wands** once BUC is known and the area is safe.
The test costs one charge. Gravel identifies digging; ice cubes
identify cold. Be prepared for lightning blindness.
...
unknown high-level book can paralyze you for many turns among whatever
is nearby), **amulets** next (all the same price), then
the resistance/utility rings in the $200 group, then any wands
that engrave-tested ambiguously.

Use the cheapest safe method first: altar, shop, engrave test,
controlled use-test, then a scroll of identify.
...
- **Rings** usually cost 1 extra nutrition every 20 turns. Regeneration,
  conflict, and hunger rings cost ten times that while active.
...
| 0 or below | Fainting  | Collapse at random; eat or pray at once.  |
...
If you are merely Hungry and have no food, take the stairs down. A new
floor offers corpses and provisions; searching an exhausted one does
not.

#### What to Eat

**Eat what is safe.** Unless you are keeping vegetarian conduct, much
of your nutrition can come from fresh kills. Check the corpse before
you save a ration; freshness alone does not make it edible.
...
three for when you don't have a fresh kill in front of you.
You don't need to hoard them.

**Lembas wafers** provide 800 nutrition at only 5 weight. Elves gain
a quarter more nutrition from them; orcs gain a quarter less.
...
Before eating a corpse, ask:

1. Is it fresh—roughly under 50 turns old?
2. Is it neither a `c` corpse nor Medusa?
3. Is it not green slime?
4. Is it not my own race, unless I have the Cave Dweller or orc exemption?
5. Is it not a dog or cat, unless I accept aggravate monster?

Then check the table below for poison, acid, and unusual effects.
...
gives the aggravate monster intrinsic. Cave Dwellers and orcs are exempt.

#### Useful Corpse Effects

Eating for intrinsics pays off through the early
and mid game. Each resistance is a *chance* per eat, not a guarantee,
so eat *every* one you find, not just the first. The tables below
give a verdict for every monster symbol: each row's **general** ruling
plus the members that differ. Eat corpses **fresh** (much over fifty
turns old risks food poisoning), and a `*` marks a resistance that is
only **temporary**.

**No corpse, nothing to eat:** `A` angels, `&` demons, `L` liches,
`v` vortices, `y` lights, plus the exceptions named in the tables.

**Undead substitutions:** ordinary vampires, mummies, and race-based
zombies leave an already-old corpse of their base race despite carrying
the no-corpse generation flag. Treat it as tainted unless you have
sickness resistance. Vlad, ghouls, and skeletons leave nothing edible.

**Usually plain meat:** `C` centaurs, `G` gnomes, `J` jabberwocks,
`K` Kops, `o` orcs, `O` ogres, `p` piercers, `q` quadrupeds, `t`
trappers, `U` umber hulks, `w` worms, `z` zruties. Cats, dogs,
leprechauns, and nymphs have important effects listed below.

[]{#vegetarian-safe-corpses}
**Vegetarian-safe corpses** (vegan, except the pudding globs, which
are vegetarian only):
...
| `d` | Dogs & canines | Little dog through large dog grant permanent aggravate monster unless you are a Cave Dweller or orc. Hell hounds → fire res; winter wolves → cold res; were-jackal/wolf leave no corpse. |
| `e` | Eyes & spheres | Mostly no corpse. A fresh **floating eye → telepathy**; eat it when the room is safe. |
| `f` | Felines | Kitten through large cat grant permanent aggravate monster unless you are a Cave Dweller or orc. |
...
| `i` | Imps & minor demons | Imp, homunculus, quasit, and tengu leave corpses. Homunculus is poisonous → sleep/poison res; quasit → poison res; **tengu → teleportitis or teleport control.** |
| `l` | Leprechauns | One chance in two to grant teleportitis. |
| `k` | Kobolds | **Poisonous** (no upside). |
| `m` | Mimics | Edible, but eating one briefly glues you in place. |
| `n` | Nymphs | About one chance in three to grant teleportitis. |
...
| `E` | Elementals | Mostly no corpse. Eat a stalker while visible for brief invisibility and stunning; eat one while already invisible for permanent invisibility and see invisible. |
...
| `W` | Wraiths | A fresh **wraith → gain a level**. Barrow wights and Nazgul leave no corpse. |
...
cures lycanthropy (see [A note on werecreatures](#a-note-on-werecreatures)).
It weighs almost nothing, so keep any you find.

**Puddings, cubes, molds, and blobs can be useful food.** Many offer
a chance at an intrinsic. Puddings and acid blobs leave **globs**;
globs of one kind merge into a single meal and therefore a single
resistance roll. Eat separate globs from the floor before they merge
in your inventory.

#### Food Strategy

1. Eat safe, fresh corpses as your primary food source.
2. Save food rations and lembas wafers for emergencies.
3. Eat intrinsic-granting corpses deliberately (even if not hungry).
4. Go down when Hungry with no food; pray when Weak or Fainting if it is safe to pray.
...
Potion appearances are shuffled each game. Price and controlled
tests are dependable; remembering that last game's bubbly potion was
healing is not.
...
| ------ | -----: | ---------------------- |
| **[healing](#potion-healing)** | 11.5% | Restores HP; only a blessed potion also cures blindness. |
| **[water](#potion-holy-water)** | 8% | The "clear potion." Put it on a co-aligned altar for a successful prayer to make holy water. |
...
| **see invisible** | 4% | See invisible for a while; one quaff in ten makes it permanent. Shares $50 with booze, fruit juice, and sickness. |
...
| **enlightenment** | 2% | Reports your stats and intrinsics; blessed also gives +1 Int and +1 Wis. |
...
[]{#potion-healing}
**Healing, extra healing, full healing.** Extra healing is the one to
stockpile: it always
...
give the biggest boost. Save every non-cursed extra or full healing
potion you do not need immediately for Gehennom and the ascension run.
...
[]{#potion-speed}
**Speed.** One non-cursed quaff grants permanent intrinsic speed;
blessing only lengthens the temporary boost layered on top. A
self-zapped wand of speed monster instead gives 50–74 turns of
temporary speed.

[]{#potion-holy-water}
**Holy water.** Put uncursed water on a co-aligned altar and make a
successful prayer there; every potion of water on that square becomes
holy. Holy water blesses any item you dip into it. Because a dip
blesses the whole stack at once,
...
At a fountain, every dip also rolls on the fountain's event table and
has a one-in-three chance to dry the fountain. Clear the area first;
unwanted potions can become holy-water feedstock, but the process is
not risk-free.

[]{#potion-gain-level}
**Gain level.** Raises your experience level by 1. Useful for
reaching quest eligibility quickly, or converting into something
better through alchemy. When cursed, it moves you up one dungeon level instead: you rise
...
the potion you are dipping, and dipping a cursed potion detonates
every time.

#### Neutralizing Ailments

A non-cursed **unicorn horn** cures blindness, deafness, confusion,
stunning, hallucination, vomiting, and sickness. It may take several
applications; the exact blessed and uncursed odds are in [Key
Tools](#key-tools). It does not restore drained ability scores, which
now require a potion of restore ability.

If you have no horn, potions cover most of the same ground:

- **Blindness** (and deafness): **blessed healing**, or any non-cursed
  **extra** or **full healing**. Eating a
  carrot works too, and temporary blindness (a cream pie, a
  yellow light) just wears off.
- **Hallucination**: **extra** or **full healing** clear it;
  plain healing does not. A potion of **sickness** snaps you out
  of it as well, though its other effects make you pay for it.
- **Sickness** (the food-poisoning timer that kills you):
  **blessed healing**, non-cursed **extra** or **full healing**,
  a unicorn horn, or a eucalyptus leaf. Prayer works if your god is
  listening.
- **Stoning**: eat a lizard or acidic corpse before the
  countdown ends. Keep a lizard in open inventory; it never rots.
- **Confusion and stunning**: a unicorn horn clears them. A lizard
  corpse cuts either timer to two turns; otherwise wait them out.

A horn also purifies bad potions by dipping:

- **Blindness, confusion, hallucination** → uncursed water
- **Sickness** → fruit juice

The water can be blessed into holy water and the fruit juice
alchemized into see invisible, so nothing is wasted.
...
but mean nothing until you identify them.

#### The Scroll Table

Each scroll's effect and best use. Prices for
...
| **[enchant weapon](#scroll-enchant)** | 8% | +1 (blessed up to +3); safe to +5, risks destroying the weapon at +6 and above. |
| **[remove curse](#scroll-remove-curse)** | 6.5% | Frees cursed gear; blessed clears your whole inventory. |
| **[enchant armor](#scroll-enchant)** | 6.3% | Enchants worn armor; past +3 (+5 for elven armor or a cornuthaum), further attempts may destroy it. |
| **[teleportation](#scroll-teleportation)** | 5.5% | Teleports you, aimed with teleport control. The lone scroll in a sealed, doorless niche is teleportation. |
...
| **create monster** | 4.5% | Spawns a monster; cursed creates 13, while confused creates acid blobs. |
...
| **punishment** | 1.5% | Chains a heavy iron ball to you; remove curse frees you. |
...
your bag and pick up nearby unknowns before reading. A blessed scroll
identifies one to four items, with a one-in-five chance to identify
everything; positive Luck raises the minimum to two. An uncursed
scroll gets that blessed result one time in five and otherwise names
one item.
...
the weapon is +6 or higher). At +6 or higher,
...
[]{#scroll-charging} **Charging.** Recharges wands and rechargeable
tools. Save one for a wand of wishing. The risk, charge counts, and
ring rules are collected under [Recharging](#recharging).

[]{#scroll-genocide}
**Genocide.** Uncursed eliminates a single
species; blessed wipes an entire monster class from the game
forever. Liches (`L`) are the usual blessed target.
**Do not blessed-genocide a class that contains your own race or
role.** Dwarves are `h`, Gnomes are `G`, Elves and Humans
...
genocide your own role's species the same way. Check the symbol
...
shows secret doors. Invaluable in [Gehennom](#gehennom)'s maddening mazes,
...
**Stinking cloud.** Reading places a poison-gas fog at a visible
square within about five squares (about fifteen squares of coverage uncursed,
...
damage and prompts you to aim at a visible square within about five
squares, making it
...
doubles as a slime cure. Bless it and keep it; an unblessed
test-read goes off in your own pack.
...
piece of armor. (Uncursed or blessed strips erodeproofing instead.)

**Confused remove curse** randomizes uncursed objects: one chance in
four to bless, one in four to curse, and one in two to leave alone.
An unblessed scroll reaches only worn and wielded gear, loadstones,
and active leashes; only a blessed scroll reaches the whole main
inventory. It is a gamble, not a curse-removal method.
...
A ray travels seven to thirteen squares before it fades, bouncing
off walls, stone, and the edge of the map along the way. Because
it keeps going after each bounce, a ray sent down a straight
corridor or at a wall a few squares off can come back and hit you
as hard as it would a monster. Aim so the beam spends its length
...
| Price | Wand | Type | Charges when found | Engrave-test result |
| --- | --- | --- | --- | --- |
|   100 | Light                                       | None  | 11–15 | room lights up         |
|   100 | Nothing                                     | BEAM  | 4–8  | no message             |
|   150 | [Digging](#wand-digging)                    | RAY   | 4–8  | gravel flies up        |
|   150 | Enlightenment                               | None  | 11–15 | you feel enlightened   |
|   150 | Magic missile                               | RAY   | 4–8  | bullet holes           |
|   150 | [Make invisible](#wand-make-invisible)      | BEAM  | 4–8  | engraving vanishes ¹   |
|   150 | Opening                                     | BEAM  | 4–8  | no message             |
|   150 | Probing                                     | BEAM  | 4–8  | no message             |
|   150 | Secret door detection                       | None  | 11–15 | doors revealed         |
|   150 | Slow monster                                | BEAM  | 4–8  | bugs slow down         |
|   150 | Speed monster                               | BEAM  | 4–8  | bugs speed up          |
|   150 | [Stasis](#wand-stasis)                      | None  | 3–6  | no message             |
|   150 | Striking                                    | BEAM  | 4–8  | wand fights you        |
|   150 | Undead turning                              | BEAM  | 4–8  | no message             |
|   150 | Locking                                     | BEAM  | 4–8  | no message             |
|   175 | [Cold](#wand-fire-cold-lightning)           | RAY   | 4–8  | ice cubes drop         |
|   175 | [Fire](#wand-fire-cold-lightning)           | RAY   | 4–8  | flames fly             |
|   175 | [Lightning](#wand-fire-cold-lightning)      | RAY   | 4–8  | lightning arcs         |
|   175 | Sleep                                       | RAY   | 4–8  | bugs stop moving ²     |
|   200 | [Cancellation](#wand-cancellation)          | BEAM  | 4–8  | engraving vanishes ¹   |
|   200 | Create monster                              | None  | 11–15 | bugs appear            |
|   200 | [Polymorph](#wand-polymorph)                | BEAM  | 4–8  | engraving rewrites     |
|   200 | [Teleportation](#wand-teleportation)        | BEAM  | 4–8  | engraving vanishes ¹   |
|   500 | [Death](#wand-death)                        | RAY   | 4–8  | bugs stop moving ²     |
|   500 | [Wishing](#wand-wishing)                    | None  | 1  | prompts for a wish     |
...
[]{#wand-wishing}
**Wishing.** Each zap grants one wish. Wands of wishing generate with
**1 charge**. Recharge the wand once *before* trying to wrest it, then
use the eventual wrested charge last: that gives three wishes. Without
a scroll of charging, the initial and wrested charges give two. Plan
the wishes before you reach [the Castle](#the-castle).

[]{#wand-death}
**Death.** Fires a death ray that instantly kills most things it
hits. Reflected by reflection. Blocked by magic resistance. One
of the strongest late-game attacks—but a bounce can kill you just as
instantly if you lack reflection or magic resistance.

**Sleep.** A sleep ray can end an early run without dealing a point
of damage. A bounced ray may leave you helpless for 6d25 turns; aim
away from walls and do not rely on waking before the monster arrives.

[]{#wand-digging}
**Digging.** Essential utility. Dig through walls to create
shortcuts, dig down to escape dangerous situations, dig through
rock to reach vaults and hidden areas. A downward zap drops you onto the next
floor, the same direction you wanted to go anyway.

[]{#wand-teleportation}
**Teleportation.** Zap a monster to send it elsewhere on the level,
or zap yourself to escape. It buys distance without having to win the
fight first.
...
[]{#wand-make-invisible}
**Make invisible.** A self-zap makes you invisible for 31–45 turns.
A monster you zap becomes invisible permanently, which is seldom an
improvement unless you can still see it. For lasting invisibility on
yourself, use a ring or cloak.
...
**exactly one** charge. An uncursed or blessed scroll of charging
adds **one** wish; blessing does not add another, while a cursed
scroll strips the wand to zero. Recharge before wrestling, because
the wrested use destroys the wand. The first recharge is safe and a
second is a **guaranteed explosion**. The total is two wishes without
charging or three with one recharge.

Rings are chargeable too, but the explosion test uses their current
enchantment: +0 is safe, +1 explodes one time in seven, +3 about 43%,
+5 about 71%, and +7 always. A valuable highly enchanted ring is a
poor charging target.
...
Self-polymorph has uses worth the risk.
A wand of polymorph zapped at yourself, a potion of polymorph, the
polymorph self spell, or stepping on a polymorph trap can all roll a
new form for you. With **polymorph control** (the
ring or intrinsic) the game lets you *choose* the form.
...
- **Bring your own resistances and attacks.** A red dragon form
  gives you fire breath. A brown mold form freezes anything that
  hits you in melee. A purple worm swallows your problems whole.
  Most monster powers are yours when you wear their shape.
- **Borrow another body.** The new form rolls its own full HP. Your
  ordinary HP remains underneath and returns when the form ends.
...
Without polymorph control, a failed Constitution check can cause
system shock for up to 30 HP. Cursed polymorph objects do not strip
...
|   200 | [Free action](#ring-free-action) | Immune to paralysis          |
|   200 | Levitation                     | Float in the air               |
|   200 | Regeneration                   | Heal faster (costs hunger)     |
|   200 | Searching                      | Auto-search each turn          |
|   200 | [Slow digestion](#ring-slow-digestion) | Reduces hunger            |
|   200 | Teleportation                  | Random teleports (auto-curse)  |
|   300 | [Conflict](#ring-conflict)     | Monsters fight each other      |
|   300 | Polymorph                      | Random polymorphs (auto-curse) |
|   300 | Polymorph control              | Choose polymorph form          |
|   300 | [Teleport control](#ring-teleport-control) | Choose teleport destination |

<div class="price-id-toolbar"></div>

Rings marked "auto-curse" generate cursed 90% of the time, and a
cursed ring can't be removed until you uncurse it.

#### Key Rings

[]{#ring-free-action}
**Free action** prevents paralysis, a common way for a late-game
monster to take enough unanswered turns to kill you.

[]{#ring-teleport-control}
**Teleport control** turns random teleportation into aimed movement
and makes teleportitis useful.

[]{#ring-conflict}
**Conflict** makes monsters attack one another. It can dismantle a
crowded room, but it also makes your pets attack you.

[]{#ring-slow-digestion}
**Slow digestion** greatly reduces ordinary hunger. It does not make
you immune to the extra drain from other worn rings.

**Aggravate monster** roughly doubles the effective dungeon depth for
...
**The hidden cost:** an ordinary worn ring costs 1 nutrition every 20
turns; conflict, regeneration, and hunger cost 1 every 2 turns. Keep
situational rings in inventory and put them on when needed. Free
action is the exception: protection against an unexpected paralysis
is worth its modest food cost.
...
| Change                 | Changes your sex when worn, then disintegrates |
...
BUC-test an unknown amulet before putting it on. An amulet of
strangulation starts a six-turn death timer: take it off immediately,
or pray if a curse prevents removal.

#### Key Amulets

**Life saving** revives you to 50 HP plus a Constitution bonus, capped
at your maximum, then crumbles and costs 1 Constitution. It cannot
save death by genocide. Once identified, wear it and forget it; the
danger you failed to anticipate is the one it is for.
...
**Magical breathing** prevents drowning. It earns its slot at
Medusa's island and becomes essential on the Plane of Water.
...
Medusa's island edge to edge. Steeds cannot wear speed boots, and
your speed does not add to theirs.
...
bags that eat other bags.

#### Containers

Every adventurer eventually runs out of carrying capacity, and the
bag of holding is the dungeon's most coveted answer.
...
A **bag of holding** changes the effective weight of its contents:
blessed quarters it, uncursed halves it, and cursed doubles it.
[Sokoban](#sokoban)'s prize is a bag of holding half the time; if you
receive the amulet instead, a bag is a strong wish candidate.

A warning: **never** put a wand of cancellation, another bag of
holding, or a charged bag of tricks inside a bag of holding. The bag
explodes for 6d6 damage, scatters its own contents, and destroys about
one item in thirteen.
...
| Overloaded   | beyond 3× capacity                      | You cannot move                                                          |

Practical rule: stay **Unencumbered** in normal play, accept
**Burdened** during loot runs, and never linger at **Stressed**
or worse without a reason. A blessed bag of holding cuts the effective
weight of its contents to roughly a quarter; an uncursed bag halves
it, while a cursed bag doubles it.
...
Intelligent monsters can loot unlocked containers and carry
containers away, but they refuse to open a locked one. Lock any floor
stash before leaving it unattended. The Castle residents likewise
cannot empty a locked chest.

#### Unlocking Tools

The dungeon is full of locked things, and brute force is noisy and
slow. A **skeleton key** is the most reliable ordinary tool (70%+ success on
doors, 75%+ on boxes). A **lock pick** (Samurai: **osaku**) is
respectable. A **credit card** is the worst but still better than
kicking. Carry one of the three; they are light, and locked doors are
everywhere.
...
**Oil lamps** and **candles** light dark corridors. A **magic lamp**
burns indefinitely and can still be rubbed while lit. Rub it (`#rub`)
and there's a 1-in-3 chance the djinni emerges, then a
chance it grants you a wish (80% if the lamp is blessed, so
~27% wish per rub overall), less if it isn't. Try again on the
same lamp until the djinni shows. Use it for light until you can bless
and rub it; lighting it does not consume the wish.

The **Candelabrum of Invocation** is a unique candelabra found in
[Vlad's Tower](#vlads-tower). It's one of three items needed for the invocation
ritual to enter [Moloch's Sanctum](#molochs-sanctum). You'll need seven candles to
...
play the passtune at [the Castle](#the-castle) drawbridge. The tune
and its two sources are described in [The Castle](#the-castle).
A **magic harp** (Samurai: **magic
...
A tooled horn or leather drum wakes and scares nearby monsters; the
drum also deafens you for 30–49 turns. A wooden flute produces only
sound.
...
| [Stethoscope](#tool-stethoscope) | Check HP and status of a monster      |
...
| [Magic marker](#tool-magic-marker) | Write scrolls and spellbooks on blank paper |
| [Crystal ball](#tool-crystal-ball) | Name a symbol and scan the level for it |
...
Apply a non-cursed **unicorn horn** to cure confusion, blindness,
sickness, hallucination,
stunning, vomiting, and deafness: most of the status
ailments that matter. Carry one at all times.
...
[]{#tool-stethoscope}
The **stethoscope** reports a monster's HP and condition. Its first
use on each game turn is free, so checking does not surrender your
move; further uses that turn cost time.

A 5.0 caveat: the unicorn horn **no longer restores lost ability
scores**. Drained Strength, Intelligence, Wisdom,
...
problems, but not for attribute drain. Budget for restore ability
separately.
...
To write a scroll intentionally, enter a label you have seen; that
produces the scroll bearing that label even if you have not formally
identified it. If charges run out
...
High-value writes include **genocide** (common class targets are L,
&, and h, though uniquely named demon lords survive; see
[Genocide](#scroll-genocide) for the race warning), **charging**
(uncursed or blessed adds one wish to a wand of wishing, for 8–15
marker charges), and **enchant weapon / enchant armor**. Never
recharge a wand of wishing twice.
...
still applies. The kit lets you seek poison resistance without taking
poison damage; acid resistance from a corpse lasts only 3–18 turns,
so it cannot be banked the same way. Don't tin a cockatrice, and don't eat a cockatrice
...
a quick escape. A wand of digging is faster in a straight line but
burns charges. Sokoban is non-diggable; in Gehennom, the Valley
floor, Sanctum, and the two towers resist digging, while the filler
mazes do not. Applied to a statue,
...
name a map symbol, and the ball scans the whole level for that symbol.
Each use consumes one charge; a scroll of
...
every time while charged. An altar reveals BUC; holy water blesses
the ball.

The **can of grease** coats armor against hugs, wraps, sticky attacks,
and mind-flayer tentacles. It does not stop nymph theft, Rider grabs,
or weapon snatching. Greasing a bag protects its contents from water
until the coating wears off.
...
This section covers choosing your equipment; the
...
If your AC is **6 or worse**, do not wait indefinitely for an altar:
ordinary body armor, helms, shields, and cloaks are usually worth the
risk. Test boots, gloves, and conical hats before wearing them; their
bad magical forms can trap or cripple you.

| Slot | Wear now | Look for | Use care |
| ---- | -------- | -------- | -------- |
| Body | Best suit that does not overburden you | Dragon scale mail | Monks lose 20 to-hit; metal hurts casting |
| Cloak | Any useful non-cursed cloak | Magic resistance, protection, displacement | Mummy wrapping blocks invisibility |
| Helm | Ordinary helm when AC is poor | Brilliance, caution, telepathy | Test conical hats |
| Gloves | Only after a BUC test | Power or dexterity | Fumbling gloves are usually cursed |
| Boots | Only after a BUC test | Speed, water walking, jumping | Levitation and fumble boots are usually cursed |
| Shield | If you use one hand and are not a Monk | Reflection or a resistance | Any shield blocks two-handers and penalizes casting |
| Shirt | Wear when convenient | Either kind; enchant it | A visible shirt worsens shop prices |
...
**Dwarvish mithril-coat** gives 6 AC at only 150 weight and does not
rust. The **elven mithril-coat** gives 5 AC at the same weight.
Mithril is still metallic: its spellcasting penalty is the same as
plate mail's, though a robe halves that penalty. For a caster, the
AC may still justify the trade.

The reliable heavy armors are **splint mail** (iron strips riveted to
...
so a +5 enchanted shirt is doing real work. The two shirts in the dungeon are
...
+3), magic cancellation, and often a useful intrinsic. They also
protect the suit beneath from some attacks.
...
chemist's apron: 1 AC, MC1, plus poison resistance. It is excellent protection
before you have the intrinsic.
...
Four magical cloaks deserve special attention:
...
and 10-40 zm. Serviceable for fighters, but each adds 4 points to a
spell's failure calculation. **Elven leather helm** is the spellcaster's
compromise: 1 AC at 3 zm, leather-class, no penalty. **Fedora** is
the Archeologist's starting hat; an Archeologist wearing one gains
+1 Luck.
...
without remove curse. Both can be BUC-tested. Their base prices also
separate them: a cornuthaum costs 80 zm and a dunce cap 1 zm.
...
game. **Helm of telepathy** detects minds within eight squares while
your eyes are open; while blind, its telepathy reaches the whole
level.
...
9 times in 10 and make you fumble constantly. Altar-test an
unidentified pair before putting it on. A cursed glove
...
The useful magical boots change how you move:
...
- **Water walking boots** let you walk on water, critical for
  ...
  them for the moment.
- **Jumping boots** add the `#jump` command, so you
  can leap to a nearby square in combat without casting the
  spell.
- **Elven boots** grant stealth and are a dependable choice for Rogues
  and Rangers.
...
- **Levitation boots** float you constantly and refuse to come
  off if cursed.
- **Fumble boots** trip you every 1–20 turns, costing two turns.

Altar-test boots before putting them on. A cursed pair won't come
off until you break the curse, and levitation boots can leave you
floating helpless over a moat.

##### Shields

Shields contribute 1–2 AC and force a choice elsewhere in the
loadout. Any shield prevents two-weapon combat and two-handed weapons.
Any shield also adds a flat spellcasting penalty; one heavier than 30
weight quarters the final success chance. A Monk can wear a shield,
but loses the Martial Arts to-hit bonus while doing so. Shields do not
block unseen rays or arrow traps.
...
**small shield** at 1 AC, along with the two 30-weight resistance
shields, avoids the severe quartering of spell success. All three
still impose the flat shield penalty; a dedicated caster is strongest
with the slot empty.

**Large shield** and **dwarvish roundshield** are 2 AC but heavy
(100 weight). Their restriction is the same as every other shield:
while one is worn, you cannot wield a two-handed sword, battle-axe,
or polearm.
...
armor add enchantment with destruction risk above +3 (see
[Enchantment](#enchantment)); and donating gold to a priest of
your alignment buys intrinsic Protection that stacks with worn AC
and can raise MC0 to MC1 (see
[Donating to Priests](#donating-to-priests)).

[]{#magic-cancellation}
**Magic cancellation (MC).** Worn armor contributes a hidden defense,
capped at 3. MC can negate the secondary effect of level drain,
poison, paralysis, sleep, slowing, confusion, stunning, lycanthropy,
disease, sliming, and teleporting touch. It does not block gazes,
breath weapons, cockatrice touch, or brain sucking. The chance is set
by MC level:
...
Start with the highest MC value among worn armor. Extrinsic Protection
adds 1, or 2 when it comes from an **amulet of guarding**; multiple
extrinsic sources do not add repeatedly. Intrinsic Protection from a
priest donation or spell merely raises MC0 to MC1. The total caps at
3. A cloak of protection reaches MC3 by itself; an amulet of guarding
raises an MC1 suit to MC3.
...
death spell, polymorph beams, magic traps, and so on. MC instead
blocks the listed melee status effects at a percentage rate. A helmet,
not MC, usually stops a mind-flayer tentacle; cockatrice touch requires
its own precautions. An ascending hero wants both defenses.
...
Your weapon determines its reach, damage, and the skill you train.
The sections that follow group weapons by how they are used. For
per-skill stat tables, see
[Weapons Tables](#weapons-tables) in the appendix.

A handful of commands run through everything below: **`w`** wields
a weapon; **`x`** exchanges it with the alternate weapon slot;
**`t`** throws any item; **`f`** fires whatever stack
...
For a first run, train the weapon your role can keep using:

| Role | Train first |
| ---- | ----------- |
| Archeologist | Whip now; move to saber or pick-axe when damage matters |
| Barbarian | Axe or two-handed sword, matching the starting weapon |
| Cave Dweller | Club |
| Healer | Knife (the scalpel skill) or quarterstaff |
| Knight | Long sword; lance if you stay mounted |
| Monk | Martial Arts |
| Priest | Mace or morning star |
| Ranger | Bow |
| Rogue | Dagger |
| Samurai | Long sword (katana), with bow as the ranged skill |
| Tourist | Dart |
| Valkyrie | Long sword |
| Wizard | Dagger or quarterstaff |
...
Keep a melee weapon in the alternate slot when using a launcher.
Press `x` to exchange the current and alternate weapons when a monster
closes; press it again to return to the launcher.
...
**Quarterstaff.** A simple wooden pole, bimanual at d6/d6 and only 40
weight. Weapons do not impose spellcasting penalties; a wielded
quarterstaff actually gives a small casting bonus. Wizards start with
one, and Healers, Priests, Cave Dwellers, and Wizards can reach Expert.
...
it back to your hand the way a tethered ball returns. d6/d3; it can
miss the return occasionally.
...
class hits hard for a one-handed weapon. The artifact
...
The **grappling hook** trains the same skill. Applied at two-square
reach, it can pull a very small monster one square, snag an object, or
drag you one step; it does not haul an ordinary foe into melee.
...
thunder hammer; it does shock damage on hit. Only a Valkyrie with
Strength 25 can throw it and have it return reliably.
...
in any direction including diagonals. Smoother still, the **`f`**
(fire) command doubles as your reach attack: with a reach weapon
wielded, `f` autotargets a monster in range and strikes it in a
single keystroke, no direction prompt.
...
The **grappling hook** is a three-pronged iron hook on a chain. Apply
it at two-square reach to snag an object, pull a very small monster
one square, or drag yourself a step. It trains the flail skill.
...
quiver with `Q`, fire with `f`. Rangers and Samurai reach Expert;
Rogues cannot train bow.
...
from a sickness potion. **Shuriken** are Japanese throwing stars;
Monks get the extra multishot. **Boomerang** is the Australian
...
- **Valkyrie or Knight:** long sword primary, off-hand at
  Skilled with a silver dagger. Numbers
...
and enchant armor. An uncursed enchant-weapon scroll adds +1; an
uncursed enchant-armor scroll adds 1–2, with larger gains possible on
plain +0 armor. Blessed scrolls can add more. At **+6 or higher**, a
weapon has a two-in-three chance to evaporate when positively
enchanted. **Armor** is also at risk: above +3
...
grease (apply a can of grease). The grease layer can deflect hugs,
wraps, sticky attacks, and mind-flayer tentacles, but not ordinary
theft or weapon snatching. Grease shields gear from water too: a greased
...
it's probably doing something terrible. You cannot remove it until
you break the curse.
...
- **Cursed weapons** can't be unwielded. Hope you like that -3
  orcish dagger
- **Cursed potions and scrolls** have specific altered effects; some
  are weaker, some harmful, and a few are useful on purpose
...
- **Altar test.** Drop an item on an altar. A black flash means
  cursed; no flash means uncursed
- **Pet test.** A pet steps reluctantly onto a cursed object. Drop
  it in a narrow route and watch several passes; one crossing does
  not prove safety
...
- **Prayer.** Cursed levitation, a welded weapon when you have no free
  ...
  with positive Luck and nothing worse to fix, a successful prayer
  uncurses at most one item.
...
By the middle game, survival depends less on what the dungeon happens
to drop and more on what you build from it: trained skills, managed
Luck, spells you can cast reliably, and a kit assembled for threats
you have not met yet. The chapters here explain those systems before
the route descends into Gehennom.
...
- chain lightning is level 2 NODIR, not level 7, not a bouncing ray (objects.h:1409-1411; SPELL fields are name,desc,sub,prob,delay=4,level=2)
...
Spells are reusable abilities learned from spellbooks. Unlike scrolls (consumed
...
Read a spellbook (`r`, the same key that reads scrolls) to learn its
spell. The book's shop price is 100 times the spell level. Reading
takes several turns and can fail: the result may teleport you, take
your gold, blind, confuse, poison, or injure you. A surviving book can
be tried again. In 5.0, a Wizard who is not certain to succeed sees
*"This spellbook is difficult to comprehend. Continue?"*; declining
costs nothing.
...
The formula produces a **read score**. A score of 5 succeeds 25% of
the time, 10 succeeds 50%, 15 succeeds 75%, and 20 succeeds
automatically. To guarantee a read without lenses, you need
`Int + XL/2` of 18 for a level-1 book, then 20, 22, 24, 26, 28, or 30
for levels 2 through 7. Lenses reduce each requirement by 2.

Save your holy water for your hardest unread spellbooks.

**Wizards** are the undisputed masters of magic: they read books and
cast spells more reliably, and can reach Expert in every school. A well-built
...
and their no-body-armor restriction helps casting because
metal body armor adds a failure penalty; the monk-favored robe grants
a bonus. Priests and Healers cast well in their
...
all level-1 appearances and level-3 in attack and enchantment, so
several books are already identifiable in their core schools.
...
outright. Carry important spellbooks if you plan to rely
...
| Detect monsters | 1     | Reveal monsters across the whole level |
...
The other 32 spells, along with their schools, types, and
...
If the `+` menu shows **100% fail**, the problem is usually equipment
or skill, not the spellbook. Remove a shield first, then metal body
armor, helm, gloves, or boots; raise the role's casting stat and train
the spell's school. A robe halves the metal-suit penalty, and wielding
a quarterstaff gives a small bonus. Every shield imposes a flat
penalty, and shields heavier than 30 weight quarter the final chance.
...
Pw regenerates on a periodic tick that shortens as you level:
every 24 turns at XL 1 (18 for a Wizard), 18 by XL 10 (14 Wizard),
12 by XL 20 (9 Wizard), and 5 by XL 30 (4 Wizard). Each tick gives
1 to **((Wis + Int) / 15) + 1** Pw, typically 1-3; magical
breathing adds 2 to that ceiling. The **energy regeneration**
intrinsic (from the *Eye of the Aethiopica*, among others)
bypasses the tick, so you regen every turn. Stressed or worse
encumbrance shuts regen off; Burdened is fine.

Carry backup wands and scrolls: a Wizard out of Pw is just a person in a
...
(NetHack uses the computer's real date.)
...
| Sitting on a throne (this result occurs only while Luck is negative) | +1 |
...
random Luck change between -3 and +3. Archeologists start with a **touchstone**, which lets
them verify whether a gem is real before throwing it at a
unicorn.

A sacrifice can raise Luck only while the corpse's difficulty exceeds
your current Luck. Kobolds are too weak to help. For later gains, use
fresh corpses from tough monsters.
...
- Many smaller checks tip your way as well.

Negative Luck makes prayer unsafe. At −1 or −2 Luck, if your god is
not angry, the usual result is simple displeasure and a reset prayer
timer rather than a curse or divine bolt. Deeper negative Luck and
anger allow harsher outcomes. Luck also changes attacks and many
Luck-adjusted rolls; it does not make scrolls generically backfire.
...
Wis, and a Satiated Monk abuses it.

#### Why Exercise Matters

Stats matter for almost everything: Str for damage and carrying
capacity, Dex for hit chance, Con for HP per level, and Wis for Pw
regeneration. Those gradual gains add up. So do five hundred turns
spent Satiated and Fumbling.
...
Pick one weapon class early and stay
...
When you've earned enough practice, the message names the category:
**"You feel more confident in your weapon skills,"** **"spell casting
skills,"** or **"fighting skills."** That is your cue to type
`#enhance`.
...
counter skips the weakest hits. The Expert weapon line (+3 / +2) is
the payoff for dedicating to a single weapon.
...
Thirty-two slots sounds like plenty until you start counting. Expert
...
- **Riding is a skill.** Without **Basic riding** you can't
  ...
  +1 damage.
- **Bare hands and martial arts favor Monks.** Grand Master needs **9
  cumulative non-weapon slots**, which Monks reach naturally.
  Barbarians, Cave Dwellers, and Samurai can reach Master; other
  roles have lower caps.
...
When *"For what do you wish?"* appears, the game accepts a free-form
object description. Decide the object and exact wording before you
answer; a typo can turn the rarest resource in the game into junk.
...
- **Wand of wishing:** found in one of [the Castle](#the-castle)'s four
  corner towers (see [Key Wands](#key-wands) for the charge mechanics).
...
- **Vlad's throne:** A special throne that grants a guaranteed
  ...
  the throne survives. Keep sitting until the wish arrives.
...
The number of wishes varies widely. A sensible budget is about five,
counting the Castle wand's initial, recharged, and wrested charges,
Vlad's throne, and the Amulet pickup wish. Lamps, fountain demons,
and smoky potions may add more.

#### What to Wish For

Choose the two body-armour wishes as a pair. If you already have
reflection from an amulet or shield, wish for **gray dragon scale
mail** to gain magic resistance. If a cloak already supplies magic
resistance and reflection is missing, wish for **silver**. Once one
defense is secured outside the body slot, the other mail becomes the
better first wish.

1. **Gray dragon scale mail** ([magic resistance](#damage-resistances) + AC; magic resistance
   is the most important protection in the game).
   Type `blessed greased fixed +2 gray dragon scale mail`.
2. **Silver dragon scale mail** (reflection + AC; reflection protects
   against wands and breath weapons).
...
5. **Amulet of [life saving](#special-and-utility)** (an extra life for
   the Planes).
   Type `blessed amulet of life saving` (amulets take no enchantment or erosion).
6. **A specific artifact** ([Grayswandir](#grayswandir) is a common target;
   its silver hurts demons, imps, vampires, weres, and shades).
   Type `blessed greased fixed +2 Grayswandir`.

Don't wish for consumables (scrolls, potions) unless you're in
dire straits. A wish is for permanent gear you can't otherwise get: dragon
scale mail, speed boots, an artifact.
...
When the prompt asks "For what do you wish?", be specific.
Here is what each word buys you:

- "blessed greased fixed +2 gray dragon scale mail" is the standard
  form. `blessed` because BUC defaults to random, `greased` can
  deflect hugs, wraps, sticky attacks, and mind-flayer tentacles, `fixed` (or
...
- Artifact wishes get *harder* as artifacts accumulate. The
  ...
  artifact-wish counter ticks whether the artifact appears. Quest artifacts are absolutely blocked.
...
artifact exists only once per game. Here's how they come into your
hands:
...
- **Naming** (Sting and Orcrist only; see below).
...
- **Intelligent artifacts** blast for 4d10 on every touch when your
  role or alignment is wrong (2d10 with magic resistance). The item
  evades your grasp only when both are wrong.
- **Other misaligned artifacts** have a 1-in-4 chance on every touch
  to blast for 4d4 damage (2d4 with magic resistance).
...
| Mjollnir          | your alignment | war hammer   | +d5    | +d24 shock                  | Valkyries catch it 99% of the time; STR 25 to throw    |
| Magicbane         | Neutral  | athame            | +d3    | +d4 magic (stun)            | magic resistance and curse protection while *wielded*  |
| Stormbringer      | Chaotic  | runesword         | +d5    | +d2 drain life              | drains a level and heals you; attacks peacefuls        |
| Vorpal Blade      | Neutral  | long sword        | +d5    | +d1 physical                | chance to behead on hit                                |
| Frost Brand       | any      | long sword        | +d5    | ×2 cold vs non-resistant    | cold resistance while wielded                          |
| Fire Brand        | any      | long sword        | +d5    | ×2 fire vs non-resistant    | fire resistance while wielded                          |
...
| Cleaver           | Neutral  | battle-axe        | +d3    | +d6 physical                | two-handed; every swing also strikes both flanks       |
...
are common second wishes. In 5.0, **Snickersnee** adds a free reach
attack each turn, while **Sunsword** can blind on demand. The remaining
entries (the bane weapons, Fire Brand, Cleaver) are usually accepted
as sacrifice gifts rather than spent wishes on.

**[Excalibur]{#excalibur-artifact}** is the go-to weapon for Lawful characters; the drain
resistance alone is worth carrying it, even after you have a stronger
weapon. At XL 5 or higher, Knights have 1-in-6 fountain-dip odds;
every other Lawful role faces 1-in-30.
...
because it will not return to them. Anyone can wield it; Strength 25
is required only to throw it (gauntlets of power get you there).
+d24 shock damage is brutal against anything not
shock-resistant.
...
alignment. Each hit drains a level from the target and heals you for
half the HP the victim loses; it does not grant you that experience
level. Stormbringer is also
...
**[Cleaver]{#cleaver}** is the Barbarian quest artifact. It is a
two-handed battle-axe, so it cannot be paired with a shield. Every
swing strikes the primary target and the two flanking squares: useful
at a corridor mouth, hazardous beside peaceful creatures.
...
melee per turn) puts Snickersnee ahead of a plain katana for most
Samurai.
...
Invoking a rested artifact costs no Pw and starts a cooldown of about
100 turns. Up or down lights only your own square; invoking at
yourself self-blinds you. During cooldown, Sunsword can spend 25 Pw to
fire anyway.

**[Bane weapons]{#bane-weapons}** (Sunsword, Demonbane, Sting, Orcrist, Grimtooth,
Dragonbane, Werebane, Giantslayer, Ogresmasher, Trollsbane) deal
double base damage against their target class. Their base damage is modest, but the defensive powers often decide when to swap one in:
Trollsbane regenerates while wielded,
Dragonbane reflects, Werebane neutralizes lycanthropy, Grimtooth
defends against poison.

**[Naming Sting and Orcrist]{#naming-sting-orcrist}.** These two
elven blades are the only artifacts you can call into being just
by naming them, with no wish or sacrifice required. Name a single
elven dagger "Sting" or a single elven broadsword "Orcrist," and
as long as that artifact has not already appeared in your game,
the blade turns into the genuine article on the spot. It must be a
lone blade rather than a stack, so split one off first if you are
carrying several. Wielded, each glows blue when orcs are near and
strikes them for double damage, part alarm and part weapon for the
trip through the Gnomish Mines. Both are chaotic, so a chaotic
hero carries one cleanly, while anyone else takes the occasional
blast for holding a blade out of alignment.

#### Quest artifacts

Each role has one quest artifact, awarded for completing that role's
quest. These artifacts are intelligent: a role or alignment mismatch
causes a 4d10 blast on every touch, and an artifact evades you when
both mismatch. Three of the nine non-weapon quest artifacts grant
magic resistance merely by being carried: the Orb of Detection,
Magic Mirror of Merlin, and Platinum Yendorian Express Card.

Quest artifacts cannot be wished for; they must be earned in their
role's quest. The table distinguishes **carry** powers, which operate
from open inventory, from **wear/wield** powers. Magic resistance is
a carry power on the Orb of Detection, Magic Mirror of Merlin, and
Platinum Yendorian Express Card, but requires wearing or wielding the
items that grant it in the other rows.

`M-i` (or `#invoke`) activates an artifact's special power. A rested
artifact costs no energy, then ignores further invocations for about
100 turns. Sunsword and Grimtooth alone may spend 25 Pw to fire their
powers during that cooldown.
...
| Hea  | The Staff of Aesculapius                | quarterstaff | drain-life on hit; drain res.; regen  | —                        | heal ½ missing HP; cure sickness, slime, blindness |
...
| Val  | The Orb of Fate                         | crystal ball | —                                     | +luck, warn, ½ all dmg   | level teleport      |
| Wiz  | The Eye of the Aethiopica               | amulet       | MR (worn)                             | ½ spell, +energy         | portal to a visited branch |
...
a luckstone does), plus stealth. Barbarians can
...
of the dungeon's hostiles once you reach [Gehennom](#gehennom)). It also grants
magic resistance while *wielded*. `#invoke` toggles conflict without
an energy cost when the artifact is rested.

**[The Staff of Aesculapius]{#staff-of-aesculapius}** (Healer): each
hit drains life; Stormbringer is the only other drain-life weapon.
Regeneration and drain resistance require the Staff to be wielded.
`#invoke` heals half your missing HP and cures sickness, sliming, and
blindness.

**[The Magic Mirror of Merlin]{#magic-mirror-of-merlin}** (Knight): grants ESP and magic
resistance, and occasionally whispers a rumor when applied or wielded.
Knights already have Excalibur for combat,
...
astral vision—x-ray sight in a radius of three—
...
**[The Mitre of Holiness]{#mitre-of-holiness}** (Priest): a helm of brilliance with the
usual brilliance bonus to intelligence and wisdom (so spells cast
more reliably), plus fire resistance while carried, plus extrinsic
Protection that adds 1 MC rather than AC. `#invoke` gives an energy boost, useful for spell-heavy
Priests. The Mitre does **not** deal bonus damage against undead (the artifact has no
...
**[The Platinum Yendorian Express Card]{#platinum-yendorian-express-card}** (Tourist): the Tourist's
...
It can add one charge to a wand of wishing, but that wand still
survives only one recharge.

**[The Orb of Fate]{#orb-of-fate}** (Valkyrie): the most generous
carried passive in the game — counts as a luckstone, grants warning,
and halves both spell *and* physical damage taken. `#invoke` performs
a level teleport.
...
*extra energy regeneration*. `#invoke` offers a menu of dungeon
branches you have already visited and opens a portal to the chosen
one.
...
The Castle ends the Dungeons of Doom and guards the only route into
Gehennom. Clear it as a supply depot: the wand of wishing and the
storerooms are the last reliable chance to repair a weak kit.
...
- **Play the passtune.** A five-note musical sequence played on
  ...
  correct after each attempt, like a game of Mastermind. The bridge
  must be in one of the eight squares around you for the tune to work.
  Do not stand on the span or its doorway; those are the squares that
  can crush you when the bridge moves. The notes
...
- **Wand of striking** *destroys* the drawbridge entirely. The
  span drops into the moat and becomes water again. The tune is
  useless afterward, so bring another way across.
...
- **Four corner-tower alcoves**. One (and only one, randomly)
  ...
  scroll of scare monster. Those wards keep food-eating monsters such
  as gelatinous cubes away from the chest. The cursed scroll is
...
- Four **storerooms** along the north and south walls, each guarded
  ...
  alcoves; they hold armor, weapons, gems, and food, one class per
  room.
- A **central hallway lined with five trap doors**. Stepping on
  ...
  conventional `>` stair to [Gehennom](#gehennom), so when you are ready to
...
until you or a wand of opening intervene.
...
further wishes must come from other sources: Vlad's throne, the
Amulet pickup, Orcus Town's lamp, or fountain luck
(see [Key Wands](#key-wands) for the full mechanics).

Once you're fully equipped, take a moment before descending. Sit down. Have a snack. Check
...
irregular level with three graveyards scattered across it. You arrive
in the lower right; the down stair is in the upper left, while the
permanent **shrine to Moloch** stands midway along the left side. The
shrine sits on an unaligned high altar; do not pray
...
- **Hot ground.** A potion dropped on the floor can shatter harmlessly;
  a fire trap is what threatens potions throughout your pack. Do not
  drop a valuable bottle just to rearrange inventory.
- **Lava.** Rivers of lava split some levels. Levitation or flying
  ...
  across. Without fire resistance, lava kills on contact. With fire
  resistance you sink and have about a dozen turns to levitate,
  teleport, or step free.
...
and spits acid). They wait in their lairs until they see you; after
that, they can follow you on stairs.

**Four demon princes accept bribes: Asmodeus, Baalzebub, Geryon, and
Dispater.** The demand is a random
fraction of the gold in your main inventory, so stash most gold in a
bag and leave a small payment outside it. Approaching with no open
gold makes the prince attack. All four are lawful, so a lawful
visitor pays half. Juiblex, Yeenoghu, Orcus, Demogorgon, and the rest
attack on sight.

Fighting Juiblex is viable late game, but he engulfs in melee, so keep
your distance. Demons are immune to death rays; use an ordinary
damaging attack, a banishing artifact, or another escape.
...
A prince who sees either weapon in your hand attacks at once, so
sheathe it before you approach.
...
50+8d6 acid damage (about 78 on average) if you do not have acid
...
lands, with about two bad effects along the way.
...
[acid resistance](#damage-resistances) before you sit. Acid can deal up
to 80 HP, and magic resistance blocks none of the throne's bad
effects. If you
...
weapon is an ordinary **wand of death**, not an artifact. His
fingertip cantrip is also a death ray, so bring reflection or magic
resistance. Orcus is a demon and ignores your own death ray; use
physical damage or another attack type.

His level is a ghost town. Its abandoned shops contain random loot,
not merchandise, and no shopkeepers remain to demand payment. What
remains is an honor guard of
...
A sequence of three special Gehennom levels. The portal enters at the
bottom; the **Wizard of Yendor** and **Book of the Dead** wait at the
top. His attacks are survivable; the problem is that he keeps coming
back. He teleports to you, summons monsters, steals the Amulet, and
curses your gear for the rest of the game.
...
down-stair to the Sanctum doesn't exist. Once the seal breaks,
descend to find the **High Priest of Moloch** carrying the
**Amulet of Yendor** near the **high altar**. The High Priest is a unique non-bribable
boss who casts spells, summons minions, and punishes anyone in melee
range. The standard answer is a wand of death or finger of
...
frantic climb back to the surface. Everything up to the invocation
can be done at your own pace. Afterward, covetous monsters start
hunting you and delays become expensive. Have the whole kit ready
before you begin. The steps:

1. **Collect the trio.** You need the **Bell of Opening** (the
   Quest goal, dropped by your quest nemesis), the **Candelabrum
   of Invocation** (the top of [Vlad's Tower](#vlads-tower)), and the **Book of
   the Dead** (the top of the Wizard's Tower). Missing any one
   means walking all the way back to fetch it; the Bell in
   particular is easy to leave behind on the nemesis's corpse
   the first time through [the Quest](#the-quest).
...
3. **Find the vibrating square.** On the Gehennom level directly
   above [Moloch's Sanctum](#molochs-sanctum), a single square vibrates when you step
   on it: *"You feel a strange vibration under your feet."*
   The square's position is random within the maze, so you have
   to search by walking. Scrolls of magic mapping help enormously.

4. **Perform the Invocation.** None of the three items may be cursed.
   Standing on the vibrating square, apply the Candelabrum to light
   it, then apply the Bell to ring it. Within four turns, read the
   Book of the Dead. The floor opens and a down stair appears.

5. **Swipe the Amulet from Moloch.** Descend, take down the
   **High Priest** (a wand of death works), then take the **Amulet of
   Yendor** from the body.

6. **Begin the getaway.** Take the up stair; it was usable even before
   you held the Amulet. You are now on the **Ascension Run**. Every covetous monster in
...
| **Cloak** | Cloak of magic resistance | Or a robe for casters. Magic resistance blocks death rays and the touch-of-death spell. |
...
| **Boots** | Speed boots | Extra actions help every role. |
...
| **Weapon** | Your best trained weapon; silver backup if practical | Only four quest artifacts are weapons. Silver adds damage against demons, imps, vampires, weres, and shades. |
| **Pack** | Bag of holding, unicorn horn, luckstone, wand of death, multiple wands of teleport, seven candles, ≥5 holy water, blessed full healing, shock protection | Holy water repairs curses; full healing is a one-action panic button; shock resistance or reflection protects against the Plane of Air's lightning. Riders resist stoning, so a cockatrice corpse is not an answer to them. |
...
A typical ascension AC sits in the **−25 to −40** range.
...
You did it. You fought through [Gehennom](#gehennom), defeated the High Priest,
and snatched the Amulet of Yendor from [Moloch's Sanctum](#molochs-sanctum). Now all
...
surface regardless of what you carry. On dungeon level 1, the up
stair takes a bearer of the real Amulet to the Plane of Earth;
without it, climbing out ends the game as an escape. Only
...
- **The Mysterious Force.** While you carry the Amulet in
  ...
  Lawful hero on the same level one time in four, a Neutral one time
  in three, and a Chaotic one time in two. Otherwise it drops you **down** a level
  ...
  next one, and deeper yanks reduce later triggers more. That decay
  benefits Lawful heroes most and Chaotic heroes least. The force stops the moment you climb out
  of Gehennom, and it never fires on the bottom four levels.
- **Consider an alignment detour.** A helm of opposite alignment
  flips Lawful to Chaotic and Chaotic to Lawful; a Neutral hero lands
  Lawful or Chaotic at random. Chaotic caps every yank at one level.
  The cost is that your Astral offering then
...
- **Don't rely on Elbereth past [the Castle](#the-castle).** Elbereth is
  **completely ignored** in all of Gehennom and on all four
  Elemental Planes plus Astral. Writing it grants no alignment, and
  no monster there will care. Plan your heal-and-recover
...
them. The only way through is to dig. The other caverns hold
earth elementals, stone giants, rock trolls, stone golems, pit
fiends, dust vortices, and an umber hulk. Teleportation is
sealed, so once a fight starts you cannot escape it on a wand.
A wand of digging is essential. Magic mapping shows the caverns but
not an unseen portal. Read gold detection while confused, or use a
crystal ball to locate the portal before digging toward it.
...
A ring of conflict is useful here: let them tear each
other apart while you search for the portal. Magic mapping does not
reveal an unseen portal; confused gold detection or a crystal ball
does. The plane is divided into drifting **cloud
...
Cloud lightning strikes about one turn in eight for 8d6 damage and
has a one-in-three chance to fry exposed wands and rings. Shock
resistance or reflection belongs in the kit; keep spare charged items
inside a bag.
...
Lava lakes cover the plane, fire traps lie between them, and fire
elementals and hell hounds roam. With fire resistance, most of that
damage disappears and the problem becomes finding the portal. Without
it, every crossing and encounter can burn both you and your inventory.

##### Plane of Water

The plane is open water crossed by drifting air bubbles. You arrive
inside one. Stepping into the water beside a bubble normally leaves
you scrambling back into air; the serious drowning threat is a giant
eel or kraken wrapping you and pulling you under. Magical breathing
removes that danger, but it is not required merely to stand on the
level.
...
find the portal and push through.

##### The Astral Plane

You surface into the presence of the divine. Three separate temples
hold the Lawful, Neutral, and Chaotic altars. You must
...
- **Pestilence** starts an illness timer of 20 plus your Constitution
  turns. Each later touch cuts the remaining time to one third. Sick
  resistance prevents it; otherwise apply a unicorn horn at once.
- **Famine** kills by accumulation. Each touch is 8d8 damage
  and 40 to 79 turns of hunger taken straight out of you. No
  single swing starves you; the exact number depends on the nutrition
  you had before the fight.

A slight mercy new in 5.0: if Pestilence or Famine land
...
a source). Carry plenty of food and a unicorn horn. All three Riders
resist stoning; a cockatrice corpse will not remove them. A ring of
**conflict** can turn surrounding monsters on one another, but a
high-level Rider may resist it most turns. Do not put the ring on
while your guardian Angel is still present: it vanishes and your god
replaces it with two to four hostile Angels. Teleportation wands
...
The basic keys handle every situation in the Mazes; the commands
below handle them faster. Once you've spent a
...
Counts up to 32,767 are accepted (five digits), but the useful
...
Use them to attack a suspected monster, move without attacking, or
choose how a long walk should stop.

- **`F`** then a direction is **force attack** into that square,
...
- **`G`** then a direction runs until you approach an item, trap,
  branch, or closed door. **`g`** is more cautious and also stops at
  corridor forks. Capital-letter directions (`H`, `J`, `K`, `L`,
  and `Y`, `U`, `B`, `N`) use the fast run mode instead: they pass
  items, doors, and traps unless another stopping condition intervenes.
- **`m`** then a direction is **move without attacking and without
  ...
  stop that would otherwise keep you out. Before `e`, the prefix skips
  the offer to eat food from the floor; before `a`, it has no special
  effect. `m,` forces a menu for a floor pile.
...
twice. The default buffer holds 20 messages; older
...
visited (including altars, thrones, fountains, sinks, shops, temples,
graves, trees, annotations, bones, branch stairs, the deepest level in
each branch, and [the Castle](#the-castle)'s tune once you
...
journal of major events from this run: your first kill, conduct
breaks, artifact gifts and crownings, the first prayer, level
...
NetHack's defaults are sensible, but five options prevent common
input mistakes and make danger easier to see. Flip them in-session with
`mO` for the full in-session options menu, or persist them in your
rcfile: `~/.nethackrc` on macOS/Linux,
`%USERPROFILE%\NetHack\.nethackrc` on Windows, or
the `NETHACKOPTIONS` environment variable.

If you change only five things, make them these:

1. **HP and hunger colors**, so danger reaches your eye before the
   numbers do.
2. **`paranoid_confirmation:+attack quit`**, to stop fatal typos.
3. **`autopickup` with `pickup_types:$?!=/`**, to collect the useful
   light items without swallowing every rock and suit of armor.
4. **`pickup_burden:unencumbered`**, to keep loot from silently
   stealing your speed.
5. **Red menu text for cursed items**, so a dangerous choice looks
   dangerous.

One more option changes character creation rather than the interface.
`OPTIONS=reroll` lets you reject the first starting attributes and
inventory for another shuffle. It is pleasant if you enjoy choosing
an opening hand, but no roll matters as much as the decisions after it.

#### Status display

**`hilite_status`** colorizes the bottom status line—HP, hunger, AC,
and other fields can each carry threshold rules. Defining a rule
turns highlighting on. Put each complete rule on its own line:

```
OPTIONS=statushilites
OPTIONS=hilite_status:hitpoints/<66%/yellow/<50%/orange/<33%/red&bold/<15%/red&inverse
OPTIONS=hilite_status:hunger/Satiated/yellow/Hungry/orange/Weak/red&bold/Fainting/red&inverse/Fainted/red&inverse+blink
```

Do not split one rule with a trailing backslash: the parser inserts a
space, and later fields are rejected as separate options.
...
The leading and trailing spaces matter: they keep `" cursed "` from
matching the middle of `"uncursed"`.
...
**`pile_limit:5`** is the default. At five or more object stacks, the
game prints a summary instead of listing the pile; `pile_limit:0`
always lists every object.

#### Safety

**`paranoid_confirmation:+attack quit`** adds full-word confirmation
for attacking peacefuls and quitting without clearing the safety
defaults. `pray` is already included by default; `Remove` means
choosing which worn item to remove, not confirming removal.
...
**`pickup_burden:unencumbered`** asks before any pickup—manual or
automatic—that would push you past Unencumbered. The default `S`
waits until a pickup would exceed Stressed; setting `U` keeps you
nimble.
...
OPTIONS=paranoid_confirmation:+attack quit
OPTIONS=autopickup,pickup_types:$?!=/
OPTIONS=pickup_burden:unencumbered
```

**Curses for a paneled UI.** A bigger interface shift requires a
NetHack binary built with the **curses** window interface; the standard
5.0 terminal build may not include it. When it is available, curses
draws a properly paneled UI inside the terminal.
...
- triggers: squeezing past or stepping onto a boulder via
  passes-walls polyform / giant polyform / tiny polyform / very
  light inventory (hack.c:299, 307, 398, 403 via
  could_move_onto_boulder at hack.c:145-163); reading a scroll of
...
with a wand, force bolt, or pick-axe, or reading a scroll of earth in Sokoban) is a −1 Luck
...
solutions can reference them. The `^` symbols mark pits on Level 1
and holes on Levels 2–4; a hole drops you one level even if you are
flying. `<` marks the upstairs. Your starting position is marked `@`.
Coordinates are written **(column, row)**. "Finish X" means push
boulder X to the trap row and then along that row into the nearest
unfilled pit or hole, following the listed order. "Finish C like G"
means reuse G's route for C.
...
**A note on mirroring.** The level is fully mapped when you arrive.
Match its outline to the printed version; if it is flipped, swap left
and right (or up and down) in every step and count columns from the
opposite edge. The web edition's flip buttons do this visually.
...
Two boulders (A and E) remain. The bag-or-amulet prize is in one
...
Two boulders (O and S) remain. The amulet-or-bag prize is
...
Here is the short version. “Start option” means the conduct has to be
chosen before the first turn; the others are watched automatically.

::: dense-table

| Conduct | What breaks it | How it begins |
|---------|----------------|---------------|
| Vegetarian | Eating meat or another forbidden animal food | Automatic |
| Vegan | Eating any animal product | Automatic |
| Foodless | Eating anything, including chewing through a wall | Automatic |
| Atheist | Praying, sacrificing, turning undead, chatting with a priest, or altar-testing an item | Automatic |
| Weaponless | Hitting with a wielded weapon or weapon-tool | Automatic |
| Pacifist | A kill credited to you, including pushing a pet into a fatal trap | Automatic |
| Illiterate | Reading, or engraving anything beyond a single `x` | Automatic |
| Genocideless | Genociding a species or class | Automatic |
| Polyselfless | Changing your own form | Automatic |
| Polypileless | Polymorphing an object | Automatic |
| Wishless | Making a wish | Automatic |
| Artifact-wishless | Asking for an artifact, even if the wish is denied | Automatic |
| Nudist | Wearing armor | `OPTIONS=nudist` |
| Blind (Zen) | —; blindness lasts for the whole game | `OPTIONS=blind` |
| Pauper | —; starting empty is the whole conduct | `OPTIONS=pauper` |
| Petless | Making any monster tame | `OPTIONS=pettype:none` |
| Permadeaf | —; deafness lasts for the whole game | `OPTIONS=permadeaf` |
| Sokoban | Violating its boulder rules after entering | Automatic on entering |
| Bonesless | —; bones stay disabled for the whole game | `OPTIONS=!bones` |
| Unrerolled | Rejecting the first character offered | Accept the first character |
...
technically vegetarian, not vegan, but eating its glob slimes you. The vegetarian
...
poison, violet fungus causes hallucination, and acid blobs sting going down.
...
**Foodless.** Don't eat anything at all. Your practical answers are
prayer (which cures hunger from Hungry status onward, not just
Weak/Fainting) and a ring of slow digestion (which stops ordinary
hunger). Stone to flesh can make meatballs, but eating one breaks the
conduct. Most foodless runs rely on finding a ring of
...
Do not kill a monster yourself. Pet kills and monsters killed through
conflict do not break the conduct; displacing a pet into a fatal trap
does. A pacifist run uses pets for fighting, conflict for crowds, and
[Elbereth](#elbereth) to keep monsters at bay.
...
prompt. Pressing Enter merely asks again. A cursed scroll summons
...
powerful item-generation strategy (polypiling).
...
Combining conducts is where the difficulty climbs. A
...
the stuff of legends (and has been done). For scale: on the public NAO
...
Mazes 5.0 added six more tracked conducts: Pauper, Petless,
Permadeaf, [Sokoban](#sokoban), Bonesless, and Unrerolled. Pauper, Permadeaf, Petless, and
Bonesless are start-of-game options (you opt in or out before
play). Sokoban is tracked automatically based on what you do
during the run; Unrerolled records that you accepted the first
character the game offered.
...
healing; Priest, Knight, and Monk all know protection (Priest
...
Only the *messages* are suppressed. A shrieker still
...
usual "shrieks" message.

Permadeaf navigates by sight and logic alone.
...
Enter Sokoban without breaking its rules. You need not finish the
branch for the conduct to appear at the end of the game. Each cheating action
costs **1 point of Luck** and increments the conduct counter:
**squeezing past** a boulder via a small or empty-handed form,
**fracturing** a boulder with force bolt, a pick-axe, or a wand of striking, **polymorphing**
...
### Shops: Credit, Debt, and Trouble {#shopping-and-shopkeeper-pricing}
...
First, the rule that prevents the most expensive mistake: **do not
cross the shop door with anything marked unpaid.** The shopkeeper
turns hostile, blocks your return, and calls the Keystone Kops. Check
the bill with `I`, then `u`, and pay before you leave. Paying later
dismisses every Kop still hunting you.

#### Credit and Debt

Each shopkeeper keeps a per-customer ledger with three numbers:
credit, debit, and loan.

**How you get credit.** There are two ordinary routes:

1. **Sell to a shopkeeper who has no gold.** Instead of paying cash,
   the shopkeeper may offer credit worth nine-tenths of the normal
   sale offer. The prompt reads:
   "Shopkeeper cannot pay you at present. Will you accept *N*
   zorkmids in credit for that?" A shopkeeper with gold simply pays
...
- **Better** in that leprechauns cannot steal it and it adds no carry
  weight. A shop you'll come back to can serve as a bank.
...
(There is an old piece of shop cheese called *credit cloning*: drop
a bag containing gold in the shop, then have your pet carry the bag
outside. The shop keeps the credit while you recover the same coins.)
...
**Loan** is the game's name for gold belonging to the shopkeeper that
you picked up from the shop floor. Dropping gold in the shop repays
the loan before it adds to your credit.
...
everything: they track every item you pick up or that enters the
shop, even when you are invisible.

::: dense-table

| Problem | Shopkeeper's response | Safest fix |
|---------|-----------------------|------------|
| Try to leave owing money | Blocks the door; escape brings Kops | Check `I`, then `u`, and pay first |
| Break or use an unpaid item | Adds the damage or use fee to your bill | Pay before leaving |
| Kick down a locked shop door | Demands 400 zm; refusal starts a fight | Pick the lock or use opening |
| Dig through a shop wall | Demands 10 zm per point of Strength | Pay, or leave the wall alone |
| Dig down while you owe | Takes your entire pack | Clear the bill before digging |
| Attack the shopkeeper | Turns hostile | `#chat` and pay the 1,000 zm buy-off |
| Arrive invisible or holding a pick-axe | Refuses entry | Become visible and put the pick-axe away |

:::

Artifact items are priced at four times their base value: from
800 zm for Giantslayer to 32,000 zm for Stormbringer or
Grayswandir. An unidentified long sword with a five-figure quote
...
fight. Killing one does not itself summon Keystone Kops; the Kops
respond when you leave a shop owing money. It does cost alignment;
non-chaotic characters also lose 2 Luck and telepathy.
**Polymorphing the shopkeeper first** (via wand or trap) means
killing them no longer counts as murder, which is the preferred
approach for Lawful and Neutral characters. Strong late-game players
sometimes clear shops, but it is not a casual mid-game move.

Three habits prevent most shop mistakes:

- **Check the bill directly.** Use `I`, then `u`, to list unpaid
  inventory. Nothing sells on the door square, so the old trick of
  dropping everything there tells you less than the inventory command.
- **Sell, then deposit.** A normal sale pays gold. Drop that gold on
  the shop floor if you want to turn it into credit.
...
- **"Closed for inventory" engraving on a door.** That marks a
  ...
  no shopkeepers, so its shop items really are ownerless.)
...
Use a **touchstone** (gray stone, base price 45,
occasionally found in the Mines and elsewhere). Rubbing an
...
Every gem weighs 1, and gems of the same identified type stack into a single
...
Every real gem, with its base value. An ordinary sale offer starts at
about half that figure, before Charisma and other modifiers.
...
dust scratch a finger or soft gem leaves). If a thrown gem hits,
a hard gem survives two times in three; a softer gem or piece of
glass survives one time in three. Hardness doesn't affect touchstoning: every
...
- **Every real gem is equally good for unicorn luck.** A 200 zm agate
  thrown to a co-aligned unicorn gives the same +5 Luck as a 3250 zm
  jacinth. Don't sell off your "junk" gems before you've found an
  alignment-matching unicorn to feed them to.
- **The price column matters when selling and in your final score.**
...
- **Top tier** (≥ 2500: dilithium, diamond, ruby, jacinth, sapphire,
  black opal, emerald) are worth selling individually. At ordinary
  rates their offers begin at half base value—a diamond brings 2,000
  zm—and a shop that does not deal in gems will not buy them at all.
- **Worthless glass never costs luck.** Glass thrown at a unicorn is
  either rejected ("not interested in your junk") or accepted
  accepted. The Luck risk only fires on *real* gems thrown to a
  **wrong-alignment** unicorn (random −3 to +3). Watch the wording:
  a unicorn accepts a real gem that raised your Luck *gratefully*,
  worthless glass that did nothing *graciously*.
...
Damage is shown as **vs small / vs large**, the dice rolled before enchantment and excluding silver/material bonuses. **Wt** is unit weight; **Cost** is the unenchanted shop base price in zorkmids. **Hit** is the to-hit bonus baked into the weapon itself (most are 0). Two-handed weapons that prevent shield use and two-weapon combat are flagged in the notes. Weapons are grouped by skill; consult the [per-role skill caps](#per-role-skill-caps) before investing slots. Samurai-language names for a handful of weapons are shown in parentheses (a Samurai sees them on screen by those names; same underlying item).
...
| crysknife | 1d10 / 1d10 | 20 | 100 | +3 | bone | Reverts to a worm tooth when dropped or thrown. An erodeproof one reverts only about 10% of the time. |
...
your Strength damage is multiplied by 1.5. Combined with the high
base dice below, that
is much of why two-handed swords rival one-hand-plus-shield
despite forfeiting the shield slot.
...
| Weapon | Damage (S/L) | Wt | Cost | Hit | Material | Notes |
|--------------------|--------------|----|------|-----|--------------|----------------------------------------------------------------|
| morning star | 1d4+1d4 / 1d6+1 | 120 | 10 | — | iron | +1d4 small, +1 large; solid damage for a one-handed weapon. |
...
| grappling hook | 1d2 / 1d6 | 30 | 50 | — | iron | Trains flail. Apply at two-square reach to snag objects, pull very small monsters, or drag yourself a step. |
...
All spears share the same skill; the trident uses a different
one (see below). The Valkyrie starts with one and can train to
...
Melee built for mounted combat. Any hit from horseback has a chance
to joust for heavy extra damage. On foot it remains a useful reach
weapon: apply it to attack from two squares away.

::: dense-table

| Weapon | Damage (S/L) | Wt | Cost | Hit | Material | Notes |
|--------------------|--------------|----|------|-----|--------------|----------------------------------------------------------------|
| lance | 1d6 / 1d8 | 180 | 10 | — | iron | One-handed. A mounted hit can joust for +2d10 primary-weapon damage (+2d2 off-hand); about one successful joust in 250 shatters the lance. On foot it keeps polearm reach but gets no joust bonus. |
...
One-handed launcher. Wield a bow and fire arrows from your quiver
with `f`. Expert wielders multishot; Ranger and Samurai are the
specialists. A bow prevents two-weapon combat but leaves your shield
available.
...
One-handed launcher. Hits harder per shot than the bow but
reloads more slowly, and full multishot needs Str 18 (Str 16 for
gnomes). Like a bow, it prevents two-weapon combat but not shield use.

::: dense-table

| Weapon | Damage (S/L) | Wt | Cost | Hit | Material | Notes |
|--------------------|--------------|----|------|-----|--------------|----------------------------------------------------------------|
| crossbow bolt | 1d4+1 / 1d6+1 | 1 | 2 | — | iron | Stackable. |
| crossbow | — | 50 | 40 | — | wood | Bolts pierce. At **Str 18** (16 for gnomes), multishot uses the normal roll; below that, the game rolls twice and takes the smaller volley. Gnomes also get +1 multishot. Rogues and Rangers reach Expert, Knights Skilled. |
...
Throw-only. Monks get +1 multishot on shuriken.
...
| dwarvish mithril-coat | +6 | 2 | 150 | 240 | mithril | Light, but metallic: the suit penalty to casting is the same as plate mail's. |
| elven mithril-coat | +5 | 2 | 150 | 240 | mithril | Light, but metallic: the suit penalty to casting is the same as plate mail's. |
...
| yellow dragon scale mail | +9 | — | 40 | 900 | hide | Acid resistance + stoning resistance. |
...
| alchemy smock | +1 | 1 | 10 | 50 | cloth | Poison resistance. |
...
| fedora | +0 | — | 3 | 1 | cloth | Archeologist starter; grants that role +1 Luck. |
...
| helm of telepathy | +1 | — | 50 | 50 | iron | Telepathy within 8 squares while sighted; whole level while blind. |
...
| water walking boots \* | +1 | — | 15 | 50 | leather | Cross water and ice; a fireproof pair plus fire resistance can cross lava. |
| jumping boots \* | +1 | — | 20 | 50 | leather | Use `#jump` to leap to a chosen nearby square. |
...
| large shield | +2 | — | 100 | 10 | iron | Like every shield, blocks two-handed weapons and two-weapon combat. |
...
| magic missile   | Attack      | 2   | ray        | (XL÷2 + 1)d6 force ray, rounding XL÷2 down; magic resistance blocks it | —             |
| cone of cold    | Attack      | 4   | ray        | (XL÷2 + 1)d6 cold ray, rounding XL÷2 down | Aimed explosion          |
| fireball        | Attack      | 4   | ray        | (XL÷2 + 1)d6 fire ray, rounding XL÷2 down | Aimed explosion          |
| finger of death | Attack      | 7   | ray        | Death ray; magic resistance blocks it when incoming, though self-zapping bypasses that check | — |
| healing         | Healing     | 1   | aimed      | Restore hit points                  | Also cures blindness          |
| cure blindness  | Healing     | 2   | untargeted | Removes blindness                   | —                             |
| cure sickness   | Healing     | 3   | untargeted | Cures food poisoning and illness    | —                             |
| extra healing   | Healing     | 3   | aimed      | Heals more HP                       | —                             |
| stone to flesh  | Healing     | 3   | aimed      | Animates a statue as a live monster; cures stoning | —                 |
| restore ability | Healing     | 4   | untargeted | Restores one drained stat           | Restores all drained stats    |
| detect monsters | Divination  | 1   | untargeted | Reveals monsters on level           | Longer duration               |
| light           | Divination  | 1   | untargeted | Lights the current room             | —                             |
| detect food     | Divination  | 2   | untargeted | Reveals food on level               | Warns before a harmful meal   |
...
| identify        | Divination  | 3   | untargeted | Identifies one inventory item       | Identifies multiple items     |
| detect treasure | Divination  | 4   | untargeted | Reveals every object on the level   | Identifies detected object types |
| magic mapping   | Divination  | 5   | untargeted | Reveals the entire level            | —                             |
| confuse monster | Enchant.    | 1   | untargeted | Next melee hit confuses target      | Charges several hits          |
| slow monster    | Enchant.    | 2   | aimed      | Slows target's speed                | —                             |
| cause fear      | Enchant.    | 3   | untargeted | Visible monsters flee               | —                             |
| sleep           | Enchant.    | 3   | ray        | Puts targets in line to sleep       | —                             |
| charm monster   | Enchant.    | 5   | untargeted | Tames monsters in a 3×3 area        | —                             |
...
| remove curse    | Cleric      | 3   | untargeted | Uncurses worn/wielded items         | Uncurses all carried items    |
...
| haste self      | Escape      | 3   | untargeted | Temporary fast movement             | Longer duration               |
| invisibility    | Escape      | 4   | untargeted | Become invisible                    | —                             |
| levitation      | Escape      | 4   | untargeted | Float over pits and water           | Can end at will with `>`      |
...
Every monster you might meet, grouped by map symbol. **Lvl** is base monster level. **Spd** is movement rate (12 is normal player speed). **AC** is armor class (lower is better). **MR** is the percentage chance the monster resists your spells and magic attacks. **Attacks** lists each mode, damage roll, and side effect; attacks separated by `·` can all occur in one turn. **Notes** lists traits that change the fight, such as flight, seeing invisible, regeneration, or a poisonous corpse.
...
Slow and mindless. Don't melee an acid blob with bare hands or a metal weapon you care about: the passive acid corrodes both. Gelatinous cubes paralyse on touch.
...
Medieval bestiary creature: a chicken with a serpent's tail whose touch turns flesh to stone. Carry a lizard corpse and fight gloved. No role resists stoning by default, and wielding a cockatrice corpse bare-handed kills you immediately. See [Petrification](#petrification-stoning).
...
| werejackal | brown | 2 | 12 | 7 | 10 | bite 1d4 lyc | regenerates, pois-res. No corpse. |
...
| werewolf | gray | 5 | 12 | 4 | 20 | bite 2d6 lyc | regenerates, pois-res. No corpse. |
...
| floating eye | blue | 2 | 1 | 9 | 10 | passive 3d70 paralyse | amphibious. Passive gaze paralyses on melee if you and the eye can both see each other. Use ranged, or wear a blindfold or towel to break sight. Corpse always grants telepathy. |
...
- Only Wizard guarantees a kitten (urole.petnum=PM_KITTEN per role.c:548); every role without a fixed pet rolls 50/50 kitten-or-dog (dog.c:90-101).
-->

Wild felines are fast and hostile; a tiger or displacer beast can
turn an ordinary corridor into a bad fight. Wizards always start with
a kitten, while roles without a fixed pet roll evenly between a
kitten and a little dog.
...
| jaguar | brown | 4 | 15 | 6 | 0 | claw 1d4 ×2 · bite 1d8 |  |
| lynx | cyan | 5 | 15 | 6 | 0 | claw 1d4 ×2 · bite 1d10 |  |
| panther | black | 5 | 15 | 6 | 0 | claw 1d6 ×2 · bite 1d10 |  |
| large cat | white | 6 | 15 | 4 | 0 | bite 2d4 | tameable. |
| tiger | yellow | 6 | 12 | 6 | 0 | claw 2d4 ×2 · bite 1d10 |  |
| displacer beast | blue | 12 | 12 | -10 | 0 | claw 4d4 ×2 · bite 2d10 |  |
...
| Name | Color | Lvl | Spd | AC | MR | Attacks | Notes |
|----------------|-------|-----|-----|----|-----| -------------------------------------------- |--------------------------------------------------------|
| gremlin | green | 5 | 12 | 2 | 25 | claw 1d6 ×2 · bite 1d4 · claw curse | swims, poisonous-corpse, follows stairs, pois-res. |
| gargoyle | brown | 6 | 10 | -4 | 0 | claw 2d6 ×2 · bite 2d4 | ston-res. |
| winged gargoyle | magenta | 9 | 15 | -2 | 0 | claw 3d6 ×2 · bite 3d4 | flies, ston-res. |
...
Dwarves carry better-than-average loot (weapons, armor, and pick-axes), but
that same equipment makes them dangerous to an unarmored explorer.
...
| dwarf lord | blue | 4 | 6 | 10 | 10 | weapon 2d4 ×2 | tunnels. |
| dwarf king | magenta | 6 | 6 | 10 | 20 | weapon 2d6 ×2 | tunnels. |
| mind flayer | bright-magenta | 9 | 12 | 5 | 90 | weapon 1d4 · tentacle 2d1 drain-Int ×3 | flies, sees-invis. Tentacles drain Int; once it reaches 3, the next tentacle that lands kills you. Any helmet blocks 7/8 of tentacles. |
| master mind flayer | bright-magenta | 13 | 12 | 0 | 90 | weapon 1d8 · tentacle 2d1 drain-Int ×5 | flies, sees-invis. Five tentacles per turn. Any helmet blocks 7/8 of tentacles. |
...
Mostly annoying small fry. Imps insult you and miss; quasits drain Dexterity. A homunculus's bite can put you to sleep. Without sleep resistance, fight at range.
...
| Name | Color | Lvl | Spd | AC | MR | Attacks | Notes |
|----------------|-------|-----|-----|----|-----| -------------------------------------------- |--------------------------------------------------------|
| manes | red | 1 | 3 | 7 | 0 | claw 1d3 ×2 · bite 1d4 | sleep-res. No corpse. |
| homunculus | green | 2 | 12 | 6 | 10 | bite 1d3 sleep | flies, poisonous-corpse, sleep-res. |
| imp | red | 3 | 12 | 2 | 20 | claw 1d4 | regenerates. |
| lemure | brown | 3 | 3 | 7 | 0 | claw 1d3 | Gehennom-only, regenerates, sleep-res. No corpse. |
| quasit | blue | 3 | 15 | 2 | 20 | claw 1d2 drain-Dx ×2 · bite 1d4 | regenerates. |
...
- A passive attack written as 0dN in the monster definition rolls (monster level + 1)dN in combat; blue jelly is therefore 6d6 and spotted jelly 7d6 (uhitm.c:5885-5888).
-->
...
| Name | Color | Lvl | Spd | AC | MR | Attacks | Notes |
|----------------|-------|-----|-----|----|-----| -------------------------------------------- |--------------------------------------------------------|
| blue jelly | blue | 4 | 0 | 8 | 10 | passive 5d6 cold | corpse: cold + poison resistance. |
| spotted jelly | green | 5 | 0 | 8 | 10 | passive 6d6 acid | corpse: temp acid + stone resistance. |
...
- Kobold shaman has only one AT_MAGC/AD_SPEL attack (monsters.h:651); notation is "cast spell," not "cast spell."
-->


Weak early-game fodder. Every kobold corpse is poisonous; leave them alone unless you have poison resistance.
...
Steals gold and teleports away. The fix is to carry no gold near them, or to kill from range. The corpse drops any gold it still carries.
...
| giant mimic | magenta | 9 | 3 | 7 | 20 | claw 3d6 sticky ×2 |  |
...
Steals one item and teleports to a random spot on the same level. Engage from range, block her path with pets, or engrave Elbereth. If she gets a hit in and you want the item back, you'll need to sweep the level to find and kill her; she drops what she stole when she dies.
...
- orc shaman L3/Spd9/AC5 single AT_MAGC/AD_SPEL (monsters.h:779-787); "spell," not "cast spell."
- orc-captain L5/Spd5/AC10 weapon 2d4 ×2 (monsters.h:788-796).
- Goblin is correctly placed in S_ORC (monsters.h:727).
-->

Pack hunters with mediocre loot, but they swarm; find a chokepoint in [the Mines](#the-gnomish-mines).
...
| orc shaman | bright-blue | 3 | 9 | 5 | 10 | cast | pois-res. |
| orc-captain | magenta | 5 | 5 | 10 | 0 | weapon 2d4 ×2 | pois-res. Hits hard. Drops decent loot. |
...
Clings to the ceiling and drops for a flat 4d6 when you walk under.
A hard helmet makes the blow glance off; otherwise good AC can still
win the dodge roll. Flying or a level without a ceiling prevents the
ambush entirely.
...
Rothes are early-game wreckers (three attacks per turn). Mumakil are slow but hit for 4d12.
...
| baluchitherium | gray | 14 | 12 | 5 | 0 | claw 5d4 ×2 |  |
| mastodon | black | 20 | 12 | 5 | 0 | butt 4d8 ×2 |  |
...
| wererat | brown | 2 | 12 | 6 | 10 | bite 1d4 lyc | regenerates, pois-res. No corpse. |
| rock mole | gray | 3 | 3 | 0 | 20 | bite 1d6 | tunnels, eats metal objects left on the floor. |
...
Includes scorpions and centipedes. Giant spider and scorpion corpses
are poisonous; cave spider and centipede corpses are safe. Do not
confuse corpse poison with food poisoning from old food.
...
| scorpion | red | 5 | 15 | 3 | 0 | claw 1d2 ×2 · sting 1d4 poison | hides, poisonous-corpse. |
...
Stationary engulfers that hide as part of the dungeon. Farlook cannot
show a hidden lurker. Search beside a suspicious square to reveal one
...
| energy vortex | bright-blue | 6 | 20 | 2 | 30 | engulf 1d6 shock · engulf 2d6 drain-Pw · passive 7d4 shock |  |
| steam vortex | blue | 7 | 22 | 2 | 30 | engulf 1d8 fire |  |
| fire vortex | yellow | 8 | 22 | 2 | 30 | engulf 1d10 fire · passive 9d4 fire |  |
...
Long worms become a maze of tail segments as they grow. Purple worms swallow you whole and digest. Fight them in the open so you can retreat before the swallow.
...
A zruty is a nasty mid-game brute with two claws and a heavy bite,
but worth good experience if you can take the flurry. The name comes
from the hairy wild man of Slavic folklore.

::: dense-table

| Name | Color | Lvl | Spd | AC | MR | Attacks | Notes |
|----------------|-------|-----|-----|----|-----| -------------------------------------------- |--------------------------------------------------------|
| zruty | brown | 9 | 8 | 3 | 0 | claw 3d4 ×2 · bite 3d6 |  |
...
All angelic beings follow you up and down stairs, and none leaves a
corpse. All except *Aleax* also fly. All except *couatl* also see
invisible.
...
| Name | Color | Lvl | Spd | AC | MR | Attacks | Notes |
|----------------|-------|-----|-----|----|-----| -------------------------------------------- |--------------------------------------------------------|
| couatl | green | 8 | 10 | 5 | 30 | bite 2d4 poison · bite 1d3 · hug 2d4 wrap | pois-res. |
| Aleax | yellow | 10 | 8 | 0 | 30 | weapon 1d6 ×2 · kick 1d4 |  |
| Angel | white | 14 | 10 | -4 | 55 | weapon 1d6 ×2 · claw 1d4 · cast 2d6 magic |  |
| ki-rin | yellow | 16 | 18 | -5 | 90 | kick 2d4 ×2 · butt 3d6 · cast 2d6 spell |  |
| Archon | magenta | 19 | 16 | -6 | 80 | weapon 2d4 ×2 · gaze 2d6 blind · claw 1d8 · cast 4d6 spell | regenerates. |
...
| mountain centaur | cyan | 6 | 20 | 2 | 10 | weapon 1d10 · kick 1d6 ×2 |  |
...
| gray dragon | gray | 15 | 9 | -1 | 20 | breath 4d6 magic · bite 3d8 · claw 1d4 ×2 | sees-invis. Anti-magic breath. Magic resistance helps; reflection doesn't. |
| gold dragon | yellow | 15 | 9 | -1 | 20 | breath 4d6 fire · bite 3d8 · claw 1d4 ×2 | sees-invis. Fire breath. Drops gold-colored scales (light source). |
| silver dragon | bright-cyan | 15 | 9 | -1 | 20 | breath 4d6 cold · bite 3d8 · claw 1d4 ×2 | sees-invis. Cold breath plus reflection scales: your reflection target. |
| red dragon | red | 15 | 9 | -1 | 20 | breath 6d6 fire · bite 3d8 · claw 1d4 ×2 | sees-invis. Cone of fire. Get fire resistance before you meet one. |
| white dragon | white | 15 | 9 | -1 | 20 | breath 4d6 cold · bite 3d8 · claw 1d4 ×2 | sees-invis. Cone of cold. Cold resistance. |
| orange dragon | orange | 15 | 9 | -1 | 20 | breath 4d25 sleep · bite 3d8 · claw 1d4 ×2 | sees-invis. Sleep ray. Sleep resistance trivialises. |
| black dragon | black | 15 | 9 | -1 | 20 | breath 1d255 disint · bite 3d8 · claw 1d4 ×2 | sees-invis. Disintegration breath. Disint resistance OR reflection. |
| blue dragon | blue | 15 | 9 | -1 | 20 | breath 4d6 shock · bite 3d8 · claw 1d4 ×2 | sees-invis. Cone of lightning. Shock resistance. |
| green dragon | green | 15 | 9 | -1 | 20 | breath 4d6 poison · bite 3d8 · claw 1d4 ×2 | sees-invis, poisonous-corpse. Poison breath; poison resistance is enough. |
| yellow dragon | yellow | 15 | 9 | -1 | 20 | breath 4d6 acid · bite 3d8 · claw 1d4 ×2 | sees-invis. Acid breath. |
| Chromatic Dragon | magenta | 16 | 12 | 0 | 30 | breath 6d6 rnd-breath · cast spell · claw 2d8 steal-amulet · bite 4d8 ×2 · sting 1d6 | sees-invis, poisonous-corpse, follows stairs. |
| Ixoth | red | 15 | 12 | -1 | 20 | breath 8d6 fire · bite 4d8 · cast spell · claw 2d4 · claw 2d4 steal-amulet | sees-invis, follows stairs. |
...
Air elementals engulf and batter you with debris; fire elementals
burn; water elementals strike once for 5d6 but do not drown you;
earth elementals are slow and tough.
...
| Name | Color | Lvl | Spd | AC | MR | Attacks | Notes |
|----------------|-------|-----|-----|----|-----| -------------------------------------------- |--------------------------------------------------------|
| stalker | white | 8 | 12 | 3 | 0 | claw 4d4 | flies, sees-invis, follows stairs. |
| air elemental | cyan | 8 | 36 | 2 | 30 | engulf 1d10 | flies. |
| fire elemental | yellow | 8 | 12 | 2 | 30 | claw 3d6 fire · passive 9d4 fire | flies. |
...
| brown mold | brown | 1 | 0 | 9 | 0 | passive 2d6 cold | cold-res, pois-res. |
| yellow mold | yellow | 1 | 0 | 9 | 0 | passive 2d4 stun | poisonous-corpse, pois-res. |
| green mold | green | 1 | 0 | 9 | 0 | passive 2d4 acid | acid-res, ston-res. |
| red mold | red | 1 | 0 | 9 | 0 | passive 2d4 fire | fire-res, pois-res. |
...
Gnomish PCs find most Mines residents peaceful. A gnome lord hits
harder than its ordinary kin, and a gnomish wizard attacks only with
spells; do not mistake either for harmless company.
...
| titan | magenta | 16 | 18 | -3 | 70 | weapon 2d8 · cast spell | flies. Tough humanoid with magic missiles. Casts spells. |
| minotaur | brown | 15 | 15 | 6 | 0 | claw 3d10 ×2 · butt 2d8 | Two claws plus a butt. Heavy hitter; roams the Gehennom mazes. |
| Cyclops | gray | 18 | 12 | 0 | 0 | weapon 4d8 ×2 · claw 2d6 steal-amulet | follows stairs, ston-res. Healer quest nemesis. Throws boulders. |
| Lord Surtur | magenta | 15 | 12 | 2 | 50 | weapon 2d10 ×2 · claw 2d6 steal-amulet | follows stairs, fire-res, ston-res. Valkyrie quest nemesis. |
...
The monster from Lewis Carroll's *Jabberwocky* ("O frabjous day! Callooh! Callay!") moves at player baseline speed and makes four 2d10 attacks. Decide early whether you can stand and trade blows. Vorpal Blade beheads it automatically.

::: dense-table

| Name | Color | Lvl | Spd | AC | MR | Attacks | Notes |
|----------------|-------|-----|-----|----|-----| -------------------------------------------- |--------------------------------------------------------|
| jabberwock | orange | 15 | 12 | -2 | 50 | bite 2d10 ×2 · claw 2d10 ×2 | flies. Four heavy attacks; baseline speed. |
...
Police force triggered by stealing from shops or hurting shopkeepers. Mostly weak individually but they swarm, and dead Kops respawn: each fallen Kop has a 1-in-5 chance to return near the down-stairs and a 1-in-5 chance to return elsewhere. Paying what you owe dismisses every Kop. Otherwise escape or genocide them instead of grinding through the force.
...
2026-05-31:
- Touch of death (mcastu.c:389-408): without Antimagic, `rn2(mtmp->m_lev) > 12` gates the effect. At m_lev 25 that succeeds 12/25 of the time; touch_of_death then deals 50+8d6 damage and drains half that amount from max HP. Magic resistance blocks the effect (mcastu.c:315-347).
...
| Name | Color | Lvl | Spd | AC | MR | Attacks | Notes |
|----------------|-------|-----|-----|----|-----| -------------------------------------------- |--------------------------------------------------------|
| lich | brown | 11 | 6 | 0 | 30 | touch 1d10 cold · cast spell |  |
| demilich | red | 14 | 9 | -2 | 60 | touch 3d4 cold · cast spell |  |
| master lich | magenta | 17 | 9 | -4 | 90 | touch 3d6 cold · cast spell | fire-res. Casts wizard spells. Kill from afar. |
| arch-lich | magenta | 25 | 9 | -6 | 90 | touch 5d6 cold · cast spell | fire-res, shock-res. Casts touch of death; magic resistance mandatory. |
...
- All M-class rows carry G_NOCORPSE, which prevents random mummy corpses and tins. The death handler overrides it and creates an already-old corpse of the mummy's base race (mon.c:620-646).
- Mummies are vulnerable to undead-turning.
-->

Mindless undead. A wand or spell of undead turning deals 1d8 and
makes a mummy flee. There is no scroll of undead turning. On death,
a mummy leaves the already-old corpse of its base race; eating it
without sickness resistance risks food poisoning, not magical aging.

::: dense-table

| Name | Color | Lvl | Spd | AC | MR | Attacks | Notes |
|----------------|-------|-----|-----|----|-----| -------------------------------------------- |--------------------------------------------------------|
| kobold mummy | brown | 3 | 8 | 6 | 20 | claw 1d4 | cold-res, sleep-res, pois-res. Drops an old kobold corpse. |
| gnome mummy | red | 4 | 10 | 6 | 20 | claw 1d6 | cold-res, sleep-res, pois-res. Drops an old gnome corpse. |
| orc mummy | gray | 5 | 10 | 5 | 20 | claw 1d6 | cold-res, sleep-res, pois-res. Drops an old orc corpse. |
| dwarf mummy | red | 5 | 10 | 5 | 20 | claw 1d6 | cold-res, sleep-res, pois-res. Drops an old dwarf corpse. |
| elf mummy | green | 6 | 12 | 4 | 30 | claw 2d4 | cold-res, sleep-res, pois-res. Drops an old elf corpse. |
| human mummy | gray | 6 | 12 | 4 | 30 | claw 2d4 ×2 | cold-res, sleep-res, pois-res. Drops an old human corpse. |
| ettin mummy | blue | 7 | 12 | 4 | 30 | claw 2d6 ×2 | cold-res, sleep-res, pois-res. Drops an old ettin corpse. |
| giant mummy | cyan | 8 | 14 | 3 | 30 | claw 3d4 ×2 | cold-res, sleep-res, pois-res. Drops an old giant corpse. |
...
Long serpentine bodies with ranged attacks. All nagas are
poison-resistant. A black naga corpse can grant permanent poison
resistance; its acid and stoning resistance last only a few turns.
...
Big melee brutes. They carry a club and sometimes a battle-axe, but
no armor.
...
**Green slime** is a [Gehennom](#gehennom)-only exception: doesn't split, leaves a glob, and one touch starts a 10-turn countdown to becoming one yourself. Fight at range, burn yourself with fire to clear it, or wear an **amulet of unchanging** (blocks and aborts the transformation). Prayer doesn't work in Gehennom, so don't rely on it. See *Delayed Deaths* for the full cure list.
...
| Name | Color | Lvl | Spd | AC | MR | Attacks | Notes |
|----------------|-------|-----|-----|----|-----| -------------------------------------------- |--------------------------------------------------------|
| gray ooze | gray | 3 | 1 | 8 | 0 | bite 2d8 rust | fire-res. |
| brown pudding | brown | 5 | 3 | 8 | 0 | bite decay |  |
| green slime | green | 6 | 6 | 6 | 0 | touch 1d4 slime · passive slime | No corpse. |
...
| Name | Color | Lvl | Spd | AC | MR | Attacks | Notes |
|----------------|-------|-----|-----|----|-----| -------------------------------------------- |--------------------------------------------------------|
| rust monster | brown | 5 | 18 | 2 | 0 | touch rust ×2 · passive rust | swims. Touch rusts iron. Strip armor before engaging or use silver. |
...
| python | magenta | 6 | 3 | 5 | 0 | bite 1d4 · touch · hug 1d4 wrap · hug 2d4 |  |
| pit viper | blue | 6 | 15 | 2 | 0 | bite 1d4 poison ×2 | poisonous-corpse, pois-res. |
...
| Name | Color | Lvl | Spd | AC | MR | Attacks | Notes |
|----------------|-------|-----|-----|----|-----| -------------------------------------------- |--------------------------------------------------------|
| umber hulk | brown | 9 | 6 | 2 | 25 | claw 3d4 ×2 · bite 2d5 · gaze confuse | tunnels. Confusion gaze. Hard to navigate around. Hits hard too. |
...
- Vampire and vampire lord carry G_NOCORPSE, but the death handler substitutes an already-old human corpse. Vlad leaves none (mon.c:613-646).
...
Drains XL on bite. Shapeshifts to bat or cloud. An ordinary vampire
or vampire lord leaves an already-old human corpse; Vlad leaves none.
Vlad the Impaler is the boss of [Vlad's Tower](#vlads-tower).
...
| Name | Color | Lvl | Spd | AC | MR | Attacks | Notes |
|----------------|-------|-----|-----|----|-----| -------------------------------------------- |--------------------------------------------------------|
| vampire | red | 10 | 12 | 1 | 25 | claw 1d6 · bite 1d6 drain-XL | Drops an old human corpse. |
| vampire lord | blue | 12 | 14 | 0 | 50 | claw 1d8 · bite 1d8 drain-XL | Drops an old human corpse. |
...
A wraith drains an experience level on touch. A fresh plain wraith corpse repays the danger by granting an experience level when eaten; barrow wights and Nazgul leave no corpse.
...
| Name | Color | Lvl | Spd | AC | MR | Attacks | Notes |
|----------------|-------|-----|-----|----|-----| -------------------------------------------- |--------------------------------------------------------|
| barrow wight | gray | 3 | 12 | 5 | 5 | weapon drain-XL · cast spell · claw 1d4 · touch 1d4 cold | cold-res, sleep-res, pois-res. |
...
| Name | Color | Lvl | Spd | AC | MR | Attacks | Notes |
|----------------|-------|-----|-----|----|-----| -------------------------------------------- |--------------------------------------------------------|
| xorn | brown | 8 | 9 | -2 | 20 | claw 1d3 ×3 · bite 4d6 | fire-res, cold-res, ston-res. |
...
| ape | brown | 4 | 12 | 6 | 0 | claw 1d3 ×2 · bite 1d6 |  |
| owlbear | brown | 5 | 12 | 5 | 0 | claw 1d6 ×2 · hug 2d8 |  |
| yeti | white | 5 | 15 | 6 | 0 | claw 1d6 ×2 · bite 1d4 | cold-res. |
| carnivorous ape | black | 6 | 12 | 6 | 0 | claw 1d4 ×2 · hug 1d8 |  |
| sasquatch | gray | 7 | 15 | 6 | 0 | claw 1d6 ×2 · kick 1d8 | sees-invis. |
...
- Race-based zombies carry G_NOCORPSE, but the death handler substitutes an already-old corpse of their base race (mon.c:620-646). Ghouls and skeletons leave none.
- Skeleton has G_NOGEN: never randomly generated, only from Orcus Town or a bone devil's summons.
- M2_UNDEAD is the class flag (NOT "M3_UNDEAD"); M2_STALK is universal across this section.
-->

Slow undead. Easy to kite. Race-based zombies leave an already-old
corpse of their base race, so eating one without sickness resistance
risks food poisoning. A wand or spell of undead turning deals 1d8 and
makes them flee; there is no corresponding scroll. The
**skeleton** doesn't generate randomly: it appears in Orcus Town or
when summoned by a bone devil. Big zombie populations live in
morgues.
...
| Name | Color | Lvl | Spd | AC | MR | Attacks | Notes |
|----------------|-------|-----|-----|----|-----| -------------------------------------------- |--------------------------------------------------------|
| kobold zombie | brown | 0 | 6 | 10 | 0 | claw 1d4 | follows stairs, cold-res, sleep-res, pois-res. Drops an old kobold corpse. |
| gnome zombie | brown | 1 | 6 | 10 | 0 | claw 1d5 | follows stairs, cold-res, sleep-res, pois-res. Drops an old gnome corpse. |
| orc zombie | gray | 2 | 6 | 9 | 0 | claw 1d6 | follows stairs, cold-res, sleep-res, pois-res. Drops an old orc corpse. |
| dwarf zombie | red | 2 | 6 | 9 | 0 | claw 1d6 | follows stairs, cold-res, sleep-res, pois-res. Drops an old dwarf corpse. |
| elf zombie | green | 3 | 6 | 9 | 0 | claw 1d7 | follows stairs. Drops an old elf corpse. |
| human zombie | white | 4 | 6 | 8 | 0 | claw 1d8 | follows stairs. Drops an old human corpse. |
| ettin zombie | blue | 6 | 8 | 6 | 0 | claw 1d10 ×2 | follows stairs, cold-res, sleep-res, pois-res. Drops an old ettin corpse. |
| ghoul | black | 3 | 6 | 10 | 0 | claw 1d2 paralyse · claw 1d3 | cold-res, sleep-res, pois-res. No corpse. |
| giant zombie | cyan | 8 | 8 | 6 | 0 | claw 2d8 ×2 | follows stairs, cold-res, sleep-res, pois-res. Drops an old giant corpse. |
...
| wererat | brown | 2 | 12 | 10 | 10 | weapon 2d4 | regenerates. No corpse. |
| werejackal | red | 2 | 12 | 10 | 10 | weapon 2d4 | regenerates. No corpse. |
| werewolf | orange | 5 | 12 | 10 | 20 | weapon 2d4 | regenerates. No corpse. |
...
| elf-lord | bright-blue | 8 | 12 | 10 | 20 | weapon 2d4 ×2 | sees-invis. |
| Elvenking | magenta | 9 | 12 | 10 | 25 | weapon 2d4 ×2 | sees-invis. |
| doppelganger | white | 9 | 12 | 5 | 20 | weapon 1d12 | shapeshifter. |
| shopkeeper | white | 12 | 16 | 0 | 50 | weapon 4d4 ×2 | starts peaceful. Don't anger one. |
| guard | blue | 12 | 12 | 10 | 40 | weapon 4d10 | starts peaceful. |
| prisoner | white | 12 | 12 | 10 | 0 | weapon 1d6 | starts peaceful. |
| Oracle | bright-blue | 12 | 0 | 0 | 50 | passive 13d4 magic | starts peaceful. |
| priest | white | 12 | 12 | 10 | 50 | weapon 4d10 · kick 1d4 · cast cleric | starts peaceful. Temple defenders. Convert their altars or sacrifice on them. |
| high priest | white | 25 | 15 | 7 | 70 | weapon 4d10 · kick 2d8 · cast 2d8 cleric ×2 | sees-invis. Endgame altar guardian. Don't fight one head-on. |
...
| lieutenant | green | 10 | 10 | 10 | 15 | weapon 3d4 ×2 | follows stairs. |
| captain | blue | 12 | 10 | 10 | 15 | weapon 4d4 ×2 | follows stairs. |
| watchman | gray | 6 | 10 | 10 | 0 | weapon 1d8 | follows stairs, starts peaceful. |
| watch captain | green | 10 | 10 | 10 | 15 | weapon 3d4 ×2 | follows stairs, starts peaceful. |
| Medusa | bright-green | 20 | 12 | 2 | 50 | weapon 2d4 · claw 1d8 · gaze petrify · bite 1d6 poison | flies, swims, amphibious, poisonous-corpse. |
| Wizard of Yendor | bright-magenta | 30 | 12 | -8 | 100 | claw 2d12 steal-amulet · cast spell | flies, regenerates, sees-invis, fire-res, poison-res. Covetous: teleports to you in late Gehennom and on the planes. The final boss. |
...
| archeologist | white | 10 | 12 | 10 | 1 | weapon 1d6 ×2 | tunnels. |
| barbarian | white | 10 | 12 | 10 | 1 | weapon 1d6 ×2 |  |
| caveman | white | 10 | 12 | 10 | 0 | weapon 2d4 |  |
| healer | white | 10 | 12 | 10 | 1 | weapon 1d6 |  |
| knight | white | 10 | 12 | 10 | 1 | weapon 1d6 ×2 |  |
| monk | white | 10 | 12 | 10 | 2 | claw 1d8 · kick 1d8 |  |
| priest | white | 10 | 12 | 10 | 2 | weapon 1d6 · cast cleric | Temple defenders. Convert their altars or sacrifice on them. |
| ranger | white | 10 | 12 | 10 | 2 | weapon 1d4 |  |
| rogue | white | 10 | 12 | 10 | 1 | weapon 1d6 ×2 |  |
| samurai | white | 10 | 12 | 10 | 1 | weapon 1d8 ×2 |  |
| tourist | white | 10 | 12 | 10 | 1 | weapon 1d6 ×2 |  |
| valkyrie | white | 10 | 12 | 10 | 1 | weapon 1d8 ×2 |  |
| wizard | white | 10 | 12 | 10 | 3 | weapon 1d6 · cast spell |  |
| Lord Carnarvon | magenta | 20 | 15 | 0 | 90 | weapon 4d10 · cast 4d8 spell | tunnels, starts peaceful. Archeologist quest leader. |
| Pelias | magenta | 20 | 15 | 0 | 90 | weapon 4d10 ×2 | starts peaceful. Barbarian quest leader. |
| Shaman Karnov | magenta | 20 | 15 | 0 | 90 | weapon 4d10 · cast 2d8 cleric | starts peaceful. Cave Dweller quest leader. |
| Hippocrates | magenta | 20 | 15 | 0 | 90 | weapon 1d6 · cast 3d8 cleric ×2 | starts peaceful. Healer quest leader. |
| King Arthur | magenta | 20 | 15 | 0 | 90 | weapon 4d10 ×2 | starts peaceful. Knight quest leader. Holds Excalibur if you didn't get it. |
| Grand Master | black | 25 | 15 | 0 | 90 | claw 4d10 · kick 2d8 · cast 2d8 cleric ×2 | sees-invis, starts peaceful. Monk quest leader. |
| Arch Priest | white | 25 | 15 | 7 | 90 | weapon 4d10 · kick 2d8 · cast 2d8 cleric ×2 | sees-invis, starts peaceful. Priest quest leader. |
| Orion | magenta | 20 | 15 | 0 | 90 | weapon 4d10 · cast 4d8 spell | swims, amphibious, sees-invis, starts peaceful. Ranger quest leader. Bow user. |
...
| Lord Sato | magenta | 20 | 15 | 0 | 90 | weapon 4d10 ×2 | starts peaceful. Samurai quest leader. |
| Twoflower | white | 20 | 15 | 10 | 90 | weapon 4d10 | starts peaceful. Tourist quest leader. |
| Norn | magenta | 20 | 15 | 0 | 90 | weapon 4d10 ×2 | starts peaceful, cold-res. Valkyrie quest leader. |
| Neferet the Green | green | 20 | 15 | 0 | 90 | weapon 4d10 · cast 2d8 spell ×2 | starts peaceful. Wizard quest leader. |
| Thoth Amon | magenta | 16 | 12 | 0 | 10 | weapon 1d6 · cast spell ×2 · claw 1d4 steal-amulet | follows stairs. Barbarian quest nemesis. |
| Master Kaen | magenta | 25 | 12 | -10 | 10 | claw 16d2 ×2 · cast cleric · claw 1d4 steal-amulet | sees-invis, follows stairs. Monk quest nemesis. |
| Master Assassin | magenta | 15 | 12 | 0 | 30 | weapon 2d6 poison · weapon 2d8 · claw 2d6 steal-amulet | follows stairs. Rogue quest nemesis. |
| Ashikaga Takauji | magenta | 15 | 12 | 0 | 40 | weapon 2d6 ×2 · claw 2d6 steal-amulet | follows stairs. Samurai quest nemesis. |
| Dark One | black | 15 | 12 | 0 | 80 | weapon 1d6 ×2 · claw 1d4 steal-amulet · cast spell | follows stairs. Wizard quest nemesis. |
...
| page | white | 5 | 12 | 10 | 10 | weapon 1d6 ×2 | starts peaceful. |
| abbot | white | 5 | 12 | 10 | 20 | claw 8d2 · kick 3d2 stun · cast cleric | starts peaceful. |
| acolyte | white | 5 | 12 | 10 | 20 | weapon 1d6 · cast cleric | starts peaceful. |
| hunter | white | 5 | 12 | 10 | 10 | weapon 1d4 | sees-invis, starts peaceful. |
| thug | white | 5 | 12 | 10 | 10 | weapon 1d6 ×2 | starts peaceful. |
| ninja | white | 5 | 12 | 10 | 10 | weapon 1d8 ×2 |  |
| roshi | white | 5 | 12 | 10 | 10 | weapon 1d8 ×2 | starts peaceful. |
| guide | white | 5 | 12 | 10 | 20 | weapon 1d6 · cast spell | starts peaceful. |
| warrior | white | 5 | 12 | 10 | 10 | weapon 1d8 ×2 | starts peaceful. |
| apprentice | white | 5 | 12 | 10 | 30 | weapon 1d6 · cast spell | starts peaceful. |
...
- Bone devil, Orcus, and Geryon stings use AD_DRST to drain Strength; poison resistance protects against that drain.
...
- Poison resistance protects against these Strength-draining attacks.
-->

Major demons. Most can gate in reinforcements (a single barbed devil
in your face can become five). Silver weapons and Demonbane do extra
damage. Only Geryon, Dispater, Baalzebub, and Asmodeus accept bribes,
and none will bargain while you wield Excalibur or Demonbane.
...
| Name | Color | Lvl | Spd | AC | MR | Attacks | Notes |
|----------------|-------|-----|-----|----|-----| -------------------------------------------- |--------------------------------------------------------|
| water demon | blue | 8 | 12 | -4 | 30 | weapon 1d3 · claw 1d3 · bite 1d3 | swims, demonic. |
| [amorous demon](#seduction) | gray | 6 | 12 | 0 | 70 | seduction (see Seduction) | flies, demonic. Displays as succubus or incubus by the demon's own randomly-assigned gender. |
| horned devil | brown | 6 | 9 | -5 | 50 | weapon 1d4 · claw 1d4 · bite 2d3 · sting 1d3 | demonic. |
| erinys | red | 7 | 12 | 2 | 30 | weapon 2d4 Str-drain | fire-res, pois-res. Grows stronger as your alignment record falls, gaining harder blows, flight, regeneration, and a second attack. |
| barbed devil | red | 8 | 12 | 0 | 35 | claw 2d4 · claw 2d4 sticky · sting 3d4 | demonic. |
| marilith | red | 7 | 12 | -6 | 80 | weapon 2d4 ×2 · claw 2d4 ×4 | sees-invis, demonic. |
| vrock | green | 8 | 12 | 0 | 50 | claw 1d4 ×2 · claw 1d8 ×2 · bite 1d6 | demonic. |
| hezrou | green | 9 | 6 | -2 | 55 | claw 1d3 ×2 · bite 4d4 | demonic. |
| bone devil | gray | 9 | 15 | -1 | 40 | weapon 3d4 · sting 2d4 drain-Str | demonic. |
| ice devil | white | 11 | 6 | -4 | 55 | claw 1d4 ×2 · bite 2d4 · sting 3d4 cold · touch 1d1 slow | sees-invis, demonic. |
| nalfeshnee | red | 11 | 9 | -1 | 65 | claw 1d4 ×2 · bite 2d4 · cast spell | demonic. |
| pit fiend | red | 13 | 6 | -3 | 65 | weapon 4d2 ×2 · hug 2d4 | sees-invis, demonic. |
| sandestin | gray | 13 | 12 | 4 | 60 | weapon 2d6 ×2 | shapeshifter, ston-res. |
| balrog | red | 16 | 5 | -2 | 75 | weapon 8d4 · weapon 4d6 | flies, sees-invis, demonic. |
| Juiblex | bright-green | 50 | 3 | -7 | 65 | engulf 4d10 disease · spit 3d6 acid | flies, amphibious, amorphous, sees-invis, demonic, fire-res, pois-res, acid-res, ston-res. |
| Yeenoghu | magenta | 56 | 18 | -5 | 80 | weapon 3d6 · weapon 2d8 confuse · claw 1d6 paralyse · cast 2d6 magic | flies, sees-invis, demonic, fire-res, pois-res. |
| Orcus | magenta | 66 | 9 | -6 | 85 | weapon 3d6 · claw 3d4 ×2 · cast 8d6 spell · sting 2d4 drain-Str | flies, sees-invis, demonic, fire-res, pois-res. |
| Geryon | magenta | 72 | 3 | -3 | 75 | claw 3d6 ×2 · sting 2d4 drain-Str | flies, sees-invis, demonic, fire-res, pois-res. |
| Dispater | magenta | 78 | 15 | -2 | 80 | weapon 4d6 · cast 6d6 spell | flies, sees-invis, demonic, fire-res, pois-res. |
| Baalzebub | magenta | 89 | 9 | -5 | 85 | bite 2d6 drain-Str · gaze 2d6 stun | flies, sees-invis, demonic, fire-res, pois-res. |
| Asmodeus | magenta | 105 | 12 | -7 | 90 | claw 4d4 · cast 6d6 cold | flies, sees-invis, demonic, fire-res, cold-res, pois-res. |
| Demogorgon | magenta | 106 | 15 | -8 | 95 | cast 8d6 spell · sting 1d4 drain-XL · claw 1d6 disease ×2 | flies, sees-invis, demonic, fire-res, pois-res. |
| Death | bright-magenta | 30 | 12 | -5 | 100 | touch 8d8 death ×2 | flies, regenerates, sees-invis, teleport-control. Rider of the Apocalypse. Vanquish three to ascend. |
| Pestilence | bright-magenta | 30 | 12 | -5 | 100 | touch 8d8 pestilence ×2 | flies, regenerates, sees-invis, teleport-control. Rider; spreads disease. |
| Famine | bright-magenta | 30 | 12 | -5 | 100 | touch 8d8 famine ×2 | flies, regenerates, sees-invis, teleport-control. Rider; drains nutrition to starvation. |
| mail daemon | bright-blue | 56 | 24 | 10 | 127 | — | flies, swims, sees-invis, starts peaceful, fire-res, cold-res, sleep-res, shock-res, pois-res, ston-res. Appears only to deliver in-game mail, then leaves. |
| djinni | yellow | 7 | 12 | 4 | 30 | weapon 2d8 | flies, pois-res, ston-res. |
| Minion of Huhetotl | orange | 16 | 12 | -2 | 75 | weapon 8d4 · weapon 4d6 · cast spell · claw 2d6 steal-amulet | flies, sees-invis, demonic. |
| Nalzok | orange | 16 | 12 | -2 | 85 | weapon 8d4 · weapon 4d6 · cast spell · claw 2d6 steal-amulet | flies, sees-invis, demonic. |
...
Iron, stone, and clay golems are dangerous; wood and leather golems
are early-game fodder. A rare gold golem is a walking treasure pile.
...
| Name | Color | Lvl | Spd | AC | MR | Attacks | Notes |
|----------------|-------|-----|-----|----|-----| -------------------------------------------- |--------------------------------------------------------|
| straw golem | yellow | 3 | 12 | 10 | 0 | claw 1d2 ×2 | cold-res. |
| paper golem | white | 3 | 12 | 10 | 0 | claw 1d3 | cold-res. |
| rope golem | brown | 4 | 9 | 8 | 0 | claw 1d4 ×2 · hug 6d1 |  |
| gold golem | yellow | 5 | 9 | 6 | 0 | claw 2d3 ×2 | acid-res. |
| leather golem | brown | 6 | 6 | 6 | 0 | claw 1d6 ×2 |  |
| wood golem | brown | 7 | 3 | 4 | 0 | claw 3d4 | cold-res. |
| flesh golem | red | 9 | 8 | 9 | 30 | claw 2d8 ×2 | fire-res, cold-res, shock-res. |
| clay golem | brown | 11 | 7 | 7 | 40 | claw 3d10 |  |
| stone golem | gray | 14 | 6 | 5 | 50 | claw 3d8 | ston-res. |
| glass golem | cyan | 16 | 6 | 1 | 50 | claw 2d8 ×2 | acid-res. |
...
| piranha | red | 5 | 18 | 4 | 0 | bite 2d6 ×2 |  |
...
| kraken | red | 20 | 3 | 6 | 0 | claw 2d4 ×2 · hug 2d6 wrap · bite 5d4 |  |
...
Mostly harmless. **Lizard corpses cure petrification and never rot.**
Carry one for cockatrices. Medusa's gaze kills at once, so a lizard
corpse cannot save you from it.
...
Before the tables, four patterns are useful:

- **Corpse odds usually rise with the monster's level.** A floating
  eye always grants telepathy; acid and stoning resistance use more
  generous rolls than the standard resistance check. Those useful
  exceptions are called out below.
- **Intrinsic + extrinsic don't stack.** A property from two sources
  is no stronger than the same property from one.
...
- **Dragon scale mail covers more of these properties than any other
  item.** Each color maps to one base resistance; several
...
Magic resistance has the fewest sources, so most ascension kits reserve
an armor, weapon, or artifact slot for it.

::: dense-table

| Property | What it does | Intrinsic sources | Extrinsic sources |
|---|---|---|---|
| **Fire resistance** | Negates fire damage from traps, breath, and attacks (you can still drown in lava). | Monk XL 11; Priest XL 20; red dragon, fire ant, fire giant, hell hound, salamander, or red mold corpses; prayer rescue from lava. | Ring of fire resistance; red dragon scales / scale mail. |
| **Cold resistance** | Negates cold damage from breath and attacks. | Valkyrie XL 1; Monk XL 13; white dragon, frost giant, winter wolf, brown mold, or blue jelly corpses. | Ring of cold resistance; white dragon scales / scale mail. |
...
| **Disintegration resistance** | Makes black dragon breath harmless. | Black dragon corpse. | Black dragon scales / scale mail. |
| **Shock resistance** | Negates electrical damage, including lightning breath. | Monk XL 15; blue dragon or electric eel corpses. | Ring of shock resistance; blue dragon scales / scale mail; shield of shock resistance (new in 5.0). |
| **Poison resistance** | Protects against poison stings, poisonous corpses, poison breath, and Strength-draining poison attacks. | Barbarian XL 1, Healer XL 1, Orc XL 1, Tourist XL 20, Monk XL 3; killer bee and scorpion corpses use unusually favorable odds; green dragon, naga, quasit, and other poisonous corpses. | Ring of poison resistance; amulet versus poison; alchemy smock (cloak); green dragon scales / scale mail. |
| **Acid resistance** | Negates acid damage. Corpse-granted resistance is timed and resets on a level change. | Acid blob, brown pudding, yellow dragon corpses (unusually favorable odds; timed). | Yellow dragon scales / scale mail (permanent while worn). |
| **Stoning resistance** | Immunity to petrification. Corpse-granted resistance is timed; yellow dragon armor lasts while worn. | Acid blob and lizard corpses (favorable odds; timed). | Yellow dragon scales / scale mail. |
| **Drain resistance** | Blocks level drain from wraiths, vampires, and drain-life weapons such as [Stormbringer](#stormbringer). | None from corpses; vampire / lich polyforms confer it. | Black dragon scales / scale mail; shield of drain resistance (new in 5.0); wielding [Excalibur](#excalibur-artifact), Stormbringer, or [Staff of Aesculapius](#staff-of-aesculapius). |
| **Sickness resistance** | Blocks deadly disease, food poisoning. | None from corpses. | Green dragon scales / scale mail. |
| **Magic resistance** | Blocks death rays, magic missile, polymorph beams, and the touch-of-death spell. Magic traps do not check it. *Not* the same as [MC](#magic-cancellation). | No role grants it intrinsically; some polyforms have it. | Cloak of magic resistance; gray dragon scales / scale mail; wielding [Magicbane](#magicbane). |
| **Hallucination resistance** | Blocks hallucination from black lights and hallucinogenic potions. | Polyform-only, from a form with a hallucination attack such as a black light. | Gold dragon scales / scale mail; wielding [Grayswandir](#grayswandir). |
| **Blindness resistance** | Blocks light-flash blindness from yellow lights. | Polyform-only, from a form whose attack blinds. | Wielding [Sunsword](#sunsword). |

:::

#### Senses and perception

Telepathy and warning show you monsters before they reach you.

::: dense-table

| Property | What it does | Intrinsic sources | Extrinsic sources |
|---|---|---|---|
| **Telepathy** (ESP) | Senses minded monsters anywhere on the level when you are blind (and within a limited radius while sighted). | Floating eye (always grants), mind flayer, master mind flayer corpses. | Amulet of ESP; helm of telepathy; [Eye of the Aethiopica](#eye-of-the-aethiopica) (carried); [Orb of Detection](#orb-of-detection) (carried); [Platinum Yendorian Express Card](#platinum-yendorian-express-card) (carried); [Longbow of Diana](#longbow-of-diana) (carried); [Magicbane](#magicbane) (wielded). |
...
| **Warning** | Marks any hostile monster of level 4 or higher within about ten squares; the digit is its level divided by four. | Cave Dweller XL 15; Healer XL 15; Monk XL 7; Priest XL 15; Wizard XL 15; prayer rescue. | Ring of warning; helm of caution; [Master Key of Thievery](#master-key-of-thievery), [Orb of Fate](#orb-of-fate), [Orcrist](#bane-weapons), [Sting](#bane-weapons), [Grimtooth](#bane-weapons) (all carried). |
...
| **Searching** | Performs an automatic search roughly once every 85 turns, revealing nearby hidden doors, passages, and traps. | Archeologist XL 1; Monk XL 9; Ranger XL 1; Rogue XL 10; Tourist XL 10. | Ring of searching; carrying [Excalibur](#excalibur-artifact). |
...
| Property | What it does | Intrinsic sources | Extrinsic sources |
|---|---|---|---|
| **[Fast](#speed)** (intrinsic speed) | Each movement allocation has a ~1/3 chance of a +12 bonus. Raises effective speed from 12 to about 16. | Monk XL 1; Samurai XL 1; Valkyrie XL 7; Archeologist XL 10; Barbarian XL 7; Cave Dweller XL 7; Knight XL 7. Prayer rescue. | Speed boots (grant **Very Fast**, ~2/3 chance, effective ~20); blue dragon scales / scale mail (Very Fast). |
...
| Property | What it does | Intrinsic sources | Extrinsic sources |
|---|---|---|---|
| **Protection** | Adds to your AC (lower is better). Also adds +1 [MC](#magic-cancellation) per worn extrinsic source (+2 for amulet of guarding). | A qualifying large donation to any peaceful priest; the required amount is randomized. | Ring of protection; cloak of protection (also MC3); amulet of guarding (also MC2); carrying [Sceptre of Might](#sceptre-of-might), [Mitre of Holiness](#mitre-of-holiness), or [Tsurugi of Muramasa](#tsurugi-of-muramasa). |
| **Reflection** | Bounces ranged magic (rays, breath) back at the attacker. | None as intrinsic. | Amulet of reflection; silver dragon scales / scale mail; shield of reflection; wielding [Dragonbane](#bane-weapons) or [Longbow of Diana](#longbow-of-diana). |
| **Regeneration** | Heals 1 HP every turn, in addition to natural healing. | Troll and other regenerating polyforms. | Ring of regeneration; wielding [Trollsbane](#bane-weapons) or [Staff of Aesculapius](#staff-of-aesculapius). |
| **Energy regeneration** | Spell points regenerate faster. | None as intrinsic. | Carrying [Eye of the Aethiopica](#eye-of-the-aethiopica). |
| **Half spell damage** | Halves damage from monster-cast spells. | None as intrinsic. | Carrying [Orb of Detection](#orb-of-detection), [Master Key of Thievery](#master-key-of-thievery), [Platinum Yendorian Express Card](#platinum-yendorian-express-card), or [Orb of Fate](#orb-of-fate). |
...
| **Free action** | Blocks paralysis from floating eyes, gelatinous cubes, ghouls, and monster-cast paralysis. It does not stop slowing. | Certain polyforms. | Ring of free action; orange dragon scales / scale mail. |
| **Stealth** | Monsters don't wake when you walk near sleeping ones; you can sneak past. | Archeologist XL 5; Barbarian XL 15; Monk XL 5; Ranger XL 7; Rogue XL 1; Samurai XL 15; Valkyrie XL 3; prayer rescue. | Ring of stealth; elven boots; elven cloak; carrying [Heart of Ahriman](#heart-of-ahriman). |
| **Invisibility** | Monsters without see invisible guess your square, so their attacks are less reliable; attacking reveals your position. | Stalker polyform; potion of invisibility (timed). | Ring of invisibility; cloak of invisibility; carrying Orb of Detection. |
...
These properties change hunger, polymorph, survival, and crowd control.

::: dense-table

| Property | What it does | Intrinsic sources | Extrinsic sources |
|---|---|---|---|
| **Slow digestion** | Stops ordinary hunger entirely; unusual direct nutrition drains can still starve you. | None. | Ring of slow digestion; white dragon scales / scale mail. |
| **Polymorph control** | When you polymorph (from a trap, ring, potion, wand, or spell), you choose the form. | None. | Ring of polymorph control. |
...
| **Sustain ability** | Your six stats (Str, Dex, Con, Int, Wis, Cha) do not change through exercise, abuse, potions, or attribute-draining attacks such as poison. | None. | Ring of sustain ability. |
| **Protection from shape changers** | Nearby shape-changers (chameleon, doppelganger, amorous demon) cannot polymorph. | None. | Ring of protection from shape changers. |
| **Conflict** | Nearby monsters attack one another. A shopkeeper caught in it attacks you. | None. | Ring of conflict; carrying [Sceptre of Might](#sceptre-of-might). |
| **Life saving** | When you would die, the amulet is destroyed and restores `50 + 10 × (Con ÷ 2)` HP, capped at your maximum. | None. | Amulet of life saving. |
| **Adornment** | Adds the ring's enchantment to Charisma. Most useful for shopping and seduction. | None. | Ring of adornment. |

:::

A few properties are essentially **polyform-only**: *swimming* and
*passes walls* (xorn, earth elemental, ghost). *Detect monsters* is
otherwise available only as a one-shot pulse from a wand or scroll.
...
- touch of death still has a binary success gate: without Antimagic, rn2(m_lev) > 12 applies the effect; Antimagic produces "Lucky for you, it didn't work!" (mcastu.c:391-407)
- the 5.0 change is the unprotected result: 50+8d6 damage plus half that amount drained from max HP instead of the old instadeath (mcastu.c:315-347; fixes5-0-0.txt:538)
...
NetHack 5.0.0 was released on May 2, 2026. If you remember 3.6.x,
start with the first group below: these are the changes most likely
to punish an old reflex.

#### Habits to Relearn {#new-dangers}

- **Unicorn horns no longer restore drained attributes.** Carry a
  potion of restore ability for that job.
- **A self-zapped wand of speed monster no longer grants permanent
  speed.** Potions of speed do.
- **Diluted alchemy products convert only two potions per dip.** A
  fresh stack may still convert as a batch. The ordinary blast chance
  is 10%; an alchemy smock lowers it to about 1 in 30.
- **Gehennom's hot ground usually shatters a potion you drop.** It also
  blocks within-level teleportation while a demon lord or prince is
  alive on the level.
- **Monsters loot unlocked containers and can animate suitable corpse
  piles.** Lock a stash before leaving it.
- **Cursed wands can explode during an engrave-test.** Identify BUC
  before testing a valuable-looking wand when you can.
- **Weak sacrifices no longer grind Luck.** If your Luck is already
  above the corpse's difficulty, the sacrifice adds none; a luckstone
  handles maintenance.
- **Valkyries start with a spear, not a long sword.** Knights still
  have a 1-in-6 Excalibur dip at XL 5 or higher; every other Lawful
  role gets 1 in 30.
- **The touch-of-death spell no longer uses the old instant-death
  result.** Without magic resistance it deals 50+8d6 damage and drains
  half that amount from maximum HP; magic
  resistance still blocks it completely.

#### New Tools and Opportunities

- **Dragon armor carries more secondary effects.** Black adds drain
  resistance, green adds sickness resistance, blue adds speed, orange
  adds free action, white adds slow digestion, red adds infravision,
  and gold adds hallucination resistance and radius-3 light.
- **The helm of caution** grants warning. The **amulet of flying**
  grants flight to you and your steed, and the **amulet of guarding**
  supplies +2 AC and +2 MC.
- **Several artifacts gained active uses.** Snickersnee adds one free
  polearm-style reach attack each turn. Sunsword spends 25 Pw to blind
  a target. Trollsbane regenerates while wielded. Demonbane is now the
  Priest's guaranteed first gift and takes the form of a silver mace.
- **There are new wish sources.** Vlad's throne eventually grants one,
  the Amulet grants one when first picked up, and Orcus Town guarantees
  either a magic lamp or a magic marker.
- **A blessed potion of polymorph grants control for that one change.**
  A polymorphed vampire can use `#monster` to cycle among vampire, bat,
  and fog-cloud forms.
- **Loadstones prevent knockback while you are grounded, even when
  cursed.** The burden is still severe, but the property now has a use.
- **Supply chests** appear on levels above the Oracle about two times
  in three, holding early healing, enchantment, and other supplies.
- **Pets can gain corpse resistances.** A dead pet can also be revived
  by praying at a co-aligned altar while standing on its corpse.
- **Sink-dipping a potion identifies it by message.** The potion is
  consumed, but no identify scroll is needed.
- **Chain lightning** is a new level-2 attack spell that jumps through
  nearby monsters. New **themed rooms** populate ordinary levels, and
  four new species appear: displacer beast, genetic engineer, gold
  dragon, and baby gold dragon.

#### Other Changes Worth Knowing

- *Charm monster* is now level 5, *sleep* level 3, and *confuse
  monster* level 1. Apply a spellbook to check how worn it is.
- Mind-flayer tentacles no longer erase the map or identifications.
  They still drain Intelligence and can erase memorized spells and
  weapon-skill experience.
- A bag-of-holding explosion scatters its contents instead of deleting
  everything; about one item in thirteen is still lost.
- Priest donation prices are randomized. For protection, offer at
  least twice but less than three times the amount named. More earns
  only thanks, while conspicuous underpayment can raise that priest's
  future prices.
- Special levels can be mirrored, so a memorized map may appear
  flipped. New conducts track pauper, petless, permadeaf, Sokoban,
  bonesless, and unrerolled games.
- Two-handed weapons receive 150% of the Strength damage bonus. Natural
  HP regeneration now rolls `(XL + Constitution)%` each turn, while
  the regeneration property heals 1 HP every turn in addition.
- Covetous monsters may flee to either staircase. The Castle no longer
  places master or arch-liches at level creation.
- Crystal plate mail cracks in stages and can be made crackproof.
  Candle radius now grows by a square-root rule rather than linearly.
- Intrinsic-granting corpses, tins, and eggs cost more in shops.
  Monsters no longer produce unrelated food as random death drops.
- Shopkeepers remove nearby pits and webs, and walking into a peaceful
  shopkeeper automatically settles debt before the inventory prompt.
...
5.0: \hyperref[what-changed-since-last-time]{new features, items, and mechanics, p.~\pageref*{what-changed-since-last-time}}; \hyperref[new-dangers]{habits to relearn, p.~\pageref*{new-dangers}}\par
...
Alchemy: \hyperref[alchemy]{dip recipes, chain, healing → extra → full → gain ability, 10\% blast chance, about 1 in 30 in a smock, p.~\pageref*{alchemy}}; \hyperref[cloaks]{smock, poison resistance, p.~\pageref*{cloaks}}\par
...
Altars: \hyperref[altars-_]{BUC testing, dropping the whole pile, p.~\pageref*{altars-_}}; \hyperref[altars-and-alignment]{conversion and the inversion trap, p.~\pageref*{altars-and-alignment}}\par
...
\hyperref[containers]{Bag of holding, ascension carry, p.~\pageref*{containers}}\par
...
\hyperref[the-demon-prince-lairs]{Bribe demand, eligible princes and Lawful discount, p.~\pageref*{the-demon-prince-lairs}}\par
...
Damerell: \hyperref[acknowledgements]{Object Identification FAQ, p.~\pageref*{acknowledgements}}\par
...
\hyperref[shopkeeper-behavior]{Shop bill, inspect with `I` then `u`, p.~\pageref*{shopkeeper-behavior}}\par
...
Early game: \hyperref[the-early-shopping-list]{shopping list, p.~\pageref*{the-early-shopping-list}}; \hyperref[things-that-will-kill-you]{the deadliest stretch, p.~\pageref*{things-that-will-kill-you}}\par
\hyperref[elementals-e]{Earth elemental, phases through walls, p.~\pageref*{elementals-e}}\par
\hyperref[deadly-mistakes]{Eating mistakes, old and poisonous corpses, p.~\pageref*{deadly-mistakes}}\par
...
\hyperref[sea-monsters]{Electric eel, six in one Medusa layout, p.~\pageref*{sea-monsters}}\par
...
Fake: \hyperref[the-gnomish-mines]{luckstone mimic, BUC-test first, p.~\pageref*{the-gnomish-mines}}; \hyperref[the-ascension-run]{amulet, from bones or wish, p.~\pageref*{the-ascension-run}}\par
...
Feelings: \hyperref[feelings-and-sounds]{feverish, lycanthropy infection, deathly sick, Pestilence or rot, p.~\pageref*{feelings-and-sounds}}\par
...
First descent: \hyperref[your-first-descent]{welcome to the dungeon, p.~\pageref*{your-first-descent}}; \hyperref[fighting-smart]{a missed swing wakes the room, p.~\pageref*{fighting-smart}}\par
\hyperref[alignment]{First-game recommendation, p.~\pageref*{alignment}}\par
\hyperref[gray-stones-four-stones-one-lucky]{Flint, sling ammunition, p.~\pageref*{gray-stones-four-stones-one-lucky}}\par
...
\hyperref[seduction]{Amorous demon, can strip cursed armor, p.~\pageref*{seduction}}\par
...
Gnomish: \hyperref[gnomes-g]{wizard, psi bolt and self-buffs, p.~\pageref*{gnomes-g}}; \hyperref[the-gnomish-mines]{Mines, entry around Dlvl 2-4, p.~\pageref*{the-gnomish-mines}}; \hyperref[common-combat-deaths]{Mines, a choice not a routine stop, p.~\pageref*{common-combat-deaths}}\par
...
\hyperref[wishable-random-artifacts]{Grayswandir (Lawful silver saber), double physical damage dealt, p.~\pageref*{wishable-random-artifacts}}\par
...
\hyperref[delayed-deaths]{Green slime, ten-turn countdown and cures, p.~\pageref*{delayed-deaths}}\par
...
\hyperref[key-spells]{Haste self, alternative to speed boots, p.~\pageref*{key-spells}}\par
...
\hyperref[molochs-sanctum]{High Priest of Moloch, carries the Amulet near the high altar, p.~\pageref*{molochs-sanctum}}\par
\hyperref[movement-traps]{Hole, like a trapdoor with manners, p.~\pageref*{movement-traps}}\par
Holy water: \hyperref[blessed-uncursed-cursed-buc]{blesses items, p.~\pageref*{blessed-uncursed-cursed-buc}}; \hyperref[potion-holy-water]{making at an altar, multiplying by dipping, p.~\pageref*{potion-holy-water}}\par
...
Iron: \hyperref[golems]{golem, poison breath, p.~\pageref*{golems}}; \hyperref[iron-bars]{bars, light passes through, bars, dig around them, bars, potion of acid dissolves, p.~\pageref*{iron-bars}}; \hyperref[boots]{shoes, traps protection, p.~\pageref*{boots}}\par
...
\hyperref[kobolds-k]{Kobold corpse, poisonous, p.~\pageref*{kobolds-k}}\par
\hyperref[keystone-kops-k]{Kops, summoned by shoplifting, p.~\pageref*{keystone-kops-k}}\par
Kraken: \hyperref[sea-monsters]{Medusa's pool variant, p.~\pageref*{sea-monsters}}; \hyperref[medusas-island]{present in one of the four layouts, p.~\pageref*{medusas-island}}\par
...
Large mimic: \hyperref[a-note-on-mimics]{sticky claw, p.~\pageref*{a-note-on-mimics}}\par
Large containers: \hyperref[containers]{box, chest, ice box, p.~\pageref*{containers}}\par
...
\hyperref[mummies-m]{`M` mummies, undead turning deals 1d8 and makes them flee, p.~\pageref*{mummies-m}}\par
...
\hyperref[the-gnomish-mines]{Mind flayer, surprise in the Mines, p.~\pageref*{the-gnomish-mines}}\par
Minetown: \hyperref[the-gnomish-mines]{shops and temple, watch, don't attack peacefuls, p.~\pageref*{the-gnomish-mines}}\par
\hyperref[giant-humanoids-h]{Minotaur, 42 average damage per full attack, p.~\pageref*{giant-humanoids-h}}\par
\hyperref[quest-artifacts]{Mitre of Holiness (Priest), p.~\pageref*{quest-artifacts}}\par
\hyperref[wishable-random-artifacts]{Mjollnir, Valkyrie throw-and-return war hammer, p.~\pageref*{wishable-random-artifacts}}\par
...
No-genocide conduct: \hyperref[no-genocide]{type ``none'', p.~\pageref*{no-genocide}}\par
No-wishing-artifacts conduct: \hyperref[wishing-restrictions]{restrictions, p.~\pageref*{wishing-restrictions}}\par
...
Plane: \hyperref[the-elemental-planes]{portals, confused gold detection, of Earth, dig the portal, of Air, cloud bubbles drift, of Air, conflict tactic, p.~\pageref*{the-elemental-planes}}; \hyperref[plane-of-fire]{of Fire, fire resistance non-optional, p.~\pageref*{plane-of-fire}}; \hyperref[plane-of-water]{of Water, moving bubbles and magical breathing, p.~\pageref*{plane-of-water}}\par
...
Prayer: \hyperref[the-golden-rules-of-early-survival]{emergency button cooldown, p.~\pageref*{the-golden-rules-of-early-survival}}; \hyperref[prayer]{when to, what it fixes, cooldown averaging about 450 turns, p.~\pageref*{prayer}}\par
...
Skill: \hyperref[the-skill-ladder]{slots, XL + 1, plus one if crowned, p.~\pageref*{the-skill-ladder}}; \hyperref[what-a-rank-buys-you]{rank effects, to-hit/damage, p.~\pageref*{what-a-rank-buys-you}}\par
...
\hyperref[tool-stethoscope]{Stethoscope, HP check and crowning meter, p.~\pageref*{tool-stethoscope}}\par
...
Price identification: \hyperref[the-price-is-right]{shopkeepers identify by price, p.~\pageref*{the-price-is-right}}\par
Throne: \hyperref[room-types]{room, sit at your own risk, p.~\pageref*{room-types}}; \hyperref[thrones]{wish possible at non-negative Luck, kicking for gold and gems, p.~\pageref*{thrones}}; \hyperref[the-castle]{room in the Castle court, p.~\pageref*{the-castle}}\par
...
Unicorn horn: \hyperref[neutralizing-ailments]{ailment cures, dip table, no longer a cure-all, p.~\pageref*{neutralizing-ailments}}; \hyperref[other-notable-tools]{status-cure all, blessed seven ailments, p.~\pageref*{other-notable-tools}}\par
...
Vlad's: \hyperref[vlads-tower]{Tower, branches upward; throne, about one wish chance in ten per sit, once, p.~\pageref*{vlads-tower}}\par
...
Wand of digging: \hyperref[engulfment]{escape from inside, p.~\pageref*{engulfment}}; \hyperref[wand-digging]{digging beam and ascension use, p.~\pageref*{wand-digging}}\par
...
Wish: \hyperref[sources-of-wishes]{seven kinds of source, p.~\pageref*{sources-of-wishes}}; \hyperref[wish-syntax]{syntax, blessed greased fixed +2, silent substitutions such as a fake amulet, p.~\pageref*{wish-syntax}}; \hyperref[wishing-restrictions]{for ``nothing'', the escape hatch, p.~\pageref*{wishing-restrictions}}\par
\hyperref[what-to-wish-for]{Wishes, optimal use of, p.~\pageref*{what-to-wish-for}}\par
\hyperref[quest-artifacts]{Quest artifacts, cannot be wished for; carry bonuses, p.~\pageref*{quest-artifacts}}\par
...
Waijers** mapped all eight [Sokoban](#sokoban) variants. **Steven Bush**
...
shopkeeper who bears his name in [the Mines](#the-gnomish-mines) is a small measure of
