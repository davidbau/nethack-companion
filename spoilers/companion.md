...
5.0: \hyperref[what-changed-since-last-time]{themed rooms became a regular feature, p.~\pageref*{what-changed-since-last-time}}; \hyperref[what-changed-since-last-time]{four new monster species, p.~\pageref*{what-changed-since-last-time}}; \hyperref[what-changed-since-last-time]{helm of caution, p.~\pageref*{what-changed-since-last-time}}; \hyperref[what-changed-since-last-time]{chain lightning, p.~\pageref*{what-changed-since-last-time}}; \hyperref[what-changed-since-last-time]{dragon scale mail two extrinsics, p.~\pageref*{what-changed-since-last-time}}; \hyperref[what-changed-since-last-time]{unicorn horn no longer restores stats, p.~\pageref*{what-changed-since-last-time}}; \hyperref[what-changed-since-last-time]{supply chests, p.~\pageref*{what-changed-since-last-time}}; \hyperref[what-changed-since-last-time]{monsters loot containers, p.~\pageref*{what-changed-since-last-time}}; \hyperref[what-changed-since-last-time]{pet revival at altar, p.~\pageref*{what-changed-since-last-time}}; \hyperref[what-changed-since-last-time]{sink dipping for potions, p.~\pageref*{what-changed-since-last-time}}; \hyperref[what-changed-since-last-time]{two-handed weapons +50\% Str damage, p.~\pageref*{what-changed-since-last-time}}; \hyperref[what-changed-since-last-time]{touch of death reworked (not instakill), p.~\pageref*{what-changed-since-last-time}}; \hyperref[what-changed-since-last-time]{gold dragon (new species, light source mail), p.~\pageref*{what-changed-since-last-time}}; \hyperref[new-dangers]{new dangers (sacrifice ceiling, hot ground), p.~\pageref*{new-dangers}}; \hyperref[new-hacks]{new hacks (blessed polymorph potion, vampire forms), p.~\pageref*{new-hacks}}\par
...
\hyperref[ac-and-defense]{AC, special attacks ignore, p.~\pageref*{ac-and-defense}}\par
\hyperref[ac-and-defense]{AC, the AC ladder to -20, p.~\pageref*{ac-and-defense}}\par
\hyperref[vegetarian-safe-corpses]{Acid blob corpse, stoning resistance (timed), p.~\pageref*{vegetarian-safe-corpses}}\par
\hyperref[petrification-stoning]{Acid blob corpse, timed stoning resistance, p.~\pageref*{petrification-stoning}}\par
\hyperref[blobs-b]{Acid blob, melee with bare hands (don't), p.~\pageref*{blobs-b}}\par
...
\hyperref[advanced-controls]{Advanced controls, faster play, p.~\pageref*{advanced-controls}}\par
\hyperref[elementals-e]{Air elemental, engulfs and suffocates, p.~\pageref*{elementals-e}}\par
\hyperref[vortices-v]{Air, fire, ice, steam, energy, dust vortex, p.~\pageref*{vortices-v}}\par
Alchemy: \hyperref[alchemy]{dip recipes, p.~\pageref*{alchemy}}; \hyperref[alchemy]{chain, healing → extra → full → gain ability, p.~\pageref*{alchemy}}; \hyperref[alchemy]{smock, blast chance \textasciitilde{}1 in 30, p.~\pageref*{alchemy}}; \hyperref[cloaks]{smock, poison resistance, p.~\pageref*{cloaks}}\par
\hyperref[angelic-beings-a]{Aleax, fights cheap-aligned heroes, p.~\pageref*{angelic-beings-a}}\par
\hyperref[alignment-and-blasting]{Alignment and blasting, misaligned artifact damage, p.~\pageref*{alignment-and-blasting}}\par
\hyperref[alignment]{Alignment, it's a number, p.~\pageref*{alignment}}\par
Altar: \hyperref[altars-_]{BUC test at, p.~\pageref*{altars-_}}; \hyperref[altars-_]{amber/black flash, p.~\pageref*{altars-_}}; \hyperref[altars-_]{dropping the whole pile, p.~\pageref*{altars-_}}; \hyperref[altars-_]{converting a cross-aligned, p.~\pageref*{altars-_}}; \hyperref[altars-and-alignment]{conversion, the inversion trap, p.~\pageref*{altars-and-alignment}}\par
\hyperref[altars-and-alignment]{Altars, converting cross-aligned, p.~\pageref*{altars-and-alignment}}\par
\hyperref[altars-_]{Altars, single most useful furniture, p.~\pageref*{altars-_}}\par
\hyperref[resolving-ambiguous-engrave-results]{Ambiguous engrave results, resolving, p.~\pageref*{resolving-ambiguous-engrave-results}}\par
\hyperref[seduction]{Amorous demon, expensive evening with, p.~\pageref*{seduction}}\par
Amulet: \hyperref[choking]{of strangulation, timer death, p.~\pageref*{choking}}; \hyperref[delayed-deaths]{of unchanging, blocks slime, p.~\pageref*{delayed-deaths}}; \hyperref[amulet-prices]{prices, all \$150, p.~\pageref*{amulet-prices}}; \hyperref[amulets]{of life saving, when to wear, p.~\pageref*{amulets}}; \hyperref[amulets]{of life saving, revives once, p.~\pageref*{amulets}}; \hyperref[amulets]{of reflection, ray bouncing, p.~\pageref*{amulets}}; \hyperref[amulets]{of magical breathing, underwater, p.~\pageref*{amulets}}; \hyperref[amulets]{of ESP (telepathy), p.~\pageref*{amulets}}; \hyperref[amulets]{of unchanging, blocks polymorph, p.~\pageref*{amulets}}; \hyperref[amulets]{of flying, mount flies too (new in 5.0), p.~\pageref*{amulets}}; \hyperref[amulets]{of guarding, +2 AC +2 MC (new in 5.0), p.~\pageref*{amulets}}; \hyperref[amulets]{of strangulation, 90\% cursed, p.~\pageref*{amulets}}; \hyperref[amulets]{of restful sleep, the rebrand, p.~\pageref*{amulets}}; \hyperref[the-gauntlet]{blocks teleportation, climb by foot, p.~\pageref*{the-gauntlet}}\par
Amulet of Yendor: \hyperref[molochs-sanctum]{the prize, p.~\pageref*{molochs-sanctum}}; \hyperref[the-ascension-run]{retrieving, p.~\pageref*{the-ascension-run}}; \hyperref[the-ascension-run]{pickup wish, on next turn, p.~\pageref*{the-ascension-run}}; \hyperref[the-elemental-planes]{the compass, p.~\pageref*{the-elemental-planes}}\par
...
\hyperref[the-roles]{Archeologist, touchstone advantage, p.~\pageref*{the-roles}}\par
\hyperref[what-pets-do-for-you]{Archon, the consensus ultimate pet, p.~\pageref*{what-pets-do-for-you}}\par
\hyperref[angelic-beings-a]{Archon, ultimate pet, p.~\pageref*{angelic-beings-a}}\par
Armor: \hyperref[the-early-shopping-list]{improvements, even basic, p.~\pageref*{the-early-shopping-list}}; \hyperref[use-testing-the-careful-way]{randomized appearances, p.~\pageref*{use-testing-the-careful-way}}; \hyperref[use-testing-the-careful-way]{pools, helms cloaks gloves boots, p.~\pageref*{use-testing-the-careful-way}}; \hyperref[armor-prices]{prices, the danger zones, p.~\pageref*{armor-prices}}; \hyperref[armor-and-ac]{and AC, the slot list, p.~\pageref*{armor-and-ac}}; \hyperref[armor-tables]{tables (full appendix), p.~\pageref*{armor-tables}}\par
\hyperref[the-armory]{Armory, weapons and armor strategy, p.~\pageref*{the-armory}}\par
\hyperref[nuisance-traps]{Arrow trap, free ammunition farm, p.~\pageref*{nuisance-traps}}\par
\hyperref[artifacts]{Artifacts, scattered legends, p.~\pageref*{artifacts}}\par
\hyperref[artifacts]{Artifacts, sources (sacrifice, quest, wish, fountain, random), p.~\pageref*{artifacts}}\par
Ascension: \hyperref[the-ascension-kit]{kit, the canonical loadout, p.~\pageref*{the-ascension-kit}}; \hyperref[the-ascension-run]{how to not die during, p.~\pageref*{the-ascension-run}}; \hyperref[what-killed-the-runners-up]{three things winners do that runners-up don't, p.~\pageref*{what-killed-the-runners-up}}; \hyperref[the-ascension-run]{Run, the gauntlet, p.~\pageref*{the-ascension-run}}; \hyperref[strategy]{Run strategy, run don't fight, p.~\pageref*{strategy}}\par
\hyperref[the-demon-prince-lairs]{Asmodeus, bribable cold caster, p.~\pageref*{the-demon-prince-lairs}}\par
\hyperref[the-astral-plane]{Astral Plane, three altars, p.~\pageref*{the-astral-plane}}\par
\hyperref[the-astral-plane]{Astral, choose wrong altar = game ends, p.~\pageref*{the-astral-plane}}\par
\hyperref[the-astral-plane]{Astral, farlook reveals altar only when adjacent, p.~\pageref*{the-astral-plane}}\par
\hyperref[engravings]{Athame, the non-dulling stylus, p.~\pageref*{engravings}}\par
\hyperref[atheist]{Atheist conduct, p.~\pageref*{atheist}}\par
\hyperref[atheist]{Atheist, ascension Amulet offering is exempt, p.~\pageref*{atheist}}\par
...
\hyperref[blessed-uncursed-cursed-buc]{Auto-curse items, read as uncursed (trap), p.~\pageref*{blessed-uncursed-cursed-buc}}\par
\hyperref[the-ring-table]{Auto-curse rings (teleport, polymorph, aggravate, hunger), p.~\pageref*{the-ring-table}}\par
...
\hyperref[containers]{Bag of holding, never insert wand of cancellation, p.~\pageref*{containers}}\par
\hyperref[containers]{Bag of holding, the turning point, p.~\pageref*{containers}}\par
...
\hyperref[the-roles]{Barbarian, just hit things harder, p.~\pageref*{the-roles}}\par
\hyperref[the-roles]{Barbarian, poison resistance gift, p.~\pageref*{the-roles}}\par
...
\hyperref[other-notable-tools]{Bell of Opening, Invocation item, p.~\pageref*{other-notable-tools}}\par
...
\hyperref[body-armor-suits]{Body armor (suits) table, p.~\pageref*{body-armor-suits}}\par
...
\hyperref[things-that-will-kill-you]{Bones level, 80\% cursed items, p.~\pageref*{things-that-will-kill-you}}\par
\hyperref[things-that-will-kill-you]{Bones level, monsters above depth, p.~\pageref*{things-that-will-kill-you}}\par
\hyperref[shopkeeper-behavior]{Bones-shop gotcha, items still belong, p.~\pageref*{shopkeeper-behavior}}\par
\hyperref[bonesless-new-in-5.0]{Bonesless conduct, must disable bones (new in 5.0), p.~\pageref*{bonesless-new-in-5.0}}\par
\hyperref[the-wizards-tower]{Book of the Dead, at the Tower bottom, p.~\pageref*{the-wizards-tower}}\par
\hyperref[boots]{Boots, p.~\pageref*{boots}}\par
\hyperref[brainlessness]{Brainlessness, mind flayer drain, p.~\pageref*{brainlessness}}\par
\hyperref[branches-and-landmarks]{Branch order, Sokoban or Mines first, p.~\pageref*{branches-and-landmarks}}\par
\hyperref[the-map-symbols]{Branch staircases, turn yellow, p.~\pageref*{the-map-symbols}}\par
...
BUC: \hyperref[blessed-uncursed-cursed-buc]{(Blessed Uncursed Cursed), p.~\pageref*{blessed-uncursed-cursed-buc}}; \hyperref[blessed-uncursed-cursed-buc]{avoiding curses by checking, p.~\pageref*{blessed-uncursed-cursed-buc}}; \hyperref[blessed-uncursed-cursed-buc]{the altar amber/black flash, p.~\pageref*{blessed-uncursed-cursed-buc}}; \hyperref[blessed-uncursed-cursed-buc]{pet step-around, p.~\pageref*{blessed-uncursed-cursed-buc}}\par
\hyperref[feelings-and-sounds]{Bugle reveille, soldier woke neighbors, p.~\pageref*{feelings-and-sounds}}\par
\hyperref[the-early-shopping-list]{Burdened status, two hits per yours, p.~\pageref*{the-early-shopping-list}}\par
\hyperref[carrying-capacity]{Burdened, Stressed, Strained, Overtaxed, Overloaded, p.~\pageref*{carrying-capacity}}\par
...
\hyperref[vlads-tower]{Candelabrum of Invocation, at top of Vlad's Tower, p.~\pageref*{vlads-tower}}\par
\hyperref[light-sources]{Candelabrum of Invocation, requires seven candles, p.~\pageref*{light-sources}}\par
...
Castle: \hyperref[castle-overview]{overview, the gateway to Gehennom, p.~\pageref*{castle-overview}}; \hyperref[the-castle]{storming the, p.~\pageref*{the-castle}}; \hyperref[the-castle]{wand chest, sitting on cursed scroll of scare monster, p.~\pageref*{the-castle}}; \hyperref[the-castle]{central hallway of five trap doors, p.~\pageref*{the-castle}}; \hyperref[the-castle]{two wishes reliably (1 charge + 1 recharge), p.~\pageref*{the-castle}}\par
...
\hyperref[scroll-charging]{Charging a wand of wishing, exactly once, p.~\pageref*{scroll-charging}}\par
\hyperref[scroll-charging]{Charging, explosion chance (n³/7³), p.~\pageref*{scroll-charging}}\par
...
Cloak: \hyperref[armor-and-ac]{of displacement, the underrated layer, p.~\pageref*{armor-and-ac}}; \hyperref[armor-and-ac]{of magic resistance, MC1 in 5.0, p.~\pageref*{armor-and-ac}}; \hyperref[armor-and-ac]{of protection, MC3 the only single source, p.~\pageref*{armor-and-ac}}; \hyperref[cloaks]{of magic resistance (MC1), p.~\pageref*{cloaks}}; \hyperref[cloaks]{of protection (MC3), p.~\pageref*{cloaks}}\par
...
Cockatrice: \hyperref[dungeon-hazards-and-how-to-survive-them]{corpse on the stairs, the most literal instadeath, p.~\pageref*{dungeon-hazards-and-how-to-survive-them}}; \hyperref[cockatrices-c]{instant petrification on touch, p.~\pageref*{cockatrices-c}}; \hyperref[petrification-stoning]{corpse, wielding (with gloves!), p.~\pageref*{petrification-stoning}}; \hyperref[petrification-stoning]{corpse, the rubber chicken, p.~\pageref*{petrification-stoning}}; \hyperref[petrification-stoning]{new moon hiss (1 in 3), p.~\pageref*{petrification-stoning}}; \hyperref[the-astral-plane]{corpse, one-shot Rider, p.~\pageref*{the-astral-plane}}\par
\hyperref[the-art-of-combat]{Combat, knowing when not to fight, p.~\pageref*{the-art-of-combat}}\par
\hyperref[combining-conducts]{Combining conducts, the legendary stacks, p.~\pageref*{combining-conducts}}\par
\hyperref[command-counts]{Command counts (10s, 20., etc.), p.~\pageref*{command-counts}}\par
\hyperref[voluntary-challenges]{Conducts, voluntary challenges, p.~\pageref*{voluntary-challenges}}\par
\hyperref[the-astral-plane]{Conflict ring on Astral, Angels go hostile if your Angel dies, p.~\pageref*{the-astral-plane}}\par
\hyperref[fighting-smart]{Conflict, Charisma scales reliability, p.~\pageref*{fighting-smart}}\par
\hyperref[fighting-smart]{Conflict, sight required, p.~\pageref*{fighting-smart}}\par
Confused: \hyperref[searching-and-detection]{gold detection, cheap trap reveal, p.~\pageref*{searching-and-detection}}; \hyperref[deadly-mistakes]{genocide, self-extinction, p.~\pageref*{deadly-mistakes}}; genocide, kills you, pp.~\hyperref[genocide]{\pageref*{genocide}}; \hyperref[confused-reading]{\pageref*{confused-reading}}; \hyperref[taming-new-creatures]{taming, 11×11 widening, p.~\pageref*{taming-new-creatures}}; reading, alternate effects, pp.~\hyperref[use-testing-the-careful-way]{\pageref*{use-testing-the-careful-way}}; \hyperref[confused-reading]{\pageref*{confused-reading}}; \hyperref[confused-reading]{destroy armor cursed, erodeproofs, p.~\pageref*{confused-reading}}; enchant weapon/armor, erodeproofs, pp.~\hyperref[confused-reading]{\pageref*{confused-reading}}; \hyperref[erosion-and-proofing]{\pageref*{erosion-and-proofing}}; \hyperref[confused-reading]{remove curse, randomizes BUC, p.~\pageref*{confused-reading}}; \hyperref[confused-reading]{gold detection, traps revealed, p.~\pageref*{confused-reading}}; \hyperref[confused-reading]{charging, raises max Pw, p.~\pageref*{confused-reading}}\par
\hyperref[containers]{Containers, p.~\pageref*{containers}}\par
\hyperref[fighting-smart]{Cornered scared monsters, fight, p.~\pageref*{fighting-smart}}\par
...
\hyperref[feelings-and-sounds]{Counting gold coins, vault marker, p.~\pageref*{feelings-and-sounds}}\par
...
\hyperref[unlocking-tools]{Credit card, worst but works, p.~\pageref*{unlocking-tools}}\par
\hyperref[credit-and-debt]{Credit cloning, the gold-lure routine, p.~\pageref*{credit-and-debt}}\par
\hyperref[credit-and-debt]{Credit, two ways to accumulate, p.~\pageref*{credit-and-debt}}\par
\hyperref[humans-and-elves]{Croesus, vault guardian, p.~\pageref*{humans-and-elves}}\par
\hyperref[crowning]{Crowning, alignment 20 and Luck 10, p.~\pageref*{crowning}}\par
\hyperref[crowning]{Crowning, prayer-cooldown penalty, p.~\pageref*{crowning}}\par
\hyperref[weapons]{Crysknife, fragile excellence, p.~\pageref*{weapons}}\par
\hyperref[searching-and-detection]{Crystal ball trap survey, p.~\pageref*{searching-and-detection}}\par
\hyperref[other-notable-tools]{Crystal ball, the one-question oracle, p.~\pageref*{other-notable-tools}}\par
...
Cursed: \hyperref[effects-of-cursed-items]{armor, won't come off, p.~\pageref*{effects-of-cursed-items}}; \hyperref[effects-of-cursed-items]{weapon, can't be unwielded, p.~\pageref*{effects-of-cursed-items}}; \hyperref[effects-of-cursed-items]{bag of holding, doubles weight, p.~\pageref*{effects-of-cursed-items}}; \hyperref[how-luck-works]{luckstone, locks negative, p.~\pageref*{how-luck-works}}\par
...
\hyperref[acknowledgements]{Damerell, Object Identification FAQ, p.~\pageref*{acknowledgements}}\par
\hyperref[acknowledgements]{Damerell, prayer spoiler, p.~\pageref*{acknowledgements}}\par
...
\hyperref[the-astral-plane]{Death the Rider, instakill chance, p.~\pageref*{the-astral-plane}}\par
\hyperref[things-that-will-kill-you]{Death, causes of (see: everything), p.~\pageref*{things-that-will-kill-you}}\par
...
\hyperref[the-demon-prince-lairs]{Demon-prince lairs, three sit alone, p.~\pageref*{the-demon-prince-lairs}}\par
...
\hyperref[useful-corpse-effects]{Disenchanter corpse, never eat, p.~\pageref*{useful-corpse-effects}}\par
\hyperref[enchantment-drain]{Disenchanter, mourning your former +5, p.~\pageref*{enchantment-drain}}\par
\hyperref[enchantment-drain]{Disenchanter, range-kill don't melee, p.~\pageref*{enchantment-drain}}\par
...
\hyperref[the-seven-spell-schools]{Divination school, p.~\pageref*{the-seven-spell-schools}}\par
\hyperref[divine-relations]{Divine relations, your god watches, p.~\pageref*{divine-relations}}\par
...
\hyperref[dungeon-hazards-and-how-to-survive-them]{Dungeon hazards, common deaths, p.~\pageref*{dungeon-hazards-and-how-to-survive-them}}\par
...
\hyperref[humanoids-h]{Dwarf, dangerously underrated, p.~\pageref*{humanoids-h}}\par
\hyperref[the-races]{Dwarf, Str and Con caps, p.~\pageref*{the-races}}\par
...
\hyperref[things-that-will-kill-you]{Early dungeon, the deadliest stretch, p.~\pageref*{things-that-will-kill-you}}\par
\hyperref[the-early-shopping-list]{Early shopping list, p.~\pageref*{the-early-shopping-list}}\par
...
\hyperref[scroll-enchant]{Enchant armor, +3 ceiling safe, p.~\pageref*{scroll-enchant}}\par
\hyperref[scroll-enchant]{Enchant weapon, +5 ceiling safe, p.~\pageref*{scroll-enchant}}\par
...
\hyperref[the-ascension-run]{Fake amulet, from bones or wish, p.~\pageref*{the-ascension-run}}\par
\hyperref[room-types]{Fake Delphi, a geometric joke, p.~\pageref*{room-types}}\par
\hyperref[the-gnomish-mines]{Fake luckstone mimic, BUC-test first, p.~\pageref*{the-gnomish-mines}}\par
...
\hyperref[the-astral-plane]{Famine the Rider, hunger per hit, p.~\pageref*{the-astral-plane}}\par
\hyperref[starvation]{Famine, the second Rider, p.~\pageref*{starvation}}\par
\hyperref[feelings-and-sounds]{Feel deathly sick, Pestilence or rot, p.~\pageref*{feelings-and-sounds}}\par
\hyperref[feelings-and-sounds]{Feel feverish, lycanthropy infection, p.~\pageref*{feelings-and-sounds}}\par
\hyperref[feelings-and-sounds]{Feelings and sounds, atmosphere or signal, p.~\pageref*{feelings-and-sounds}}\par
...
\hyperref[engravings]{Finger in dust, fragile but instant, p.~\pageref*{engravings}}\par
\hyperref[the-touch-of-death]{Finger of death, MR blocks (outside-in), p.~\pageref*{the-touch-of-death}}\par
\hyperref[key-spells]{Finger of death, the argument-ender, p.~\pageref*{key-spells}}\par
Fire: \hyperref[dangerous-traps]{trap, sleeper threat for inventory, p.~\pageref*{dangerous-traps}}; \hyperref[useful-corpse-effects]{ant corpse, fire resistance, p.~\pageref*{useful-corpse-effects}}; \hyperref[useful-corpse-effects]{giant corpse, fire + Strength, p.~\pageref*{useful-corpse-effects}}; \hyperref[wishable-random-artifacts]{Brand, fire + firestorm invoke, p.~\pageref*{wishable-random-artifacts}}\par
\hyperref[your-first-descent]{First descent, welcome to the dungeon, p.~\pageref*{your-first-descent}}\par
...
\hyperref[fort-ludios]{Fort Ludios, Croesus across the moat, p.~\pageref*{fort-ludios}}\par
\hyperref[fort-ludios]{Fort Ludios, vault full of gold, p.~\pageref*{fort-ludios}}\par
...
Gehennom: \hyperref[the-big-picture]{lower trunk, p.~\pageref*{the-big-picture}}; \hyperref[gehennom]{why is it so hot, p.~\pageref*{gehennom}}; \hyperref[whats-different-in-gehennom]{no prayer, p.~\pageref*{whats-different-in-gehennom}}; \hyperref[whats-different-in-gehennom]{fire everywhere, p.~\pageref*{whats-different-in-gehennom}}; \hyperref[whats-different-in-gehennom]{hot ground shatters potions, p.~\pageref*{whats-different-in-gehennom}}; \hyperref[whats-different-in-gehennom]{mazes, p.~\pageref*{whats-different-in-gehennom}}\par
...
Genocide: \hyperref[genocide]{(scroll), nuclear option, p.~\pageref*{genocide}}; \hyperref[scroll-genocide]{race-trap warning (h, G, @, o), p.~\pageref*{scroll-genocide}}; \hyperref[survival-tips]{L, removes liches in one read, p.~\pageref*{survival-tips}}; \hyperref[plane-of-water]{class `;`, on Plane of Water, p.~\pageref*{plane-of-water}}\par
...
\hyperref[bats-and-birds-b]{Giant bat, speed 22 swarmer, p.~\pageref*{bats-and-birds-b}}\par
\hyperref[giant-humanoids-h]{Giant corpse, +1 Strength, p.~\pageref*{giant-humanoids-h}}\par
\hyperref[sea-monsters]{Giant eel, grab and drown, p.~\pageref*{sea-monsters}}\par
...
\hyperref[gloves]{Gloves, p.~\pageref*{gloves}}\par
\hyperref[gnomes-g]{Gnome lord, gnome king, p.~\pageref*{gnomes-g}}\par
\hyperref[the-races]{Gnome, slightly higher Int, p.~\pageref*{the-races}}\par
\hyperref[common-combat-deaths]{Gnomish Mines, a choice not a routine stop, p.~\pageref*{common-combat-deaths}}\par
\hyperref[the-gnomish-mines]{Gnomish Mines, entry around Dlvl 2-4, p.~\pageref*{the-gnomish-mines}}\par
\hyperref[gnomes-g]{Gnomish wizard, sleep spell danger, p.~\pageref*{gnomes-g}}\par
...
\hyperref[the-golden-rules-of-early-survival]{Golden Rules of Early Survival, p.~\pageref*{the-golden-rules-of-early-survival}}\par
...
\hyperref[gremlins-g]{Gremlin, multiplies in water, p.~\pageref*{gremlins-g}}\par
\hyperref[gremlins-g]{Gremlin, strips intrinsic at night, p.~\pageref*{gremlins-g}}\par
\hyperref[xans-and-fantastic-insects-x]{Grid bug, can't move diagonally, p.~\pageref*{xans-and-fantastic-insects-x}}\par
\hyperref[deadly-mistakes]{Grid bug, last-hit kills, p.~\pageref*{deadly-mistakes}}\par
\hyperref[acknowledgements]{Grid bug, name and Tron reference, p.~\pageref*{acknowledgements}}\par
...
\hyperref[the-roles]{Healer, sickness immunity, p.~\pageref*{the-roles}}\par
\hyperref[the-roles]{Healer, sleep-wand surprise, p.~\pageref*{the-roles}}\par
Healing: \hyperref[potion-prices]{potion, \$20 alone, p.~\pageref*{potion-prices}}; \hyperref[potion-healing]{chain, blessed pumps maxHP, p.~\pageref*{potion-healing}}; \hyperref[key-spells]{spell, level 1, p.~\pageref*{key-spells}}; \hyperref[the-seven-spell-schools]{school, p.~\pageref*{the-seven-spell-schools}}\par
...
\hyperref[blessed-uncursed-cursed-buc]{Holy water, blessing items, p.~\pageref*{blessed-uncursed-cursed-buc}}\par
\hyperref[potion-holy-water]{Holy water, dipping water multiplies, p.~\pageref*{potion-holy-water}}\par
\hyperref[potion-holy-water]{Holy water, making (pray on co-aligned altar), p.~\pageref*{potion-holy-water}}\par
\hyperref[how-items-get-cursed]{How items get cursed (bones, monsters, etc.), p.~\pageref*{how-items-get-cursed}}\par
\hyperref[the-races]{Human, no infravision, no special talents, p.~\pageref*{the-races}}\par
\hyperref[how-hunger-works]{Hunger thresholds, Satiated to Fainting, p.~\pageref*{how-hunger-works}}\par
...
\hyperref[a-practical-identification-strategy]{Identification flowchart, p.~\pageref*{a-practical-identification-strategy}}\par
\hyperref[gaining-and-losing-luck]{Identified gem to co-aligned unicorn, +5, p.~\pageref*{gaining-and-losing-luck}}\par
Identify: \hyperref[the-early-shopping-list]{scroll, valuable but late, p.~\pageref*{the-early-shopping-list}}; \hyperref[scroll-prices]{scroll, \$20 alone, p.~\pageref*{scroll-prices}}; \hyperref[scroll-identify]{never enough scrolls of, p.~\pageref*{scroll-identify}}; \hyperref[key-spells]{spell, blessed multi-ID, p.~\pageref*{key-spells}}\par
\hyperref[illiterate]{Illiterate conduct, p.~\pageref*{illiterate}}\par
\hyperref[illiterate]{Illiterate, only x signature allowed, p.~\pageref*{illiterate}}\par
...
\hyperref[seduction]{Incubus, succubus, the encounter table, p.~\pageref*{seduction}}\par
...
Iron: \hyperref[golems]{golem, poison breath, p.~\pageref*{golems}}; \hyperref[dangerous-traps]{footwear, surprisingly protective, p.~\pageref*{dangerous-traps}}; \hyperref[iron-bars]{bars, light passes through, p.~\pageref*{iron-bars}}; \hyperref[iron-bars]{bars, dig around them, p.~\pageref*{iron-bars}}; \hyperref[iron-bars]{bars, wand of lightning melts (sometimes), p.~\pageref*{iron-bars}}; \hyperref[boots]{shoes, traps protection, p.~\pageref*{boots}}\par
...
\hyperref[the-golden-rules-of-early-survival]{Killer bees, expect more, p.~\pageref*{the-golden-rules-of-early-survival}}\par
\hyperref[gaining-and-losing-luck]{Killing co-aligned unicorn, –5, p.~\pageref*{gaining-and-losing-luck}}\par
\hyperref[gaining-and-losing-luck]{Killing peaceful, –1 Luck (50\%), p.~\pageref*{gaining-and-losing-luck}}\par
\hyperref[gaining-and-losing-luck]{Killing pet, –1 Luck plus –15 alignment, p.~\pageref*{gaining-and-losing-luck}}\par
\hyperref[felines-f]{Kitten, common starter pet, p.~\pageref*{felines-f}}\par
Knight: \hyperref[the-roles]{pony of, p.~\pageref*{the-roles}}; \hyperref[the-roles]{Excalibur odds (1 in 6), p.~\pageref*{the-roles}}; \hyperref[the-roles]{caitiff penalty, p.~\pageref*{the-roles}}; \hyperref[the-roles]{jousting on lance, p.~\pageref*{the-roles}}\par
...
\hyperref[sea-monsters]{Kraken, Medusa's pool variant, p.~\pageref*{sea-monsters}}\par
\hyperref[medusas-island]{Kraken, only on medusa-4, p.~\pageref*{medusas-island}}\par
...
\hyperref[containers]{Large box, chest, ice box (furniture), p.~\pageref*{containers}}\par
\hyperref[a-note-on-mimics]{Large mimic, sticky claw, p.~\pageref*{a-note-on-mimics}}\par
...
\hyperref[other-notable-tools]{Leash, follows through stairs, p.~\pageref*{other-notable-tools}}\par
...
\hyperref[leprechauns-l]{Leprechaun, your gold and gone, p.~\pageref*{leprechauns-l}}\par
\hyperref[level-drain]{Level drain, wraiths and friends, p.~\pageref*{level-drain}}\par
\hyperref[movement-traps]{Level teleporter, separated from your pet, p.~\pageref*{movement-traps}}\par
...
\hyperref[the-golden-rules-of-early-survival]{Lizard corpse, carry one, p.~\pageref*{the-golden-rules-of-early-survival}}\par
\hyperref[lizards]{Lizard corpse, cures stoning, p.~\pageref*{lizards}}\par
\hyperref[gray-stones-four-stones-one-correct-answer]{Loadstone, cursed and refuses to drop, p.~\pageref*{gray-stones-four-stones-one-correct-answer}}\par
...
\hyperref[how-luck-works]{Luck, the hidden number, p.~\pageref*{how-luck-works}}\par
\hyperref[how-luck-works]{Luckstone, freezes the drift, p.~\pageref*{how-luck-works}}\par
\hyperref[gray-stones-four-stones-one-correct-answer]{Luckstone, preserves luck, p.~\pageref*{gray-stones-four-stones-one-correct-answer}}\par
\hyperref[engulfment]{Lurker above, ceiling drop, p.~\pageref*{engulfment}}\par
\hyperref[engulfment]{Lurker above, looking up too late, p.~\pageref*{engulfment}}\par
...
\hyperref[common-combat-deaths]{Major demons, summoning each other, p.~\pageref*{common-combat-deaths}}\par
...
\hyperref[medusas-island]{Medusa, surviving the gaze, p.~\pageref*{medusas-island}}\par
\hyperref[humans-and-elves]{Medusa, the Gorgon, p.~\pageref*{humans-and-elves}}\par
\hyperref[a-note-on-mimics]{Mimics, shop disguise, p.~\pageref*{a-note-on-mimics}}\par
\hyperref[humanoids-h]{Mind flayer, drains Int, p.~\pageref*{humanoids-h}}\par
\hyperref[brainlessness]{Mind flayer, greased helmet stacks, p.~\pageref*{brainlessness}}\par
\hyperref[brainlessness]{Mind flayer, wear any helmet, p.~\pageref*{brainlessness}}\par
\hyperref[the-gnomish-mines]{Mine's End, guaranteed luckstone, p.~\pageref*{the-gnomish-mines}}\par
\hyperref[supply-containers]{Mines branch chest, food edition, p.~\pageref*{supply-containers}}\par
\hyperref[the-gnomish-mines]{Mines, gnomish (general), p.~\pageref*{the-gnomish-mines}}\par
\hyperref[the-gnomish-mines]{Minesflayer, the mind flayer surprise, p.~\pageref*{the-gnomish-mines}}\par
\hyperref[the-gnomish-mines]{Minetown watch, attacking peacefuls, p.~\pageref*{the-gnomish-mines}}\par
\hyperref[the-gnomish-mines]{Minetown, shops and temple, p.~\pageref*{the-gnomish-mines}}\par
...
\hyperref[the-roles]{Monk, no body armor please, p.~\pageref*{the-roles}}\par
\hyperref[the-roles]{Monk, robe spellcasting bonus, p.~\pageref*{the-roles}}\par
...
\hyperref[movement-prefixes]{Movement prefixes (F, G, m), p.~\pageref*{movement-prefixes}}\par
...
\hyperref[the-gauntlet]{Mysterious Force, Chaotic discount, p.~\pageref*{the-gauntlet}}\par
\hyperref[the-gauntlet]{Mysterious Force, every staircase a chance, p.~\pageref*{the-gauntlet}}\par
...
\hyperref[acknowledgements]{NetHack DevTeam, who maintain it, p.~\pageref*{acknowledgements}}\par
\hyperref[acknowledgements]{NetHack Wiki, the living changelog, p.~\pageref*{acknowledgements}}\par
\hyperref[alignment]{Neutral, the most flexibility, p.~\pageref*{alignment}}\par
\hyperref[the-golden-rules-of-early-survival]{Newt corpse, free mana sometimes, p.~\pageref*{the-golden-rules-of-early-survival}}\par
\hyperref[lizards]{Newt corpse, restores 1-3 Pw, p.~\pageref*{lizards}}\par
\hyperref[no-genocide]{No Genocide conduct, type \\"none\\", p.~\pageref*{no-genocide}}\par
\hyperref[wishing-restrictions]{No wishing for artifacts conduct, p.~\pageref*{wishing-restrictions}}\par
\hyperref[combining-conducts]{Nudist conduct (since 3.6), p.~\pageref*{combining-conducts}}\par
\hyperref[nuisance-traps]{Nuisance traps, arrow and dart, p.~\pageref*{nuisance-traps}}\par
\hyperref[options-worth-knowing-about]{Number\_pad, the keypad layout, p.~\pageref*{options-worth-knowing-about}}\par
\hyperref[a-note-on-nymphs]{Nymph, walks off the level with your bag of holding, p.~\pageref*{a-note-on-nymphs}}\par
\hyperref[a-note-on-nymphs]{Nymphs, never engage carrying the Amulet, p.~\pageref*{a-note-on-nymphs}}\par
\hyperref[a-note-on-nymphs]{Nymphs, the universal horror story, p.~\pageref*{a-note-on-nymphs}}\par
...
Oracle: \hyperref[humans-and-elves]{peaceful by design, p.~\pageref*{humans-and-elves}}; \hyperref[the-oracle]{mid-levels, p.~\pageref*{the-oracle}}; \hyperref[the-oracle]{minor consultation (50 zm), p.~\pageref*{the-oracle}}; \hyperref[the-oracle]{major consultation, p.~\pageref*{the-oracle}}\par
\hyperref[a-note-on-dragons]{Orange dragon scale mail, sleep + free action, p.~\pageref*{a-note-on-dragons}}\par
\hyperref[quest-artifacts]{Orb of Detection (Archeologist), p.~\pageref*{quest-artifacts}}\par
\hyperref[quest-artifacts]{Orb of Fate (Valkyrie), p.~\pageref*{quest-artifacts}}\par
\hyperref[how-luck-works]{Orb of Fate, counts as luckstone, p.~\pageref*{how-luck-works}}\par
\hyperref[the-races]{Orc, peaceful-to-orcs, p.~\pageref*{the-races}}\par
...
\hyperref[orcus-town]{Orcus Town, ghost shopping district, p.~\pageref*{orcus-town}}\par
\hyperref[orcus-town]{Orcus Town, guaranteed magic lamp or marker, p.~\pageref*{orcus-town}}\par
\hyperref[orcus-town]{Orcus, Prince of Undead, p.~\pageref*{orcus-town}}\par
...
\hyperref[pacifist]{Pacifist conduct, p.~\pageref*{pacifist}}\par
\hyperref[pacifist]{Pacifist, the figurine-of-Archon plan, p.~\pageref*{pacifist}}\par
\hyperref[things-that-will-kill-you]{Pacing, XL near Dlvl, p.~\pageref*{things-that-will-kill-you}}\par
\hyperref[learning-spells]{Paperback, +20 XP on first read, p.~\pageref*{learning-spells}}\par
...
Pet: \hyperref[the-golden-rules-of-early-survival]{your friend (mostly), p.~\pageref*{the-golden-rules-of-early-survival}}; \hyperref[deadly-mistakes]{kills (yours), via conflict ring, p.~\pageref*{deadly-mistakes}}; \hyperref[keeping-your-pet-alive]{accidentally killing your, p.~\pageref*{keeping-your-pet-alive}}; \hyperref[starting-pets]{your best early asset, p.~\pageref*{starting-pets}}; \hyperref[starting-pets]{growth from feeding, p.~\pageref*{starting-pets}}; \hyperref[starting-pets]{curse detection (drop and watch), p.~\pageref*{starting-pets}}; \hyperref[taming-new-creatures]{taming new creatures, p.~\pageref*{taming-new-creatures}}; \hyperref[what-pets-do-for-you]{shoplifting, store-without-paying, p.~\pageref*{what-pets-do-for-you}}; \hyperref[keeping-your-pet-alive]{leaving on Sokoban (kennel), p.~\pageref*{keeping-your-pet-alive}}; \hyperref[keeping-your-pet-alive]{reviving at a co-aligned altar (new in 5.0), p.~\pageref*{keeping-your-pet-alive}}; \hyperref[keeping-your-pet-alive]{gains resistances from corpses (new in 5.0), p.~\pageref*{keeping-your-pet-alive}}\par
...
Prayer: \hyperref[the-golden-rules-of-early-survival]{emergency button cooldown, p.~\pageref*{the-golden-rules-of-early-survival}}; \hyperref[prayer]{when to, p.~\pageref*{prayer}}; \hyperref[prayer]{what it fixes (priority order), p.~\pageref*{prayer}}; \hyperref[prayer]{requirements (alignment, luck, cooldown), p.~\pageref*{prayer}}; \hyperref[prayer]{cooldown, \textasciitilde{}500 turn ballpark, p.~\pageref*{prayer}}\par
...
\hyperref[donating-to-priests]{Protection racket, the donation ladder, p.~\pageref*{donating-to-priests}}\par
\hyperref[a-note-on-puddings]{Puddings, splitting trap, p.~\pageref*{a-note-on-puddings}}\par
...
Quest: \hyperref[the-quest]{the role's special dungeon, p.~\pageref*{the-quest}}; \hyperref[the-quest]{portal, magenta `\textasciicircum{}`, p.~\pageref*{the-quest}}; \hyperref[the-quest]{XL 14 and alignment 20, p.~\pageref*{the-quest}}; \hyperref[the-quest]{leader, on the first floor, p.~\pageref*{the-quest}}; \hyperref[the-quest]{nemesis, kill twice (life saving), p.~\pageref*{the-quest}}; \hyperref[the-quest]{artifact, on the nemesis's square, p.~\pageref*{the-quest}}; \hyperref[quest-artifacts]{artifacts, the per-role list, p.~\pageref*{quest-artifacts}}\par
...
\hyperref[the-early-shopping-list]{Ranged attack, almost always safer, p.~\pageref*{the-early-shopping-list}}\par
\hyperref[fighting-smart]{Ranged attackers retreat, backing into corners, p.~\pageref*{fighting-smart}}\par
...
\hyperref[the-early-shopping-list]{Restraint, forty pounds of, p.~\pageref*{the-early-shopping-list}}\par
...
Ring: \hyperref[fighting-smart]{of conflict, in combat, p.~\pageref*{fighting-smart}}; \hyperref[ring-prices]{prices, \$100 to \$300, p.~\pageref*{ring-prices}}; \hyperref[the-ring-table]{table, by price tier, p.~\pageref*{the-ring-table}}; \hyperref[the-ring-table]{of free action, anti-paralysis, p.~\pageref*{the-ring-table}}; \hyperref[the-ring-table]{of teleport control, on-demand transport, p.~\pageref*{the-ring-table}}; \hyperref[the-ring-table]{of conflict, monsters fight each other, p.~\pageref*{the-ring-table}}; \hyperref[the-ring-table]{of slow digestion, foodless option, p.~\pageref*{the-ring-table}}; \hyperref[the-ring-table]{of polymorph control, less critical now, p.~\pageref*{the-ring-table}}; \hyperref[the-ring-table]{of aggravate monster, the niche use, p.~\pageref*{the-ring-table}}; \hyperref[the-ring-table]{hunger, every ring costs nutrition, p.~\pageref*{the-ring-table}}; \hyperref[the-ring-table]{of protection, chargeable, p.~\pageref*{the-ring-table}}; \hyperref[the-ring-table]{of regeneration, hungry healer, p.~\pageref*{the-ring-table}}; \hyperref[the-ring-table]{of searching, auto-search each turn, p.~\pageref*{the-ring-table}}; \hyperref[the-ring-table]{of warning, threat-color overlay, p.~\pageref*{the-ring-table}}; \hyperref[the-ring-table]{of sustain ability, prevents stat drain, p.~\pageref*{the-ring-table}}\par
...
Rogue: \hyperref[the-roles]{multishot dagger throw, p.~\pageref*{the-roles}}; \hyperref[the-roles]{backstab bonus, p.~\pageref*{the-roles}}; \hyperref[the-rogue-level]{Level, older more primitive world, p.~\pageref*{the-rogue-level}}; \hyperref[the-rogue-level]{Level, all uppercase wildlife, p.~\pageref*{the-rogue-level}}; \hyperref[acknowledgements]{(1980), Toy and Wichman, p.~\pageref*{acknowledgements}}\par
\hyperref[choosing-your-expedition]{Role, choosing one, p.~\pageref*{choosing-your-expedition}}\par
\hyperref[the-roles]{Roles, the thirteen, p.~\pageref*{the-roles}}\par
...
\hyperref[the-golden-rules-of-early-survival]{Rule 1, don't fight what you can't beat, p.~\pageref*{the-golden-rules-of-early-survival}}\par
...
\hyperref[rust-monsters-and-disenchanters-r]{Rust monster, strip iron first, p.~\pageref*{rust-monsters-and-disenchanters-r}}\par
\hyperref[nuisance-traps]{Rust trap, splashes water, p.~\pageref*{nuisance-traps}}\par
...
Sacrifice: \hyperref[sacrifice]{fresh within 50 turns, p.~\pageref*{sacrifice}}; \hyperref[sacrifice]{role-biased first gift, p.~\pageref*{sacrifice}}; \hyperref[sacrifice]{minimum corpse value, p.~\pageref*{sacrifice}}; \hyperref[gaining-and-losing-luck]{luck ceiling, difficulty must exceed, p.~\pageref*{gaining-and-losing-luck}}\par
...
\hyperref[the-roles]{Samurai, giri-breaking penalty, p.~\pageref*{the-roles}}\par
\hyperref[the-roles]{Samurai, katana opening, p.~\pageref*{the-roles}}\par
\hyperref[the-roles]{Samurai, wakizashi is dead weight, p.~\pageref*{the-roles}}\par
...
\hyperref[the-touch-of-death]{Self-zap of death, only nonliving safe, p.~\pageref*{the-touch-of-death}}\par
\hyperref[deadly-mistakes]{Self-zapped wand, ray ricochet, p.~\pageref*{deadly-mistakes}}\par
\hyperref[the-seven-spell-schools]{Seven spell schools, focus and grind, p.~\pageref*{the-seven-spell-schools}}\par
Shield: \hyperref[level-drain]{of drain resistance, new in 5.0, p.~\pageref*{level-drain}}; \hyperref[shields]{of reflection, saves the body slot, p.~\pageref*{shields}}; \hyperref[shields]{of drain resistance (new in 5.0), p.~\pageref*{shields}}; \hyperref[shields]{of shock resistance (new in 5.0), p.~\pageref*{shields}}\par
\hyperref[shields]{Shields, p.~\pageref*{shields}}\par
\hyperref[shirts]{Shirts, Hawaiian and T-shirt, p.~\pageref*{shirts}}\par
\hyperref[room-types]{Shop, identified by shopkeeper, p.~\pageref*{room-types}}\par
\hyperref[shopkeeper-behavior]{Shopkeeper behavior, the toughest NPCs, p.~\pageref*{shopkeeper-behavior}}\par
\hyperref[shopping-and-shopkeeper-pricing]{Shopkeeper, angering, p.~\pageref*{shopping-and-shopkeeper-pricing}}\par
\hyperref[humans-and-elves]{Shopkeeper, tougher NPC than you, p.~\pageref*{humans-and-elves}}\par
\hyperref[shopping-and-shopkeeper-pricing]{Shopping and shopkeeper pricing, full details, p.~\pageref*{shopping-and-shopkeeper-pricing}}\par
...
\hyperref[weapons]{Silver saber bonus, late-game weapon, p.~\pageref*{weapons}}\par
\hyperref[weapons]{Silver saber, demon damage, p.~\pageref*{weapons}}\par
\hyperref[room-types]{Single-monster-type room, almost always themed, p.~\pageref*{room-types}}\par
Sink: \hyperref[sinks]{kicking for rings and trouble, p.~\pageref*{sinks}}; \hyperref[sinks]{the amorous dishwasher demon, p.~\pageref*{sinks}}; \hyperref[sinks]{dipping potions for messages, p.~\pageref*{sinks}}; \hyperref[sinks]{quaffing the drain, p.~\pageref*{sinks}}; \hyperref[sinks]{dropping a ring down, p.~\pageref*{sinks}}; \hyperref[the-sink-test-rings]{test, the ring drop, p.~\pageref*{the-sink-test-rings}}\par
...
\hyperref[the-skill-ladder]{Skill, 32-slot ceiling at XL 30 crowned, p.~\pageref*{the-skill-ladder}}\par
\hyperref[common-combat-deaths]{Sleep without resistance, near-instadeath, p.~\pageref*{common-combat-deaths}}\par
\hyperref[dangerous-traps]{Sleeping gas trap, murder in monster rooms, p.~\pageref*{dangerous-traps}}\par
...
Sokoban: \hyperref[sokoban]{entry one level above Oracle, p.~\pageref*{sokoban}}; \hyperref[sokoban]{boulders into pits, p.~\pageref*{sokoban}}; \hyperref[sokoban]{no teleport here, p.~\pageref*{sokoban}}; \hyperref[sokoban]{cheating cost (–1 Luck each), p.~\pageref*{sokoban}}; \hyperref[sokoban]{prize, bag of holding or amulet of reflection, p.~\pageref*{sokoban}}; \hyperref[sokoban]{Strength training side effect, p.~\pageref*{sokoban}}; \hyperref[sokoban-solutions]{solutions appendix, p.~\pageref*{sokoban-solutions}}; \hyperref[sokoban-solutions]{solving without cheating, p.~\pageref*{sokoban-solutions}}; \hyperref[level-1-version-a]{level 1 A and B variants, p.~\pageref*{level-1-version-a}}; \hyperref[level-1-version-a]{scrolls of earth as fillers, p.~\pageref*{level-1-version-a}}; \hyperref[level-2-version-a]{level 2 variants, p.~\pageref*{level-2-version-a}}; \hyperref[level-3-version-a]{level 3 variants, p.~\pageref*{level-3-version-a}}; \hyperref[level-4-version-a]{level 4 variants (the prize), p.~\pageref*{level-4-version-a}}; \hyperref[sokoban-solutions]{mirrored variants (new in 5.0), p.~\pageref*{sokoban-solutions}}; \hyperref[sokoban-new-in-5.0]{(no cheating) conduct (new in 5.0), p.~\pageref*{sokoban-new-in-5.0}}\par
...
\hyperref[armor-and-ac]{Speed boots, more turns equals more, p.~\pageref*{armor-and-ac}}\par
Spell: \hyperref[brainlessness]{amnesia, mind flayer side effect, p.~\pageref*{brainlessness}}; \hyperref[learning-spells]{memory, \textasciitilde{}20,000 turns, p.~\pageref*{learning-spells}}; \hyperref[spell-school-caps]{school caps, by role, p.~\pageref*{spell-school-caps}}; \hyperref[spell-tables]{tables (full appendix), p.~\pageref*{spell-tables}}\par
\hyperref[training-a-skill]{Spell-school practice, level × cast, p.~\pageref*{training-a-skill}}\par
Spellbook: \hyperref[spellbook-prices]{prices, 100 × level, p.~\pageref*{spellbook-prices}}; \hyperref[learning-spells]{failure effects by level, p.~\pageref*{learning-spells}}; \hyperref[learning-spells]{4 successful reads to fade, p.~\pageref*{learning-spells}}; \hyperref[learning-spells]{level 7 explosion rune, p.~\pageref*{learning-spells}}\par
\hyperref[spellcasting]{Spellcasting, mana not sparkles, p.~\pageref*{spellcasting}}\par
\hyperref[spending-slots-wisely]{Spending slots wisely, the principles, p.~\pageref*{spending-slots-wisely}}\par
...
\hyperref[quest-artifacts]{Staff of Aesculapius (Healer), drain-life on hit, p.~\pageref*{quest-artifacts}}\par
\hyperref[level-drain]{Staff of Aesculapius, drain res, p.~\pageref*{level-drain}}\par
\hyperref[the-map-symbols]{Stairs, up and down (`<`, `>`), p.~\pageref*{the-map-symbols}}\par
\hyperref[useful-corpse-effects]{Stalker corpse, invisibility and see invisible, p.~\pageref*{useful-corpse-effects}}\par
\hyperref[elementals-e]{Stalker, see-invisible corpse, p.~\pageref*{elementals-e}}\par
\hyperref[what-to-pack]{Starting kit, improving on, p.~\pageref*{what-to-pack}}\par
\hyperref[dungeon-hazards-and-how-to-survive-them]{Starvation, eat at Hungry not Weak, p.~\pageref*{dungeon-hazards-and-how-to-survive-them}}\par
...
\hyperref[scroll-stinking-cloud]{Stinking cloud, room-clearing fog, p.~\pageref*{scroll-stinking-cloud}}\par
\hyperref[petrification-stoning]{Stoning, avoiding, p.~\pageref*{petrification-stoning}}\par
\hyperref[giant-humanoids-h]{Storm, fire, frost giant breath of boulders, p.~\pageref*{giant-humanoids-h}}\par
\hyperref[wishable-random-artifacts]{Stormbringer (Chaotic runesword), drain life, p.~\pageref*{wishable-random-artifacts}}\par
\hyperref[level-drain]{Stormbringer, drain res while wielded (chaotic), p.~\pageref*{level-drain}}\par
\hyperref[feelings-and-sounds]{Strange mental acuity, telepathy gained, p.~\pageref*{feelings-and-sounds}}\par
\hyperref[feelings-and-sounds]{Strange wind, Oracle level, p.~\pageref*{feelings-and-sounds}}\par
\hyperref[delayed-deaths]{Strangulation, uncurse first, p.~\pageref*{delayed-deaths}}\par
...
\hyperref[supply-containers]{Supply chests, locked with goodies, p.~\pageref*{supply-containers}}\par
\hyperref[supply-containers]{Supply containers, care packages from somebody, p.~\pageref*{supply-containers}}\par
\hyperref[survival-tips]{Survival tips, Gehennom checklist, p.~\pageref*{survival-tips}}\par
...
\hyperref[detecting-curses]{Temple donation, does NOT reveal BUC, p.~\pageref*{detecting-curses}}\par
\hyperref[room-types]{Temple, altar plus priest, p.~\pageref*{room-types}}\par
\hyperref[useful-corpse-effects]{Tengu corpse, teleportitis / teleport control, p.~\pageref*{useful-corpse-effects}}\par
\hyperref[imps-and-minor-demons-i]{Tengu, teleport and teleport-control corpse, p.~\pageref*{imps-and-minor-demons-i}}\par
\hyperref[acknowledgements]{The DevTeam is THINKING, the 12-year gap, p.~\pageref*{acknowledgements}}\par
\hyperref[the-price-is-right]{The Price Is Right, shopkeepers identify, p.~\pageref*{the-price-is-right}}\par
...
Throne: \hyperref[room-types]{room, sit at your own risk, p.~\pageref*{room-types}}; \hyperref[thrones]{the purest gamble, p.~\pageref*{thrones}}; \hyperref[thrones]{wish only at positive Luck 7+, p.~\pageref*{thrones}}; \hyperref[thrones]{vanishes in a puff of logic, p.~\pageref*{thrones}}; \hyperref[thrones]{kicking for gold and gems, p.~\pageref*{thrones}}; \hyperref[the-castle]{room (Castle court), p.~\pageref*{the-castle}}\par
...
\hyperref[the-touch-of-death]{Touch of death (Rider Death), p.~\pageref*{the-touch-of-death}}\par
\hyperref[gem-identification-through-selling]{Touchstone, blessed names gems on rub, p.~\pageref*{gem-identification-through-selling}}\par
\hyperref[the-early-shopping-list]{Touchstone, helpful not urgent, p.~\pageref*{the-early-shopping-list}}\par
\hyperref[gray-stones-four-stones-one-correct-answer]{Touchstone, real gem on rub, p.~\pageref*{gray-stones-four-stones-one-correct-answer}}\par
\hyperref[the-roles]{Tourist, camera-flash plan, p.~\pageref*{the-roles}}\par
\hyperref[the-roles]{Tourist, hardest of the standard roles, p.~\pageref*{the-roles}}\par
\hyperref[the-roles]{Tourist, magic mapping scrolls at start, p.~\pageref*{the-roles}}\par
\hyperref[other-notable-tools]{Towel, cream pie and blindfold, p.~\pageref*{other-notable-tools}}\par
\hyperref[training-a-skill]{Training a skill, dmg>1 counts, p.~\pageref*{training-a-skill}}\par
...
\hyperref[quest-artifacts]{Tsurugi of Muramasa (Samurai), p.~\pageref*{quest-artifacts}}\par
\hyperref[how-luck-works]{Tsurugi of Muramasa, counts as luckstone, p.~\pageref*{how-luck-works}}\par
\hyperref[weapons]{Tsurugi, two-handed bisects, p.~\pageref*{weapons}}\par
...
\hyperref[two-weapon-combat]{Two-weapon combat, flat penalty per strike, p.~\pageref*{two-weapon-combat}}\par
...
\hyperref[vegetarian-safe-corpses]{Useful corpse effects (vegetarian), p.~\pageref*{vegetarian-safe-corpses}}\par
...
\hyperref[the-roles]{Valkyrie, easy-mode recommendation, p.~\pageref*{the-roles}}\par
\hyperref[the-roles]{Valkyrie, Female only, p.~\pageref*{the-roles}}\par
\hyperref[the-roles]{Valkyrie, Mjollnir waiting, p.~\pageref*{the-roles}}\par
\hyperref[the-valley-of-the-dead]{Valley of the Dead, Gehennom entrance, p.~\pageref*{the-valley-of-the-dead}}\par
\hyperref[bats-and-birds-b]{Vampire bat, Str-draining bite, p.~\pageref*{bats-and-birds-b}}\par
\hyperref[vampires-v]{Vampire, level drain, p.~\pageref*{vampires-v}}\par
\hyperref[where-the-word-comes-from]{Varda Elentári, Star-Queen, p.~\pageref*{where-the-word-comes-from}}\par
\hyperref[vaults]{Vault guard, lying costs Lawfuls alignment, p.~\pageref*{vaults}}\par
\hyperref[vaults]{Vault guard, name yourself Croesus, p.~\pageref*{vaults}}\par
\hyperref[vaults]{Vaults, the 2×2 closet of gold, p.~\pageref*{vaults}}\par
\hyperref[the-food-conducts]{Vegan conduct, p.~\pageref*{the-food-conducts}}\par
\hyperref[what-to-eat]{Vegan, no eggs either, p.~\pageref*{what-to-eat}}\par
\hyperref[the-food-conducts]{Vegetarian conduct, p.~\pageref*{the-food-conducts}}\par
\hyperref[what-to-eat]{Vegetarian, allowed corpses, p.~\pageref*{what-to-eat}}\par
...
\hyperref[vampires-v]{Vlad the Impaler, top of his tower, p.~\pageref*{vampires-v}}\par
\hyperref[engravings]{Vlad was here, trap-door closet marker, p.~\pageref*{engravings}}\par
Vlad's: \hyperref[vlads-tower]{throne, fourth sit's the charm, p.~\pageref*{vlads-tower}}; \hyperref[vlads-tower]{Tower, branches upward, p.~\pageref*{vlads-tower}}; \hyperref[vlads-tower]{throne, four wishes in thirteen, p.~\pageref*{vlads-tower}}; \hyperref[vlads-tower]{throne, the nine bad outcomes, p.~\pageref*{vlads-tower}}\par
...
\hyperref[wand-digging]{Wand of digging, ascension kit staple, p.~\pageref*{wand-digging}}\par
\hyperref[wand-digging]{Wand of digging, cursed zaps down, p.~\pageref*{wand-digging}}\par
...
\hyperref[wands-and-staves]{Wands and staves, three types, p.~\pageref*{wands-and-staves}}\par
...
\hyperref[weapon-skill-caps]{Weapon skill caps, the matrix, p.~\pageref*{weapon-skill-caps}}\par
\hyperref[weaponless]{Weaponless conduct, p.~\pageref*{weaponless}}\par
\hyperref[weapons-tables]{Weapons tables (full appendix), p.~\pageref*{weapons-tables}}\par
...
\hyperref[what-changed-since-last-time]{What changed since last time, 5.0 release, p.~\pageref*{what-changed-since-last-time}}\par
\hyperref[what-to-eat]{What to eat, fresh kills first, p.~\pageref*{what-to-eat}}\par
...
Wish: \hyperref[sources-of-wishes]{sources, six in total, p.~\pageref*{sources-of-wishes}}; \hyperref[wish-syntax]{syntax, blessed greased fixed +3 GDSM, p.~\pageref*{wish-syntax}}; \hyperref[wish-syntax]{silent substitutions (fake amulet, etc.), p.~\pageref*{wish-syntax}}; \hyperref[wishing-restrictions]{for \\"nothing\\", the escape hatch, p.~\pageref*{wishing-restrictions}}\par
...
\hyperref[a-note-on-wraiths]{Wraith corpse, gain an experience level, p.~\pageref*{a-note-on-wraiths}}\par
\hyperref[a-note-on-wraiths]{Wraith corpse, the recipe, p.~\pageref*{a-note-on-wraiths}}\par
\hyperref[scroll-reverse-genocide]{Wraith reverse genocide, banquet, p.~\pageref*{scroll-reverse-genocide}}\par
\hyperref[a-note-on-wraiths]{Wraiths, farming with reverse genocide, p.~\pageref*{a-note-on-wraiths}}\par
