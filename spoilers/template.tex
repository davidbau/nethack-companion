...
% before the next section. The fix below loads xltabular's
% longtable-replacement environment via the ltablex package and
% redefines pandoc's longtable opener so each table uses the
% phantom-free pagination logic.
\usepackage{ltablex}
\keepXColumns
