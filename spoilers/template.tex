...
\texttt{m}+dir & move without attacking or pickup\\
\end{tabular}
...
\end{minipage}
\par\vspace{1.4em}
{\centering Commands written with \texttt{\#} are typed out in full. Most actions then ask for a direction or an item. A number repeats a command: \texttt{22s} searches 22 times, stopping early if anything happens. \texttt{Esc} cancels; \texttt{Ctrl+A} repeats your last command.\par}
\normalsize
\clearpage
