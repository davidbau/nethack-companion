% LaTeX template for "A Traveler's Guide to the Mazes of Menace"
...
\setmonofont{Source Code Pro}[
  Path=fonts/,
  Extension=.ttf,
  UprightFont=SourceCodePro,
  UprightFeatures={FakeBold=3},
  ItalicFont=SourceCodePro-Italic,
  ItalicFeatures={FakeBold=3},
  BoldFont=SourceCodePro,
  BoldFeatures={FakeBold=5},
  BoldItalicFont=SourceCodePro-Italic,
  BoldItalicFeatures={FakeBold=5},
  Scale=0.80
]
...
\vspace*{2in}
\begin{center}
{\LARGE\bfseries A Traveler's Guide to the\\[0.3em]Mazes of Menace}
\end{center}
\end{titlepage}
