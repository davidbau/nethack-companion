...
% patches the longtable environment, and the negative \vspace
% pulls back the trailing baseline that the package's "table is
% complete" marker would otherwise leave as a visible empty row.
\usepackage{ltablex}
\keepXColumns
