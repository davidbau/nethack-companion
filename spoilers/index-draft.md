# Index Draft for the NetHack Companion

Organized by Part. Anchors are best guesses based on Pandoc auto-slugs.
Not alphabetized; that's a final-pass concern.
...
- "Barbarian, poison resistance gift" → #the-roles
- "Cave Dweller, sling and flint" → #the-roles
- "Healer, sleep-wand surprise" → #the-roles
...
- "Valkyrie, Mjollnir waiting" → #the-roles
- "Valkyrie, Female only" → #the-roles
- "Wizard, kitten that won't share lunch" → #the-roles
- "Wizard, cloak of magic resistance from turn one" → #the-roles
- "Wizard, force bolt shatters potions" → #the-roles
- "Races, the five" → #the-races
...
- "Chaotic, paired with Rogue for theme" → #alignment
- "First-game recommendation" → #alignment

### Packing and early survival
...
### Lay of the land and map

- "Dungeon layout, the branching tree" → #the-big-picture
- "Dungeons of Doom, upper trunk" → #the-big-picture
...
- "Zorkmid, abbreviation zm" → #the-map-symbols
...
- "Mausoleum, mummy waiting" → #room-types
- "Spider nest, scales with depth" → #room-types
- "Trap room, recognize and retreat" → #room-types
- "Teleportation hub, fixed-destination" → #room-types
- "Fake Delphi, a geometric joke" → #room-types
- "Single-monster-type room, almost always themed" → #room-types
...
- "Pyrolisk, fire-gaze cousin" → #cockatrices-c
- "`d` dogs and canines" → #dogs-and-canines-d
- "Jackal, leading cause of death" → #dogs-and-canines-d
- "Werewolf, werejackal, lycanthropy" → #dogs-and-canines-d
- "`e` eyes and spheres" → #eyes-and-spheres-e
- "Floating eye, never melee" → #eyes-and-spheres-e
- "Floating eye corpse, telepathy" → #eyes-and-spheres-e
- "Gas spore, walking explosion" → #eyes-and-spheres-e
- "`f` felines" → #felines-f
- "Kitten, common starter pet" → #felines-f
- "Displacer beast, taming" → #felines-f
- "`g` gremlins and gargoyles" → #gremlins-g
- "Gremlin, strips intrinsic at night" → #gremlins-g
- "Gremlin, multiplies in water" → #gremlins-g
- "`G` gnomes" → #gnomes-g
- "Gnome lord, gnome king" → #gnomes-g
- "Gnomish wizard, sleep spell danger" → #gnomes-g
- "`h` humanoids" → #humanoids-h
- "Dwarf, dangerously underrated" → #humanoids-h
- "Mind flayer, drains Int" → #humanoids-h
- "Master mind flayer, five tentacles" → #humanoids-h
- "`i` imps and minor demons" → #imps-and-minor-demons-i
- "Imp, stream of insults" → #imps-and-minor-demons-i
- "Quasit, drains Dex" → #imps-and-minor-demons-i
- "Tengu, teleport and teleport-control corpse" → #imps-and-minor-demons-i
- "`j` jellies" → #jellies-j
- "Spotted jelly, passive acid" → #jellies-j
- "Blue jelly corpse, cold + poison resistance" → #jellies-j
- "`k` kobolds" → #kobolds-k
...
- "Large mimic, sticky claw" → #a-note-on-mimics
- "`n` nymphs" → #nymphs-n
- "Nymph, walks off the level with your bag of holding" → #a-note-on-nymphs
- "`N` nagas" → #nagas-n
- "Black naga corpse, three resistances" → #nagas-n
- "`o` orcs" → #orcs-o
- "Orc-captain, two attacks" → #orcs-o
- "`O` ogres" → #ogres-o
- "`p` piercers" → #piercers-p
- "Piercer, drop from ceiling" → #piercers-p
- "`P` puddings and oozes" → #puddings-and-oozes-p
- "Black pudding, do not split with iron" → #a-note-on-puddings
- "Brown pudding, vegetarian-safe glob" → #a-note-on-puddings
- "Gray ooze, rusts armor" → #a-note-on-puddings
- "Green slime, ten-turn countdown" → #a-note-on-puddings
- "`q` quadrupeds" → #quadrupeds-q
- "Rothe, three attacks per turn" → #quadrupeds-q
- "Mumak, 4d12 butt" → #quadrupeds-q
- "`r` rodents" → #rodents-r
- "Rock mole, eats your metal" → #rodents-r
- "`R` rust monster, disenchanter" → #rust-monsters-and-disenchanters-r
- "Rust monster, strip iron first" → #rust-monsters-and-disenchanters-r
- "Disenchanter, mourning your former +5" → #enchantment-drain
- "`s` arachnids and centipedes" → #arachnids-and-centipedes-s
- "Cave spider, eat for poison resistance" → #arachnids-and-centipedes-s
- "Scorpius, named quest nemesis" → #arachnids-and-centipedes-s
- "`S` snakes" → #snakes-s
- "Pit viper, cobra, poison bites" → #snakes-s
- "Water moccasin, from fountain" → #snakes-s
- "`t` trappers and lurkers" → #trappers-and-lurkers-t
- "Lurker above, looking up too late" → #engulfment
- "Trapper, floor in disguise" → #trappers-and-lurkers-t
- "`T` trolls, do not stay dead" → #a-note-on-trolls
- "Olog-hai, the troll you fear" → #a-note-on-trolls
- "`u` horses and unicorns" → #unicorns-and-horses-u
- "Unicorn, gem-throwing playbook" → #unicorns-and-horses-u
- "Warhorse, ridden into mid-game" → #unicorns-and-horses-u
- "`U` umber hulk, confusion gaze" → #umber-hulks-u
- "`v` vortices" → #vortices-v
- "Air, fire, ice, steam, energy, dust vortex" → #vortices-v
- "`V` vampires" → #vampires-v
- "Vampire, level drain" → #vampires-v
- "Vlad the Impaler, top of his tower" → #vampires-v
- "`w` worms" → #worms-w
- "Long worm, tail segments" → #worms-w
- "Purple worm, swallows you whole" → #worms-w
- "`W` wraiths" → #wraiths-w
- "Wraith corpse, gain an experience level" → #a-note-on-wraiths
- "Nazgul, sleep breath" → #wraiths-w
- "`x` xans and fantastic insects" → #xans-and-fantastic-insects-x
- "Grid bug, can't move diagonally" → #xans-and-fantastic-insects-x
- "Grid bug, last-hit kills" → #deadly-mistakes
- "Xan, sting cripples your legs" → #xans-and-fantastic-insects-x
...
- "`z` zruty, three-attack brute" → #zruties-z
- "`Z` zombies" → #zombies-z
...
- "Ki-rin, flying spellcaster" → #angelic-beings-a
- "`B` bats and birds" → #bats-and-birds-b
- "Vampire bat, Str-draining bite" → #bats-and-birds-b
- "Giant bat, speed 22 swarmer" → #bats-and-birds-b
- "`C` centaurs" → #centaurs-c
- "Forest centaur, bow user" → #centaurs-c
- "Mountain centaur, two kicks plus weapon" → #centaurs-c
- "`D` dragons, color cheat-sheet" → #a-note-on-dragons
- "Gray dragon scale mail, magic resistance" → #a-note-on-dragons
- "Silver dragon scale mail, reflection" → #a-note-on-dragons
- "Black dragon scale mail, disintegration + drain res" → #a-note-on-dragons
- "Yellow dragon scale mail, stoning resistance bonus" → #a-note-on-dragons
- "Orange dragon scale mail, sleep + free action" → #a-note-on-dragons
- "White dragon scale mail, cold + slow digestion" → #a-note-on-dragons
- "Red dragon scale mail, fire + infravision" → #a-note-on-dragons
- "Green dragon scale mail, poison + sickness resistance" → #a-note-on-dragons
- "Blue dragon scale mail, shock + speed" → #a-note-on-dragons
- "Gold dragon scale mail, the body-slot lantern" → #a-note-on-dragons
- "Chromatic Dragon, random breath weapons" → #dragons-d
- "Ixoth, Quest dragon (Archeologist)" → #dragons-d
- "Baby dragon, doesn't breathe" → #dragons-d
- "`E` elementals" → #elementals-e
- "Air elemental, engulfs and suffocates" → #elementals-e
- "Earth elemental, phases through walls" → #elementals-e
- "Stalker, see-invisible corpse" → #elementals-e
- "`F` fungi and molds" → #fungi-and-molds-f
- "Yellow mold, stuns and poisons" → #fungi-and-molds-f
- "Brown mold, passive cold" → #fungi-and-molds-f
- "Violet fungus, sticky paralysis" → #fungi-and-molds-f
...
- "Cyclops, Healer quest nemesis" → #giant-humanoids-h
- "Lord Surtur, Valkyrie quest nemesis" → #giant-humanoids-h
- "`J` jabberwock, four 2d10 attacks" → #jabberwocks-j
- "`K` Keystone Kops" → #keystone-kops-k
- "Kops, summoned by shoplifting" → #keystone-kops-k
- "`L` liches" → #liches-l
- "Arch-lich, touch of death" → #liches-l
- "Master lich, magic resistance mandatory" → #liches-l
- "`M` mummies, undead-turning shreds" → #mummies-m
- "Mummy wrapping, blocks invisibility" → #cloaks
- "`Q` quantum mechanics, teleport-on-claw" → #quantum-mechanics-q
- "Quantum mechanic corpse, toggles Fast" → #quantum-mechanics-q
- "Genetic engineer, polymorph-on-claw" → #quantum-mechanics-q
- "`@` humans and elves (monster class)" → #humans-and-elves
- "Shopkeeper, tougher NPC than you" → #humans-and-elves
- "Oracle, peaceful by design" → #humans-and-elves
- "Medusa, the Gorgon" → #humans-and-elves
- "Wizard of Yendor, the most persistent ex" → #humans-and-elves
- "Croesus, vault guardian" → #humans-and-elves
- "Charon, ferryman" → #humans-and-elves
- "`&` major demons" → #major-demons
- "Mail daemon, do not attack" → #major-demons
- "Amorous demon, expensive evening with" → #seduction
- "Water demon, fountain summons" → #major-demons
- "Demogorgon, attacks on sight, no bribe" → #major-demons
- "Asmodeus, bribable cold caster" → #the-demon-prince-lairs
- "Baalzebub, beetle-shaped lair" → #the-demon-prince-lairs
- "Juiblex, Faceless Lord, swamp" → #the-demon-prince-lairs
- "Yeenoghu, attacks on sight" → #major-demons
- "Orcus, Prince of Undead" → #orcus-town
- "Geryon, bribable arch-devil" → #major-demons
- "Dispater, bribable arch-devil" → #major-demons
- "Balrog, slow but heavy" → #major-demons
- "`'` golems" → #golems
- "Iron golem, poison breath" → #golems
- "Rope golem, grappling hug" → #golems
- "Clay golem, dissolves to cancellation" → #golems
- "Gold golem, walking treasure pile" → #golems
- "`;` sea monsters" → #sea-monsters
- "Giant eel, grab and drown" → #sea-monsters
- "Kraken, Medusa's pool variant" → #sea-monsters
- "Electric eel, six in medusa-2" → #sea-monsters
- "`:` lizards" → #lizards
- "Lizard corpse, cures stoning" → #lizards
- "Newt corpse, restores 1-3 Pw" → #lizards
- "Chameleon corpse, polymorphs you" → #lizards
- "Salamander, Gehennom-only" → #lizards
- "`I` invisible monster marker" → #special-symbols
- "`~` long worm tail" → #special-symbols
- "Ghost, paints over the floor as a gap" → #special-symbols

### Points of interest

- "Fountains, gentle bubbling doom" → #fountains
- "Magic fountain, one in seven" → #fountains
...
- "Throne, wish only at positive Luck 7+" → #thrones
- "Throne, vanishes in a puff of logic" → #thrones
- "Throne, kicking for gold and gems" → #thrones
...
- "Sokoban, boulders into pits" → #sokoban
...
- "Rogue Level, all uppercase wildlife" → #the-rogue-level
- "Fort Ludios, vault full of gold" → #fort-ludios
- "Fort Ludios, Croesus across the moat" → #fort-ludios
- "Medusa's Island, three layered challenges" → #medusas-island
- "Medusa, surviving the gaze" → #medusas-island
...
- "Pit, climb out" → #movement-traps
- "Spiked pit, possibly poisoned" → #movement-traps
- "Trapdoor, 25% chance to keep falling" → #movement-traps
- "Teleport trap, free transport with control" → #movement-traps
- "Level teleporter, separated from your pet" → #movement-traps
- "Hole, like a trapdoor with manners" → #movement-traps
...
- "Varda Elentári, Star-Queen" → #where-the-word-comes-from
- "Elbereth, the ward (basic)" → #the-ward
- "Elbereth, rules of the ward" → #rules-of-the-ward
- "Elbereth, the defile rule (important)" → #the-defile-rule-important
- "Hypocrite, alignment hit when defiling" → #the-defile-rule-important
- "Elbereth, who ignores it" → #rules-of-the-ward
- "Elbereth, dead in Gehennom" → #rules-of-the-ward
- "Elbereth, practical use" → #practical-use
- "Scroll of scare monster, drop-and-stand" → #practical-use
- "Iron bars, light passes through" → #iron-bars
- "Iron bars, dig around them" → #iron-bars
- "Iron bars, wand of lightning melts (sometimes)" → #iron-bars
...
- "Turning into slime, the 10-turn timer" → #feelings-and-sounds
- "Feel deathly sick, Pestilence or rot" → #feelings-and-sounds
- "Health currently feels amplified, shock resistance" → #feelings-and-sounds
- "Strange mental acuity, telepathy gained" → #feelings-and-sounds
...
- "Cockatrice corpse, the rubber chicken" → #petrification-stoning
- "Cockatrice, new moon hiss (1 in 3)" → #petrification-stoning
...
- "Mind flayer, wear any helmet" → #brainlessness
- "Mind flayer, greased helmet stacks" → #brainlessness
- "Master mind flayer, five tentacles" → #brainlessness
- "Restore ability, returning lost stats" → #brainlessness
- "Spell amnesia, mind flayer side effect" → #brainlessness
- "Level drain, wraiths and friends" → #level-drain
- "Excalibur, drain resistance" → #level-drain
- "Stormbringer, drain res while wielded (chaotic)" → #level-drain
- "Staff of Aesculapius, drain res" → #level-drain
- "Shield of drain resistance, new in 5.0" → #level-drain
- "Enchantment drain, the silent ascension-killer" → #enchantment-drain
- "Disenchanter, range-kill don't melee" → #enchantment-drain
- "Magic cancellation (MC), MC3 blocks 90%" → #enchantment-drain
...
- "Amulet of unchanging, blocks slime" → #delayed-deaths
...
- "Crowning, alignment 20 and Luck 10" → #crowning
- "Crowning, prayer-cooldown penalty" → #crowning
...
- "Mark, the sucker conditions" → #the-price-is-right
...
- "Healing potion, $20 alone" → #potion-prices
- "Ring prices, $100 to $300" → #ring-prices
- "Wand prices, $100 to $500" → #wand-prices
- "$500 wand, very good day" → #wand-prices
- "Amulet prices, all $150" → #amulet-prices
- "Wand, identifying by engraving" → #the-engrave-test-wands
- "Engrave test, the procedure" → #the-engrave-test-wands
- "Engrave test, pre-write a word in dust" → #the-engrave-test-wands
- "Wand of wishing, found with one charge" → #wand-wishing
...
- "Armor, randomized appearances" → #use-testing-the-careful-way
- "Armor pools, helms cloaks gloves boots" → #use-testing-the-careful-way
- "Armor prices, the danger zones" → #armor-prices
- "$30 boots, the warning" → #armor-prices
- "Gray stones, four stones one answer" → #gray-stones-four-stones-one-correct-answer
- "Loadstone, cursed and refuses to drop" → #gray-stones-four-stones-one-correct-answer
- "Loadstone, the kick test" → #gray-stones-four-stones-one-correct-answer
- "Loadstone, the #tip escape" → #gray-stones-four-stones-one-correct-answer
...
- "Tin of spinach, +1 Str" → #what-to-eat
- "Vegetarian, allowed corpses" → #what-to-eat
...
- "Killer bee corpse, poison resistance" → #useful-corpse-effects
- "Fire ant corpse, fire resistance" → #useful-corpse-effects
- "Fire giant corpse, fire + Strength" → #useful-corpse-effects
- "Stalker corpse, invisibility and see invisible" → #useful-corpse-effects
- "Tengu corpse, teleportitis / teleport control" → #useful-corpse-effects
...
- "Enchant weapon, +5 ceiling safe" → #scroll-enchant
- "Enchant armor, +3 ceiling safe" → #scroll-enchant
- "Remove curse, the happy ending" → #scroll-remove-curse
- "Scroll of charging, save for wand of wishing" → #scroll-charging
- "Charging, explosion chance (n³/7³)" → #scroll-charging
...
- "Confused charging, raises max Pw" → #confused-reading
- "Confused genocide, kills you" → #confused-reading
- "Potion of confusion, the controlled confuser" → #confused-reading
...
- "Wand of cold, freezes water (ice path)" → #wand-fire-cold-lightning
- "Wand of cancellation, never in a bag" → #wand-cancellation
...
- "Ring of slow digestion, foodless option" → #the-ring-table
- "Ring of polymorph control, less critical now" → #the-ring-table
- "Ring of aggravate monster, the niche use" → #the-ring-table
- "Auto-curse rings (teleport, polymorph, aggravate, hunger)" → #the-ring-table
- "Ring hunger, every ring costs nutrition" → #the-ring-table
- "Ring of protection, chargeable" → #the-ring-table
- "Ring of regeneration, hungry healer" → #the-ring-table
...
- "Amulet of magical breathing, underwater" → #amulets
- "Amulet of ESP (telepathy)" → #amulets
- "Amulet of unchanging, blocks polymorph" → #amulets
- "Amulet of flying, mount flies too (new in 5.0)" → #amulets
- "Amulet of guarding, +2 AC +2 MC (new in 5.0)" → #amulets
- "Amulet of strangulation, 90% cursed" → #amulets
- "Amulet of restful sleep, the rebrand" → #amulets
...
- "BoH, ascension carry" → #containers
...
- "Monsters loot unlocked containers (new in 5.0)" → #carrying-capacity
- "Unlocking tools, skeleton key best" → #unlocking-tools
- "Lock pick, respectable" → #unlocking-tools
- "Credit card, worst but works" → #unlocking-tools
- "Light sources, candles and oil lamps" → #light-sources
- "Magic lamp, the wish gamble" → #light-sources
- "Candelabrum of Invocation, requires seven candles" → #light-sources
- "Musical instruments, the passtune" → #musical-instruments
- "Magic harp, charms monsters" → #musical-instruments
- "Magic flute, sleep" → #musical-instruments
- "Drum of earthquake, pits around you" → #musical-instruments
- "Unicorn horn, status-cure all" → #other-notable-tools
- "Unicorn horn, blessed seven ailments" → #other-notable-tools
- "Stethoscope, HP check and crowning meter" → #other-notable-tools
- "Tinning kit, intrinsic grinder bypass" → #other-notable-tools
- "Can of grease, slip and waterproofing" → #other-notable-tools
- "Blindfold, voluntary blindness" → #other-notable-tools
- "Towel, cream pie and blindfold" → #other-notable-tools
- "Magic marker, scroll printer" → #other-notable-tools
- "Magic marker, ascension-kit writes" → #other-notable-tools
- "Crystal ball, the one-question oracle" → #other-notable-tools
- "Bell of Opening, Invocation item" → #other-notable-tools
- "Pickaxe and mattock, dig anywhere" → #other-notable-tools
- "Tin opener, blessed instant" → #other-notable-tools
...
- "Spellcasting, mana not sparkles" → #spellcasting
- "Learning spells, success formula" → #learning-spells
- "Spellbook, failure effects by level" → #learning-spells
...
- "Key spells, the short list" → #key-spells
- "Force bolt, level 1 attack" → #key-spells
- "Healing spell, level 1" → #key-spells
- "Identify spell, blessed multi-ID" → #key-spells
- "Magic mapping spell, level 5" → #key-spells
- "Charm monster, 3×3 tame" → #key-spells
- "Chain lightning, 5.0 room-clearer" → #key-spells
- "Finger of death, the argument-ender" → #key-spells
- "Mana, 5 Pw per spell level" → #mana-management

### Luck

- "Luck, secretly ruining yours" → #gaining-and-losing-luck
- "Luck, the hidden number" → #how-luck-works
- "Luck timeout, 600 turns toward 0" → #how-luck-works
- "Luckstone, freezes the drift" → #how-luck-works
- "Cursed luckstone, locks negative" → #how-luck-works
- "Heart of Ahriman, counts as luckstone" → #how-luck-works
- "Tsurugi of Muramasa, counts as luckstone" → #how-luck-works
- "Orb of Fate, counts as luckstone" → #how-luck-works
- "Full moon, +1 baseline Luck" → #how-luck-works
- "Friday the 13th, –1 baseline Luck" → #how-luck-works
- "Gaining and losing Luck, the table" → #gaining-and-losing-luck
- "Unicorn gem-throwing, +5 luck max" → #gaining-and-losing-luck
- "Identified gem to co-aligned unicorn, +5" → #gaining-and-losing-luck
- "Killing peaceful, –1 Luck (50%)" → #gaining-and-losing-luck
- "Killing pet, –1 Luck plus –15 alignment" → #gaining-and-losing-luck
...
- "Magicbane (Neutral athame), wielded magic resistance" → #wishable-random-artifacts
- "Stormbringer (Chaotic runesword), drain life" → #wishable-random-artifacts
- "Vorpal Blade, behead chance" → #wishable-random-artifacts
- "Frost Brand, cold + snowstorm invoke" → #wishable-random-artifacts
- "Fire Brand, fire + firestorm invoke" → #wishable-random-artifacts
- "Sunsword (Lawful), 5.0 blinding ray" → #wishable-random-artifacts
- "Snickersnee (Samurai katana), Shkinng! free polearm reach" → #wishable-random-artifacts
- "Cleaver (Barbarian), three-monster swing" → #wishable-random-artifacts
- "Demonbane (Lawful silver mace), Priest first gift" → #wishable-random-artifacts
- "Sting (Chaotic elven dagger), warns of orcs" → #wishable-random-artifacts
- "Orcrist (Chaotic elven broadsword), warns of orcs" → #wishable-random-artifacts
- "Grimtooth (Chaotic orcish dagger), warns of elves" → #wishable-random-artifacts
- "Dragonbane, reflection while wielded" → #wishable-random-artifacts
- "Werebane, lycanthropy defense" → #wishable-random-artifacts
- "Giantslayer, double vs giants" → #wishable-random-artifacts
- "Ogresmasher, double vs ogres" → #wishable-random-artifacts
- "Trollsbane, regeneration while wielded" → #wishable-random-artifacts
- "Bane weapons, defensive riders" → #wishable-random-artifacts
- "Quest artifacts, the per-role list" → #quest-artifacts
- "Orb of Detection (Archeologist)" → #quest-artifacts
- "Heart of Ahriman (Barbarian)" → #quest-artifacts
- "Sceptre of Might (Caveman), conflict invoke" → #quest-artifacts
- "Staff of Aesculapius (Healer), drain-life on hit" → #quest-artifacts
- "Magic Mirror of Merlin (Knight)" → #quest-artifacts
- "Eyes of the Overworld (Monk), astral vision when worn" → #quest-artifacts
- "Mitre of Holiness (Priest)" → #quest-artifacts
- "Longbow of Diana (Ranger), conjure arrows invoke" → #quest-artifacts
- "Master Key of Thievery (Rogue), untrap invoke" → #quest-artifacts
- "Tsurugi of Muramasa (Samurai)" → #quest-artifacts
- "Platinum Yendorian Express Card (Tourist), charge an item" → #quest-artifacts
- "Orb of Fate (Valkyrie)" → #quest-artifacts
- "Eye of the Aethiopica (Wizard), Vlad portal invoke" → #quest-artifacts
- "Wishing for other roles' quest artifacts, carry bonuses" → #quest-artifacts
...
- "Drawbridge, four ways to lower" → #the-castle
- "Passtune, the five-note Mastermind" → #the-castle
- "Wand of striking, destroys drawbridge" → #the-castle
...
- "Wand of Orcus, his fingertip death ray" → #orcus-town
- "Orcus Town, guaranteed magic lamp or marker" → #orcus-town
- "Wizard's Tower, three special levels" → #the-wizards-tower
- "Wizard of Yendor, never stops" → #the-wizards-tower
- "Book of the Dead, at the Tower bottom" → #the-wizards-tower
- "Moloch's Sanctum, sealed level" → #molochs-sanctum
- "High Priest of Moloch, on the high altar" → #molochs-sanctum
- "Amulet of Yendor, the prize" → #molochs-sanctum
...
- "Fake amulet, from bones or wish" → #the-ascension-run
...
- "Carrying Amulet, casts cost more (drop to cast)" → #strategy
- "Elbereth dead past Castle" → #strategy
...
- "Plane of Air, conflict tactic" → #plane-of-air
- "Plane of Fire, fire resistance non-optional" → #plane-of-fire
- "Plane of Water, magical breathing required" → #plane-of-water
- "Genocide class `;`, on Plane of Water" → #plane-of-water
- "Astral Plane, three altars" → #the-astral-plane
- "Astral, choose wrong altar = game ends" → #the-astral-plane
- "Astral, farlook reveals altar only when adjacent" → #the-astral-plane
...
- "Wand of death on Death, heals him" → #the-astral-plane
...
- "Travel (`_`), shortest path autopilot" → #travel
- "#force, prying chests open" → #forcing-locked-chests
- "Ctrl+P, message history" → #message-history-and-redraw
- "Ctrl+R, redraw" → #message-history-and-redraw
...
- "Foodless conduct" → #the-food-conducts
- "Atheist conduct" → #atheist
- "Atheist, ascension Amulet offering is exempt" → #atheist
- "Weaponless conduct" → #weaponless
- "Pacifist conduct" → #pacifist
- "Pacifist, the figurine-of-Archon plan" → #pacifist
- "Illiterate conduct" → #illiterate
- "Illiterate, only x signature allowed" → #illiterate
- "No Genocide conduct, type \"none\"" → #no-genocide
- "Polymorph restrictions (poly self, poly objects)" → #polymorph-restrictions
...
- "Closed for inventory, locked shop door" → #shopkeeper-behavior
- "Gem identification through selling (not reliable)" → #gem-identification-through-selling
- "Touchstone, blessed names gems on rub" → #gem-identification-through-selling
- "Real gem prices, the table" → #real-gem-prices
- "Mohs hardness, gems for engraving" → #real-gem-prices
- "Hard gems (Mohs 8+), survive throws" → #real-gem-prices
- "Worthless glass, unicorn-safe junk" → #real-gem-prices
...
- "Levitation boots, the cursed trap" → #boots
...
- "Steelypips, Kate Nepveu's archive" → #acknowledgements
- "Spoilers, Hugo and O'Donnell" → #acknowledgements
- "Damerell, Object Identification FAQ" → #acknowledgements
- "Damerell, prayer spoiler" → #acknowledgements
- "NetHack Wiki, the living changelog" → #acknowledgements
- "NAO (nethack.alt.org), the public server" → #acknowledgements
- "Hardfought, the variants server" → #acknowledgements
- "Grid bug, name and Tron reference" → #acknowledgements
- "The DevTeam is THINKING, the 12-year gap" → #acknowledgements
